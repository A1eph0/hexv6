...
consolewrite(int user_src, uint64 src, int n)
{
  ...
  for(i = 0; i < n; i++){
    ...
    80000130:	442080e7          	jalr	1090(ra) # 8000256e <either_copyin>
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  while(n > 0){
    ...
    80000214:	308080e7          	jalr	776(ra) # 80002518 <either_copyout>
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000ed8:	ae0080e7          	jalr	-1312(ra) # 800029b4 <trapinithart>
  ...
  scheduler();        
    ...
    80000f50:	a40080e7          	jalr	-1472(ra) # 8000298c <trapinit>
    trapinithart();  // install kernel trap vector
    80000f54:	00002097          	auipc	ra,0x2
    80000f58:	a60080e7          	jalr	-1440(ra) # 800029b4 <trapinithart>
    ...
    80000f70:	31a080e7          	jalr	794(ra) # 80003286 <binit>
    iinit();         // inode table
    80000f74:	00003097          	auipc	ra,0x3
    80000f78:	9aa080e7          	jalr	-1622(ra) # 8000391e <iinit>
    fileinit();      // file table
    80000f7c:	00004097          	auipc	ra,0x4
    80000f80:	954080e7          	jalr	-1708(ra) # 800048d0 <fileinit>
    virtio_disk_init(); // emulated hard disk
...
forkret(void)
{
  ...
  usertrapret();
    ...
    80001a0e:	fc2080e7          	jalr	-62(ra) # 800029cc <usertrapret>
}
    ...
    80001a28:	e7a080e7          	jalr	-390(ra) # 8000389e <fsinit>
...
0000000080001d22 <userinit>:
{
  ...
  p->cwd = namei("/");
    ...
    80001d84:	54c080e7          	jalr	1356(ra) # 800042cc <namei>
...
0000000080001e18 <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    80001ec2:	aa4080e7          	jalr	-1372(ra) # 80004962 <filedup>
  ...
  np->cwd = idup(p->cwd);
    ...
    80001ee4:	bf8080e7          	jalr	-1032(ra) # 80003ad8 <idup>
...
0000000080001f5c <scheduler>:
{
  ...
  c->proc = 0;
    ...
    80001fac:	a889                	j	80001ffe <scheduler+0xa2>
        if(temp == 0 || temp->ctime > p->ctime)
    80001fae:	0a0a8263          	beqz	s5,80002052 <scheduler+0xf6>
    80001fb2:	170ab703          	ld	a4,368(s5)
    80001fb6:	1704b783          	ld	a5,368(s1)
    80001fba:	00e7f363          	bgeu	a5,a4,80001fc0 <scheduler+0x64>
    80001fbe:	8aa6                	mv	s5,s1
      release(&p->lock);
    80001fc0:	854a                	mv	a0,s2
    80001fc2:	fffff097          	auipc	ra,0xfffff
    80001fc6:	cd6080e7          	jalr	-810(ra) # 80000c98 <release>
    for(p = proc; p < &proc[NPROC]; p++)
    80001fca:	1d048793          	addi	a5,s1,464
    80001fce:	0547f463          	bgeu	a5,s4,80002016 <scheduler+0xba>
    80001fd2:	1d048493          	addi	s1,s1,464
    80001fd6:	8926                	mv	s2,s1
      acquire(&p->lock);
    ...
    80001fe4:	fd3785e3          	beq	a5,s3,80001fae <scheduler+0x52>
      release(&p->lock);
    80001fe8:	8526                	mv	a0,s1
    80001fea:	fffff097          	auipc	ra,0xfffff
    80001fee:	cae080e7          	jalr	-850(ra) # 80000c98 <release>
    for(p = proc; p < &proc[NPROC]; p++)
    80001ff2:	1d048793          	addi	a5,s1,464
    80001ff6:	fd47eee3          	bltu	a5,s4,80001fd2 <scheduler+0x76>
    if(p != 0)
    80001ffa:	000a9e63          	bnez	s5,80002016 <scheduler+0xba>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    struct proc *temp = 0;
    80002012:	8ada                	mv	s5,s6
    80002014:	b7c9                	j	80001fd6 <scheduler+0x7a>
      acquire(&p->lock);
    ...
    8000201e:	bca080e7          	jalr	-1078(ra) # 80000be4 <acquire>
       if(p->state == RUNNABLE) {
    80002022:	018aa783          	lw	a5,24(s5)
    80002026:	03379063          	bne	a5,s3,80002046 <scheduler+0xea>
        p->state = RUNNING;
    8000202a:	4791                	li	a5,4
    8000202c:	00faac23          	sw	a5,24(s5)
        c->proc = p;
    80002030:	035bb823          	sd	s5,48(s7)
        swtch(&c->context, &p->context);
    80002034:	060a8593          	addi	a1,s5,96
    80002038:	8562                	mv	a0,s8
    8000203a:	00001097          	auipc	ra,0x1
    8000203e:	8e8080e7          	jalr	-1816(ra) # 80002922 <swtch>
        c->proc = 0;
    80002042:	020bb823          	sd	zero,48(s7)
      release(&p->lock);
    80002046:	8526                	mv	a0,s1
    80002048:	fffff097          	auipc	ra,0xfffff
    8000204c:	c50080e7          	jalr	-944(ra) # 80000c98 <release>
    80002050:	b77d                	j	80001ffe <scheduler+0xa2>
    80002052:	8aa6                	mv	s5,s1
    80002054:	b7b5                	j	80001fc0 <scheduler+0x64>
...
0000000080002056 <sched>:
{
  ...
  if(!holding(&p->lock))
    ...
    80002072:	afc080e7          	jalr	-1284(ra) # 80000b6a <holding>
  ...
  if(mycpu()->noff != 1)
    ...
    80002082:	22270713          	addi	a4,a4,546 # 800112a0 <pid_lock>
  ...
  intena = mycpu()->intena;
    ...
    800020a8:	1fc90913          	addi	s2,s2,508 # 800112a0 <pid_lock>
  ...
  swtch(&p->context, &mycpu()->context);
    ...
    800020c0:	21c58593          	addi	a1,a1,540 # 800112d8 <cpus+0x8>
    800020c4:	95be                	add	a1,a1,a5
    800020c6:	06048513          	addi	a0,s1,96
    800020ca:	00001097          	auipc	ra,0x1
    800020ce:	858080e7          	jalr	-1960(ra) # 80002922 <swtch>
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  struct proc *p = myproc();
    ...
    8000217e:	836080e7          	jalr	-1994(ra) # 800019b0 <myproc>
...
00000000800021cc <wait>:
{
  ...
  struct proc *p = myproc();
    ...
    800021ea:	7ca080e7          	jalr	1994(ra) # 800019b0 <myproc>
  ...
  acquire(&wait_lock);
    ...
    80002204:	00017997          	auipc	s3,0x17
    80002208:	8cc98993          	addi	s3,s3,-1844 # 80018ad0 <tickslock>
        havekids = 1;
    8000220c:	4a85                	li	s5,1
    sleep(p, &wait_lock);  //DOC: wait-sleep
    8000220e:	0000fc17          	auipc	s8,0xf
    80002212:	0aac0c13          	addi	s8,s8,170 # 800112b8 <wait_lock>
    havekids = 0;
    80002216:	875e                	mv	a4,s7
    for(np = proc; np < &proc[NPROC]; np++){
    80002218:	0000f497          	auipc	s1,0xf
    8000221c:	4b848493          	addi	s1,s1,1208 # 800116d0 <proc>
    ...
    8000223a:	43c080e7          	jalr	1084(ra) # 80001672 <copyout>
    8000223e:	02054563          	bltz	a0,80002268 <wait+0x9c>
          freeproc(np);
    80002242:	8526                	mv	a0,s1
    80002244:	00000097          	auipc	ra,0x0
    80002248:	91e080e7          	jalr	-1762(ra) # 80001b62 <freeproc>
          release(&np->lock);
    8000224c:	8526                	mv	a0,s1
    8000224e:	fffff097          	auipc	ra,0xfffff
    80002252:	a4a080e7          	jalr	-1462(ra) # 80000c98 <release>
          release(&wait_lock);
    80002256:	0000f517          	auipc	a0,0xf
    8000225a:	06250513          	addi	a0,a0,98 # 800112b8 <wait_lock>
    ...
    for(np = proc; np < &proc[NPROC]; np++){
    80002286:	1d048493          	addi	s1,s1,464
    ...
    800022b8:	c79d                	beqz	a5,800022e6 <wait+0x11a>
      release(&wait_lock);
    800022ba:	0000f517          	auipc	a0,0xf
    800022be:	ffe50513          	addi	a0,a0,-2 # 800112b8 <wait_lock>
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    80002314:	00016917          	auipc	s2,0x16
    80002318:	7bc90913          	addi	s2,s2,1980 # 80018ad0 <tickslock>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    8000232c:	1d048493          	addi	s1,s1,464
    80002330:	03248463          	beq	s1,s2,80002358 <wakeup+0x64>
    if(p != myproc()){
    80002334:	fffff097          	auipc	ra,0xfffff
    80002338:	67c080e7          	jalr	1660(ra) # 800019b0 <myproc>
...
00000000800023c4 <exit>:
{
  ...
  struct proc *p = myproc();
    ...
    800023da:	5da080e7          	jalr	1498(ra) # 800019b0 <myproc>
  ...
  if(p == initproc)
    ...
    80002408:	5b0080e7          	jalr	1456(ra) # 800049b4 <fileclose>
      p->ofile[fd] = 0;
  ...
  begin_op();
    ...
    80002420:	0cc080e7          	jalr	204(ra) # 800044e8 <begin_op>
  iput(p->cwd);
    80002424:	1509b503          	ld	a0,336(s3)
    80002428:	00002097          	auipc	ra,0x2
    8000242c:	8a8080e7          	jalr	-1880(ra) # 80003cd0 <iput>
  end_op();
    80002430:	00002097          	auipc	ra,0x2
    80002434:	138080e7          	jalr	312(ra) # 80004568 <end_op>
  p->cwd = 0;
    80002438:	1409b823          	sd	zero,336(s3)
  acquire(&wait_lock);
    8000243c:	0000f497          	auipc	s1,0xf
    80002440:	e7c48493          	addi	s1,s1,-388 # 800112b8 <wait_lock>
  ...
  p->etime = ticks;
    ...
    8000247c:	bb87e783          	lwu	a5,-1096(a5) # 80009030 <ticks>
    80002480:	1af9b023          	sd	a5,416(s3)
  release(&wait_lock);
  ...
  sched();
    ...
    80002492:	bc8080e7          	jalr	-1080(ra) # 80002056 <sched>
  panic("zombie exit");
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800024ba:	21a48493          	addi	s1,s1,538 # 800116d0 <proc>
    800024be:	00016997          	auipc	s3,0x16
    800024c2:	61298993          	addi	s3,s3,1554 # 80018ad0 <tickslock>
    acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    800024e0:	1d048493          	addi	s1,s1,464
...
either_copyout(int user_dst, uint64 dst, void *src, uint64 len)
{
  ...
  struct proc *p = myproc();
    ...
    80002534:	480080e7          	jalr	1152(ra) # 800019b0 <myproc>
  if(user_dst){
    ...
    80002546:	130080e7          	jalr	304(ra) # 80001672 <copyout>
  } else {
    ...
    80002566:	7de080e7          	jalr	2014(ra) # 80000d40 <memmove>
    return 0;
...
either_copyin(void *dst, int user_src, uint64 src, uint64 len)
{
  ...
  struct proc *p = myproc();
    ...
    8000258a:	42a080e7          	jalr	1066(ra) # 800019b0 <myproc>
  if(user_src){
    ...
    8000259c:	166080e7          	jalr	358(ra) # 800016fe <copyin>
  } else {
    ...
    800025bc:	788080e7          	jalr	1928(ra) # 80000d40 <memmove>
    return 0;
...
procdump(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800025f6:	63690913          	addi	s2,s2,1590 # 80018c28 <bcache+0x140>
    if(p->state == UNUSED)
      continue;
    ...
    80002618:	cacb8b93          	addi	s7,s7,-852 # 800082c0 <states.1737>
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    80002636:	1d048493          	addi	s1,s1,464
...
update_vals()
{
  ...
  for (p = proc; p < &proc[NPROC]; p++) {
    ...
    8000268a:	04a48493          	addi	s1,s1,74 # 800116d0 <proc>
    acquire(&p->lock);
    
    if (p->state == SLEEPING)
    8000268e:	4989                	li	s3,2
      p->stime++;
    
    if (p->state == RUNNING)
    80002690:	4a11                	li	s4,4
    ...
    80002692:	06400a93          	li	s5,100
      p->priority = 100;
    80002696:	06400b13          	li	s6,100
  for (p = proc; p < &proc[NPROC]; p++) {
    8000269a:	00016917          	auipc	s2,0x16
    8000269e:	43690913          	addi	s2,s2,1078 # 80018ad0 <tickslock>
    800026a2:	a09d                	j	80002708 <update_vals+0x96>
      p->stime++;
    800026a4:	1784b783          	ld	a5,376(s1)
    800026a8:	0785                	addi	a5,a5,1
    800026aa:	16f4bc23          	sd	a5,376(s1)
    if(p->rtime != 0 || p->stime !=0)
    800026ae:	1804b703          	ld	a4,384(s1)
    800026b2:	e701                	bnez	a4,800026ba <update_vals+0x48>
    800026b4:	1784b783          	ld	a5,376(s1)
    800026b8:	cf81                	beqz	a5,800026d0 <update_vals+0x5e>
      p->niceness = (p->stime*10)/(p->stime+p->rtime);
    800026ba:	1784b683          	ld	a3,376(s1)
    800026be:	00269793          	slli	a5,a3,0x2
    800026c2:	97b6                	add	a5,a5,a3
    800026c4:	0786                	slli	a5,a5,0x1
    800026c6:	9736                	add	a4,a4,a3
    800026c8:	02e7d7b3          	divu	a5,a5,a4
    800026cc:	1af4a823          	sw	a5,432(s1)
    p->priority = p->spriority - p->niceness + 5;
    800026d0:	1a84a783          	lw	a5,424(s1)
    800026d4:	1b04a703          	lw	a4,432(s1)
    800026d8:	9f99                	subw	a5,a5,a4
    800026da:	2795                	addiw	a5,a5,5
    800026dc:	0007871b          	sext.w	a4,a5
    if(p->priority< 0)
    800026e0:	02079693          	slli	a3,a5,0x20
    800026e4:	0006c763          	bltz	a3,800026f2 <update_vals+0x80>
    else if(p->priority>100)
    800026e8:	04eac563          	blt	s5,a4,80002732 <update_vals+0xc0>
    p->priority = p->spriority - p->niceness + 5;
    800026ec:	1af4a623          	sw	a5,428(s1)
    800026f0:	a019                	j	800026f6 <update_vals+0x84>
      p->priority = 0;
    800026f2:	1a04a623          	sw	zero,428(s1)

    release(&p->lock); 
    800026f6:	8526                	mv	a0,s1
    800026f8:	ffffe097          	auipc	ra,0xffffe
    800026fc:	5a0080e7          	jalr	1440(ra) # 80000c98 <release>
  for (p = proc; p < &proc[NPROC]; p++) {
    80002700:	1d048493          	addi	s1,s1,464
    80002704:	03248a63          	beq	s1,s2,80002738 <update_vals+0xc6>
    acquire(&p->lock);
    ...
    80002714:	f93788e3          	beq	a5,s3,800026a4 <update_vals+0x32>
    if (p->state == RUNNING)
    80002718:	f9479be3          	bne	a5,s4,800026ae <update_vals+0x3c>
      p->rtime++;
    8000271c:	1804b783          	ld	a5,384(s1)
    80002720:	0785                	addi	a5,a5,1
    80002722:	18f4b023          	sd	a5,384(s1)
      p->rtime_whole++;
    80002726:	1884b783          	ld	a5,392(s1)
    8000272a:	0785                	addi	a5,a5,1
    8000272c:	18f4b423          	sd	a5,392(s1)
    80002730:	bfbd                	j	800026ae <update_vals+0x3c>
      p->priority = 100;
    80002732:	1b64a623          	sw	s6,428(s1)
    80002736:	b7c1                	j	800026f6 <update_vals+0x84>
  }
}
    80002738:	70e2                	ld	ra,56(sp)
    8000273a:	7442                	ld	s0,48(sp)
    8000273c:	74a2                	ld	s1,40(sp)
    8000273e:	7902                	ld	s2,32(sp)
    80002740:	69e2                	ld	s3,24(sp)
    80002742:	6a42                	ld	s4,16(sp)
    80002744:	6aa2                	ld	s5,8(sp)
    80002746:	6b02                	ld	s6,0(sp)
    80002748:	6121                	addi	sp,sp,64
    8000274a:	8082                	ret

000000008000274c <priority_updater>:
...
priority_updater(int new_priority, int pid)
{
  ...
  for (p = proc; p < &proc[NPROC]; p++) {
    ...
    80002768:	f6c48493          	addi	s1,s1,-148 # 800116d0 <proc>
  int temp = -1;
    8000276c:	5afd                	li	s5,-1
    acquire(&p->lock);
    if (p->pid == pid)
    {
      temp = p->spriority;
  ...
  for (p = proc; p < &proc[NPROC]; p++) {
    80002770:	00016997          	auipc	s3,0x16
    80002774:	36098993          	addi	s3,s3,864 # 80018ad0 <tickslock>
    80002778:	a811                	j	8000278c <priority_updater+0x40>
    }
    release(&p->lock); 
  ...
  for (p = proc; p < &proc[NPROC]; p++) {
    80002784:	1d048493          	addi	s1,s1,464
    80002788:	03348163          	beq	s1,s3,800027aa <priority_updater+0x5e>
    acquire(&p->lock);
    ...
    80002798:	ff2791e3          	bne	a5,s2,8000277a <priority_updater+0x2e>
      temp = p->spriority;
    8000279c:	1a84aa83          	lw	s5,424(s1)
      p->spriority = new_priority;
    800027a0:	1b44a423          	sw	s4,424(s1)
      p->niceness = 5;
    800027a4:	1b64a823          	sw	s6,432(s1)
    800027a8:	bfc9                	j	8000277a <priority_updater+0x2e>
  }
  
  if(temp != -1 && temp > new_priority)
    800027aa:	57fd                	li	a5,-1
    800027ac:	00fa8463          	beq	s5,a5,800027b4 <priority_updater+0x68>
    800027b0:	015a4c63          	blt	s4,s5,800027c8 <priority_updater+0x7c>
    yield();
}
    ...
    800027c2:	6b02                	ld	s6,0(sp)
    800027c4:	6121                	addi	sp,sp,64
    800027c6:	8082                	ret
    yield();
    800027c8:	00000097          	auipc	ra,0x0
    800027cc:	964080e7          	jalr	-1692(ra) # 8000212c <yield>
}
    800027d0:	b7d5                	j	800027b4 <priority_updater+0x68>

00000000800027d2 <waitx>:
...
waitx(uint64 addr, uint* rtime_whole, uint* wtime_whole)
{
    ...
    800027ea:	e06a                	sd	s10,0(sp)
    800027ec:	1080                	addi	s0,sp,96
    800027ee:	8b2a                	mv	s6,a0
    800027f0:	8c2e                	mv	s8,a1
    800027f2:	8bb2                	mv	s7,a2
  struct proc *np;
  int havekids, pid;
  struct proc *p = myproc();
    800027f4:	fffff097          	auipc	ra,0xfffff
    800027f8:	1bc080e7          	jalr	444(ra) # 800019b0 <myproc>
  ...
  for(;;){
    ...
    for(np = proc; np < &proc[NPROC]; np++){
    80002812:	00016997          	auipc	s3,0x16
    80002816:	2be98993          	addi	s3,s3,702 # 80018ad0 <tickslock>
        havekids = 1;
    8000281a:	4a85                	li	s5,1
      release(&wait_lock);
      return -1;
    }
    ...
    sleep(p, &wait_lock);  //DOC: wait-sleep
    8000281c:	0000fd17          	auipc	s10,0xf
    80002820:	a9cd0d13          	addi	s10,s10,-1380 # 800112b8 <wait_lock>
    havekids = 0;
    80002824:	8766                	mv	a4,s9
    for(np = proc; np < &proc[NPROC]; np++){
    80002826:	0000f497          	auipc	s1,0xf
    8000282a:	eaa48493          	addi	s1,s1,-342 # 800116d0 <proc>
    8000282e:	a069                	j	800028b8 <waitx+0xe6>
          pid = np->pid;
    80002830:	0304a983          	lw	s3,48(s1)
          *rtime_whole = np->rtime_whole;
    80002834:	1884b783          	ld	a5,392(s1)
    80002838:	00fc2023          	sw	a5,0(s8)
          *wtime_whole = np->etime - np->ctime - np->rtime_whole;
    8000283c:	1a04b783          	ld	a5,416(s1)
    80002840:	1704b703          	ld	a4,368(s1)
    80002844:	1884b683          	ld	a3,392(s1)
    80002848:	9f35                	addw	a4,a4,a3
    8000284a:	9f99                	subw	a5,a5,a4
    8000284c:	00fba023          	sw	a5,0(s7)
          if(addr != 0 && copyout(p->pagetable, addr, (char *)&np->xstate,
    80002850:	000b0e63          	beqz	s6,8000286c <waitx+0x9a>
    80002854:	4691                	li	a3,4
    80002856:	02c48613          	addi	a2,s1,44
    8000285a:	85da                	mv	a1,s6
    8000285c:	05093503          	ld	a0,80(s2)
    80002860:	fffff097          	auipc	ra,0xfffff
    80002864:	e12080e7          	jalr	-494(ra) # 80001672 <copyout>
    80002868:	02054563          	bltz	a0,80002892 <waitx+0xc0>
          freeproc(np);
    8000286c:	8526                	mv	a0,s1
    8000286e:	fffff097          	auipc	ra,0xfffff
    80002872:	2f4080e7          	jalr	756(ra) # 80001b62 <freeproc>
          release(&np->lock);
    ...
    8000288c:	410080e7          	jalr	1040(ra) # 80000c98 <release>
          return pid;
    80002890:	a09d                	j	800028f6 <waitx+0x124>
            release(&np->lock);
    ...
    800028a0:	a1c50513          	addi	a0,a0,-1508 # 800112b8 <wait_lock>
    800028a4:	ffffe097          	auipc	ra,0xffffe
    800028a8:	3f4080e7          	jalr	1012(ra) # 80000c98 <release>
            return -1;
    800028ac:	59fd                	li	s3,-1
    800028ae:	a0a1                	j	800028f6 <waitx+0x124>
    for(np = proc; np < &proc[NPROC]; np++){
    800028b0:	1d048493          	addi	s1,s1,464
    800028b4:	03348463          	beq	s1,s3,800028dc <waitx+0x10a>
      if(np->parent == p){
    800028b8:	7c9c                	ld	a5,56(s1)
    800028ba:	ff279be3          	bne	a5,s2,800028b0 <waitx+0xde>
        acquire(&np->lock);
    800028be:	8526                	mv	a0,s1
    800028c0:	ffffe097          	auipc	ra,0xffffe
    800028c4:	324080e7          	jalr	804(ra) # 80000be4 <acquire>
        if(np->state == ZOMBIE){
    800028c8:	4c9c                	lw	a5,24(s1)
    800028ca:	f74783e3          	beq	a5,s4,80002830 <waitx+0x5e>
        release(&np->lock);
    800028ce:	8526                	mv	a0,s1
    800028d0:	ffffe097          	auipc	ra,0xffffe
    800028d4:	3c8080e7          	jalr	968(ra) # 80000c98 <release>
        havekids = 1;
    800028d8:	8756                	mv	a4,s5
    800028da:	bfd9                	j	800028b0 <waitx+0xde>
    if(!havekids || p->killed){
    800028dc:	c701                	beqz	a4,800028e4 <waitx+0x112>
    800028de:	02892783          	lw	a5,40(s2)
    800028e2:	cb8d                	beqz	a5,80002914 <waitx+0x142>
      release(&wait_lock);
    800028e4:	0000f517          	auipc	a0,0xf
    800028e8:	9d450513          	addi	a0,a0,-1580 # 800112b8 <wait_lock>
    ...
    800028f8:	60e6                	ld	ra,88(sp)
    800028fa:	6446                	ld	s0,80(sp)
    800028fc:	64a6                	ld	s1,72(sp)
    800028fe:	6906                	ld	s2,64(sp)
    80002900:	79e2                	ld	s3,56(sp)
    80002902:	7a42                	ld	s4,48(sp)
    80002904:	7aa2                	ld	s5,40(sp)
    80002906:	7b02                	ld	s6,32(sp)
    80002908:	6be2                	ld	s7,24(sp)
    8000290a:	6c42                	ld	s8,16(sp)
    8000290c:	6ca2                	ld	s9,8(sp)
    8000290e:	6d02                	ld	s10,0(sp)
    80002910:	6125                	addi	sp,sp,96
    80002912:	8082                	ret
    sleep(p, &wait_lock);  //DOC: wait-sleep
    80002914:	85ea                	mv	a1,s10
    80002916:	854a                	mv	a0,s2
    80002918:	00000097          	auipc	ra,0x0
    8000291c:	850080e7          	jalr	-1968(ra) # 80002168 <sleep>
    havekids = 0;
    80002920:	b711                	j	80002824 <waitx+0x52>
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80002998:	95c58593          	addi	a1,a1,-1700 # 800082f0 <states.1737+0x30>
    8000299c:	00016517          	auipc	a0,0x16
    800029a0:	13450513          	addi	a0,a0,308 # 80018ad0 <tickslock>
    800029a4:	ffffe097          	auipc	ra,0xffffe
    800029a8:	1b0080e7          	jalr	432(ra) # 80000b54 <initlock>
}
...
trapinithart(void)
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    800029be:	61678793          	addi	a5,a5,1558 # 80005fd0 <kernelvec>
...
usertrapret(void)
{
  ...
  struct proc *p = myproc();
    ...
    800029d8:	fdc080e7          	jalr	-36(ra) # 800019b0 <myproc>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
  ...
  p->trapframe->kernel_trap = (uint64)usertrap;
    80002a18:	6d38                	ld	a4,88(a0)
    80002a1a:	00000697          	auipc	a3,0x0
    80002a1e:	14668693          	addi	a3,a3,326 # 80002b60 <usertrap>
...
clockintr()
{
  ...
  acquire(&tickslock);
    80002a76:	00016917          	auipc	s2,0x16
    80002a7a:	05a90913          	addi	s2,s2,90 # 80018ad0 <tickslock>
    80002a7e:	854a                	mv	a0,s2
    80002a80:	ffffe097          	auipc	ra,0xffffe
    80002a84:	164080e7          	jalr	356(ra) # 80000be4 <acquire>
  ticks++;
    80002a88:	00006497          	auipc	s1,0x6
    80002a8c:	5a848493          	addi	s1,s1,1448 # 80009030 <ticks>
    80002a90:	409c                	lw	a5,0(s1)
    80002a92:	2785                	addiw	a5,a5,1
    80002a94:	c09c                	sw	a5,0(s1)
  update_vals();
    80002a96:	00000097          	auipc	ra,0x0
    80002a9a:	bdc080e7          	jalr	-1060(ra) # 80002672 <update_vals>
  wakeup(&ticks);
    80002a9e:	8526                	mv	a0,s1
    80002aa0:	00000097          	auipc	ra,0x0
    80002aa4:	854080e7          	jalr	-1964(ra) # 800022f4 <wakeup>
  release(&tickslock);
    80002aa8:	854a                	mv	a0,s2
    80002aaa:	ffffe097          	auipc	ra,0xffffe
    80002aae:	1ee080e7          	jalr	494(ra) # 80000c98 <release>
}
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80002af4:	5e8080e7          	jalr	1512(ra) # 800060d8 <plic_claim>
    ...
    80002b10:	7ec50513          	addi	a0,a0,2028 # 800082f8 <states.1737+0x38>
  ...
  asm volatile("csrw sip, %0" : : "r" (x));
    ...
    80002b5a:	f14080e7          	jalr	-236(ra) # 80002a6a <clockintr>
...
0000000080002b60 <usertrap>:
{
  ...
  if((r_sstatus() & SSTATUS_SPP) != 0)
    ...
    80002b72:	e3a5                	bnez	a5,80002bd2 <usertrap+0x72>
  asm volatile("csrw stvec, %0" : : "r" (x));
    80002b74:	00003797          	auipc	a5,0x3
    80002b78:	45c78793          	addi	a5,a5,1116 # 80005fd0 <kernelvec>
    80002b7c:	10579073          	csrw	stvec,a5
  struct proc *p = myproc();
    80002b80:	fffff097          	auipc	ra,0xfffff
    80002b84:	e30080e7          	jalr	-464(ra) # 800019b0 <myproc>
  ...
  if(r_scause() == 8){
    ...
    80002b98:	04f71b63          	bne	a4,a5,80002bee <usertrap+0x8e>
    if(p->killed)
    80002b9c:	551c                	lw	a5,40(a0)
    80002b9e:	e3b1                	bnez	a5,80002be2 <usertrap+0x82>
    p->trapframe->epc += 4;
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80002bb8:	29a080e7          	jalr	666(ra) # 80002e4e <syscall>
  if(p->killed)
    80002bbc:	549c                	lw	a5,40(s1)
    80002bbe:	e7b5                	bnez	a5,80002c2a <usertrap+0xca>
  usertrapret();
    80002bc0:	00000097          	auipc	ra,0x0
    80002bc4:	e0c080e7          	jalr	-500(ra) # 800029cc <usertrapret>
}
    ...
    80002bd6:	74650513          	addi	a0,a0,1862 # 80008318 <states.1737+0x58>
    ...
    80002be8:	7e0080e7          	jalr	2016(ra) # 800023c4 <exit>
    80002bec:	bf55                	j	80002ba0 <usertrap+0x40>
  } else if((which_dev = devintr()) != 0){
    80002bee:	00000097          	auipc	ra,0x0
    80002bf2:	ed0080e7          	jalr	-304(ra) # 80002abe <devintr>
    80002bf6:	f179                	bnez	a0,80002bbc <usertrap+0x5c>
  asm volatile("csrr %0, scause" : "=r" (x) );
    80002bf8:	142025f3          	csrr	a1,scause
    printf("usertrap(): unexpected scause %p pid=%d\n", r_scause(), p->pid);
    80002bfc:	5890                	lw	a2,48(s1)
    80002bfe:	00005517          	auipc	a0,0x5
    80002c02:	73a50513          	addi	a0,a0,1850 # 80008338 <states.1737+0x78>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80002c1a:	75250513          	addi	a0,a0,1874 # 80008368 <states.1737+0xa8>
    80002c1e:	ffffe097          	auipc	ra,0xffffe
    80002c22:	96a080e7          	jalr	-1686(ra) # 80000588 <printf>
    p->killed = 1;
    80002c26:	4785                	li	a5,1
    80002c28:	d49c                	sw	a5,40(s1)
    exit(-1);
    80002c2a:	557d                	li	a0,-1
    80002c2c:	fffff097          	auipc	ra,0xfffff
    80002c30:	798080e7          	jalr	1944(ra) # 800023c4 <exit>
    80002c34:	b771                	j	80002bc0 <usertrap+0x60>
...
0000000080002c36 <kerneltrap>:
{
  ...
  if((sstatus & SSTATUS_SPP) == 0)
    ...
    80002c54:	c78d                	beqz	a5,80002c7e <kerneltrap+0x48>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80002c56:	100027f3          	csrr	a5,sstatus
  return (x & SSTATUS_SIE) != 0;
    80002c5a:	8b89                	andi	a5,a5,2
  if(intr_get() != 0)
    80002c5c:	eb8d                	bnez	a5,80002c8e <kerneltrap+0x58>
  if((which_dev = devintr()) == 0){
    80002c5e:	00000097          	auipc	ra,0x0
    80002c62:	e60080e7          	jalr	-416(ra) # 80002abe <devintr>
    80002c66:	cd05                	beqz	a0,80002c9e <kerneltrap+0x68>
  asm volatile("csrw sepc, %0" : : "r" (x));
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80002c82:	70a50513          	addi	a0,a0,1802 # 80008388 <states.1737+0xc8>
    80002c86:	ffffe097          	auipc	ra,0xffffe
    80002c8a:	8b8080e7          	jalr	-1864(ra) # 8000053e <panic>
    panic("kerneltrap: interrupts enabled");
    80002c8e:	00005517          	auipc	a0,0x5
    80002c92:	72250513          	addi	a0,a0,1826 # 800083b0 <states.1737+0xf0>
    80002c96:	ffffe097          	auipc	ra,0xffffe
    80002c9a:	8a8080e7          	jalr	-1880(ra) # 8000053e <panic>
    printf("scause %p\n", scause);
    80002c9e:	85ce                	mv	a1,s3
    80002ca0:	00005517          	auipc	a0,0x5
    80002ca4:	73050513          	addi	a0,a0,1840 # 800083d0 <states.1737+0x110>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80002cbc:	72850513          	addi	a0,a0,1832 # 800083e0 <states.1737+0x120>
    80002cc0:	ffffe097          	auipc	ra,0xffffe
    80002cc4:	8c8080e7          	jalr	-1848(ra) # 80000588 <printf>
    panic("kerneltrap");
    80002cc8:	00005517          	auipc	a0,0x5
    80002ccc:	73050513          	addi	a0,a0,1840 # 800083f8 <states.1737+0x138>
...
argraw(int n)
{
  ...
  switch (n) {
    ...
    80002cf8:	76c70713          	addi	a4,a4,1900 # 80008460 <states.1737+0x1a0>
  ...
  panic("argraw");
    ...
    80002d34:	6d850513          	addi	a0,a0,1752 # 80008408 <states.1737+0x148>
    80002d38:	ffffe097          	auipc	ra,0xffffe
    80002d3c:	806080e7          	jalr	-2042(ra) # 8000053e <panic>
...
0000000080002d40 <fetchaddr>:
{
  ...
  struct proc *p = myproc();
    ...
    80002d54:	c60080e7          	jalr	-928(ra) # 800019b0 <myproc>
  if(addr >= p->sz || addr+sizeof(uint64) > p->sz)
    80002d58:	653c                	ld	a5,72(a0)
  ...
  if(copyin(p->pagetable, (char *)ip, addr, sizeof(*ip)) != 0)
    ...
    80002d72:	990080e7          	jalr	-1648(ra) # 800016fe <copyin>
...
syscall(void)
{
  ...
  struct proc *p = myproc();
    ...
    80002e62:	b52080e7          	jalr	-1198(ra) # 800019b0 <myproc>
    80002e66:	892a                	mv	s2,a0

  num = p->trapframe->a7;
    80002e68:	6d24                	ld	s1,88(a0)
    80002e6a:	74dc                	ld	a5,168(s1)
    80002e6c:	0007899b          	sext.w	s3,a5
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    80002e70:	37fd                	addiw	a5,a5,-1
    80002e72:	475d                	li	a4,23
    80002e74:	0af76863          	bltu	a4,a5,80002f24 <syscall+0xd6>
    80002e78:	00399713          	slli	a4,s3,0x3
    80002e7c:	00005797          	auipc	a5,0x5
    80002e80:	5fc78793          	addi	a5,a5,1532 # 80008478 <syscalls>
    80002e84:	97ba                	add	a5,a5,a4
    80002e86:	639c                	ld	a5,0(a5)
    80002e88:	cfd1                	beqz	a5,80002f24 <syscall+0xd6>
    int temp_trap = p->trapframe->a0;
    80002e8a:	0704ba03          	ld	s4,112(s1)
    p->trapframe->a0 = syscalls[num]();
    80002e8e:	9782                	jalr	a5
    80002e90:	f8a8                	sd	a0,112(s1)

    if (p->mask & (int)1<<num)
    80002e92:	16892483          	lw	s1,360(s2)
    80002e96:	4134d4bb          	sraw	s1,s1,s3
    80002e9a:	8885                	andi	s1,s1,1
    80002e9c:	c4cd                	beqz	s1,80002f46 <syscall+0xf8>
    {
      printf("%d: syscall %s ( %d ", p->pid, syscall_name[num], temp_trap);
    80002e9e:	00299793          	slli	a5,s3,0x2
    80002ea2:	97ce                	add	a5,a5,s3
    80002ea4:	078a                	slli	a5,a5,0x2
    80002ea6:	000a069b          	sext.w	a3,s4
    80002eaa:	00006617          	auipc	a2,0x6
    80002eae:	a5e60613          	addi	a2,a2,-1442 # 80008908 <syscall_name>
    80002eb2:	963e                	add	a2,a2,a5
    80002eb4:	03092583          	lw	a1,48(s2)
    80002eb8:	00005517          	auipc	a0,0x5
    80002ebc:	55850513          	addi	a0,a0,1368 # 80008410 <states.1737+0x150>
    80002ec0:	ffffd097          	auipc	ra,0xffffd
    80002ec4:	6c8080e7          	jalr	1736(ra) # 80000588 <printf>
      
      int temp;
      for(int i=1; i < syscall_argc[num-1]; i++)
    80002ec8:	39fd                	addiw	s3,s3,-1
    80002eca:	00299793          	slli	a5,s3,0x2
    80002ece:	00005997          	auipc	s3,0x5
    80002ed2:	5aa98993          	addi	s3,s3,1450 # 80008478 <syscalls>
    80002ed6:	99be                	add	s3,s3,a5
    80002ed8:	0c89a983          	lw	s3,200(s3)
    80002edc:	4785                	li	a5,1
    80002ede:	0337d763          	bge	a5,s3,80002f0c <syscall+0xbe>
      {
          argint(i, &temp);
          printf("%d ", temp);
    80002ee2:	00005a17          	auipc	s4,0x5
    80002ee6:	546a0a13          	addi	s4,s4,1350 # 80008428 <states.1737+0x168>
          argint(i, &temp);
    80002eea:	fcc40593          	addi	a1,s0,-52
    80002eee:	8526                	mv	a0,s1
    80002ef0:	00000097          	auipc	ra,0x0
    80002ef4:	eea080e7          	jalr	-278(ra) # 80002dda <argint>
          printf("%d ", temp);
    80002ef8:	fcc42583          	lw	a1,-52(s0)
    ...
    80002f08:	ff3491e3          	bne	s1,s3,80002eea <syscall+0x9c>
      }

      printf(") -> %d\n", p->trapframe->a0);
    80002f0c:	05893783          	ld	a5,88(s2)
    80002f10:	7bac                	ld	a1,112(a5)
    80002f12:	00005517          	auipc	a0,0x5
    80002f16:	51e50513          	addi	a0,a0,1310 # 80008430 <states.1737+0x170>
    80002f1a:	ffffd097          	auipc	ra,0xffffd
    80002f1e:	66e080e7          	jalr	1646(ra) # 80000588 <printf>
    80002f22:	a015                	j	80002f46 <syscall+0xf8>
    }

  } else {
    printf("%d %s: unknown sys call %d\n",
    80002f24:	86ce                	mv	a3,s3
    80002f26:	15890613          	addi	a2,s2,344
    80002f2a:	03092583          	lw	a1,48(s2)
    80002f2e:	00005517          	auipc	a0,0x5
    80002f32:	51250513          	addi	a0,a0,1298 # 80008440 <states.1737+0x180>
    80002f36:	ffffd097          	auipc	ra,0xffffd
    80002f3a:	652080e7          	jalr	1618(ra) # 80000588 <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
    80002f3e:	05893783          	ld	a5,88(s2)
    80002f42:	577d                	li	a4,-1
    80002f44:	fbb8                	sd	a4,112(a5)
  }
}
    80002f46:	70e2                	ld	ra,56(sp)
    80002f48:	7442                	ld	s0,48(sp)
    80002f4a:	74a2                	ld	s1,40(sp)
    80002f4c:	7902                	ld	s2,32(sp)
    80002f4e:	69e2                	ld	s3,24(sp)
    80002f50:	6a42                	ld	s4,16(sp)
...
sys_exit(void)
{
  ...
  if(argint(0, &n) < 0)
    ...
    80002f68:	e76080e7          	jalr	-394(ra) # 80002dda <argint>
    return -1;
  ...
  exit(n);
    ...
    80002f7a:	44e080e7          	jalr	1102(ra) # 800023c4 <exit>
...
sys_fork(void)
{
  ...
  return fork();
    ...
    80002fb0:	e6c080e7          	jalr	-404(ra) # 80001e18 <fork>
}
...
sys_wait(void)
{
  ...
  if(argaddr(0, &p) < 0)
    ...
    80002fce:	e32080e7          	jalr	-462(ra) # 80002dfc <argaddr>
  ...
  return wait(p);
    ...
    80002fe2:	1ee080e7          	jalr	494(ra) # 800021cc <wait>
}
...
sys_sbrk(void)
{
  ...
  if(argint(0, &n) < 0)
    ...
    80003002:	ddc080e7          	jalr	-548(ra) # 80002dda <argint>
  ...
  addr = myproc()->sz;
    ...
    80003012:	9a2080e7          	jalr	-1630(ra) # 800019b0 <myproc>
    80003016:	4524                	lw	s1,72(a0)
  if(growproc(n) < 0)
    80003018:	fdc42503          	lw	a0,-36(s0)
    8000301c:	fffff097          	auipc	ra,0xfffff
    80003020:	d88080e7          	jalr	-632(ra) # 80001da4 <growproc>
...
sys_sleep(void)
{
  ...
  if(argint(0, &n) < 0)
    ...
    80003050:	d8e080e7          	jalr	-626(ra) # 80002dda <argint>
    return -1;
  ...
  acquire(&tickslock);
    ...
    8000305e:	a7650513          	addi	a0,a0,-1418 # 80018ad0 <tickslock>
  ...
  while(ticks - ticks0 < n){
    ...
    80003078:	00016997          	auipc	s3,0x16
    8000307c:	a5898993          	addi	s3,s3,-1448 # 80018ad0 <tickslock>
    80003080:	00006497          	auipc	s1,0x6
    80003084:	fb048493          	addi	s1,s1,-80 # 80009030 <ticks>
    if(myproc()->killed){
    80003088:	fffff097          	auipc	ra,0xfffff
    8000308c:	928080e7          	jalr	-1752(ra) # 800019b0 <myproc>
    ...
    8000309c:	0d0080e7          	jalr	208(ra) # 80002168 <sleep>
  while(ticks - ticks0 < n){
  ...
  release(&tickslock);
    ...
    800030b2:	a2250513          	addi	a0,a0,-1502 # 80018ad0 <tickslock>
  ...
  return 0;
    ...
    800030d4:	a0050513          	addi	a0,a0,-1536 # 80018ad0 <tickslock>
...
sys_kill(void)
{
  ...
  if(argint(0, &pid) < 0)
    ...
    800030f6:	ce8080e7          	jalr	-792(ra) # 80002dda <argint>
  ...
  return kill(pid);
    ...
    8000310a:	3a0080e7          	jalr	928(ra) # 800024a6 <kill>
}
...
sys_uptime(void)
{
  ...
  release(&tickslock);
    ...
    8000313c:	99850513          	addi	a0,a0,-1640 # 80018ad0 <tickslock>
    80003140:	ffffe097          	auipc	ra,0xffffe
    80003144:	b58080e7          	jalr	-1192(ra) # 80000c98 <release>
  return xticks;
}
...
sys_strace(void)
{
  ...
  if(argint(0, &mask) < 0)
    ...
    8000316a:	c74080e7          	jalr	-908(ra) # 80002dda <argint>
    return -1;
    8000316e:	577d                	li	a4,-1
  if(argint(0, &mask) < 0)
    80003170:	02054063          	bltz	a0,80003190 <sys_strace+0x38>

  struct proc *process = myproc();
    80003174:	fffff097          	auipc	ra,0xfffff
    80003178:	83c080e7          	jalr	-1988(ra) # 800019b0 <myproc>

  if(process -> mask > 0)
    8000317c:	16852683          	lw	a3,360(a0)
    return -1;
    80003180:	577d                	li	a4,-1
  if(process -> mask > 0)
    80003182:	00d04763          	bgtz	a3,80003190 <sys_strace+0x38>
  
  process->mask = mask;
    80003186:	fec42703          	lw	a4,-20(s0)
    8000318a:	16e52423          	sw	a4,360(a0)

  return 0;
    8000318e:	4701                	li	a4,0
}
    80003190:	853a                	mv	a0,a4
    80003192:	60e2                	ld	ra,24(sp)
    80003194:	6442                	ld	s0,16(sp)
    80003196:	6105                	addi	sp,sp,32
    80003198:	8082                	ret

000000008000319a <sys_set_priority>:
...
sys_set_priority(void)
{
  ...
  argint(0, &new_priority);
    ...
    800031ac:	c32080e7          	jalr	-974(ra) # 80002dda <argint>
  argint(0, &pid);
    800031b0:	fe840593          	addi	a1,s0,-24
    800031b4:	4501                	li	a0,0
    800031b6:	00000097          	auipc	ra,0x0
    800031ba:	c24080e7          	jalr	-988(ra) # 80002dda <argint>
  
  priority_updater(new_priority, pid);
    800031be:	fe842583          	lw	a1,-24(s0)
    800031c2:	fec42503          	lw	a0,-20(s0)
    800031c6:	fffff097          	auipc	ra,0xfffff
    800031ca:	586080e7          	jalr	1414(ra) # 8000274c <priority_updater>
...
sys_waitx(void)
{
  ...
  if(argaddr(0, &addr) < 0)
    ...
    800031ee:	c12080e7          	jalr	-1006(ra) # 80002dfc <argaddr>
    return -1;
    800031f2:	57fd                	li	a5,-1
  if(argaddr(0, &addr) < 0)
    800031f4:	08054063          	bltz	a0,80003274 <sys_waitx+0x9c>
  if(argaddr(1, &addr1) < 0) // user virtual memory
    ...
    80003202:	bfe080e7          	jalr	-1026(ra) # 80002dfc <argaddr>
    return -1;
    80003206:	57fd                	li	a5,-1
  if(argaddr(1, &addr1) < 0) // user virtual memory
    80003208:	06054663          	bltz	a0,80003274 <sys_waitx+0x9c>
  if(argaddr(2, &addr2) < 0)
    8000320c:	fc840593          	addi	a1,s0,-56
    80003210:	4509                	li	a0,2
    80003212:	00000097          	auipc	ra,0x0
    80003216:	bea080e7          	jalr	-1046(ra) # 80002dfc <argaddr>
    return -1;
    8000321a:	57fd                	li	a5,-1
  if(argaddr(2, &addr2) < 0)
    8000321c:	04054c63          	bltz	a0,80003274 <sys_waitx+0x9c>
  int ret = waitx(addr, &wtime, &rtime);
    80003220:	fc040613          	addi	a2,s0,-64
    80003224:	fc440593          	addi	a1,s0,-60
    80003228:	fd843503          	ld	a0,-40(s0)
    8000322c:	fffff097          	auipc	ra,0xfffff
    80003230:	5a6080e7          	jalr	1446(ra) # 800027d2 <waitx>
    80003234:	892a                	mv	s2,a0
  struct proc* p = myproc();
    80003236:	ffffe097          	auipc	ra,0xffffe
    8000323a:	77a080e7          	jalr	1914(ra) # 800019b0 <myproc>
    8000323e:	84aa                	mv	s1,a0
  if (copyout(p->pagetable, addr1,(char*)&wtime, sizeof(int)) < 0)
    80003240:	4691                	li	a3,4
    80003242:	fc440613          	addi	a2,s0,-60
    80003246:	fd043583          	ld	a1,-48(s0)
    8000324a:	6928                	ld	a0,80(a0)
    8000324c:	ffffe097          	auipc	ra,0xffffe
    80003250:	426080e7          	jalr	1062(ra) # 80001672 <copyout>
    return -1;
    80003254:	57fd                	li	a5,-1
  if (copyout(p->pagetable, addr1,(char*)&wtime, sizeof(int)) < 0)
    80003256:	00054f63          	bltz	a0,80003274 <sys_waitx+0x9c>
  if (copyout(p->pagetable, addr2,(char*)&rtime, sizeof(int)) < 0)
    8000325a:	4691                	li	a3,4
    8000325c:	fc040613          	addi	a2,s0,-64
    80003260:	fc843583          	ld	a1,-56(s0)
    80003264:	68a8                	ld	a0,80(s1)
    80003266:	ffffe097          	auipc	ra,0xffffe
    8000326a:	40c080e7          	jalr	1036(ra) # 80001672 <copyout>
    8000326e:	00054a63          	bltz	a0,80003282 <sys_waitx+0xaa>
    return -1;
  return ret;
    80003272:	87ca                	mv	a5,s2
    ...
    80003284:	bfc5                	j	80003274 <sys_waitx+0x9c>

0000000080003286 <binit>:
  struct buf head;
} bcache;
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    80003296:	00005597          	auipc	a1,0x5
    8000329a:	30a58593          	addi	a1,a1,778 # 800085a0 <syscall_argc+0x60>
    8000329e:	00016517          	auipc	a0,0x16
    800032a2:	84a50513          	addi	a0,a0,-1974 # 80018ae8 <bcache>
    800032a6:	ffffe097          	auipc	ra,0xffffe
    800032aa:	8ae080e7          	jalr	-1874(ra) # 80000b54 <initlock>

  // Create linked list of buffers
  bcache.head.prev = &bcache.head;
    800032ae:	0001e797          	auipc	a5,0x1e
    800032b2:	83a78793          	addi	a5,a5,-1990 # 80020ae8 <bcache+0x8000>
    800032b6:	0001e717          	auipc	a4,0x1e
    800032ba:	a9a70713          	addi	a4,a4,-1382 # 80020d50 <bcache+0x8268>
    800032be:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    800032c2:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    800032c6:	00016497          	auipc	s1,0x16
    800032ca:	83a48493          	addi	s1,s1,-1990 # 80018b00 <bcache+0x18>
    b->next = bcache.head.next;
    800032ce:	893e                	mv	s2,a5
    b->prev = &bcache.head;
    800032d0:	89ba                	mv	s3,a4
    initsleeplock(&b->lock, "buffer");
    800032d2:	00005a17          	auipc	s4,0x5
    800032d6:	2d6a0a13          	addi	s4,s4,726 # 800085a8 <syscall_argc+0x68>
    b->next = bcache.head.next;
    800032da:	2b893783          	ld	a5,696(s2)
    800032de:	e8bc                	sd	a5,80(s1)
    b->prev = &bcache.head;
    800032e0:	0534b423          	sd	s3,72(s1)
    initsleeplock(&b->lock, "buffer");
    800032e4:	85d2                	mv	a1,s4
    800032e6:	01048513          	addi	a0,s1,16
    800032ea:	00001097          	auipc	ra,0x1
    800032ee:	4bc080e7          	jalr	1212(ra) # 800047a6 <initsleeplock>
    bcache.head.next->prev = b;
    800032f2:	2b893783          	ld	a5,696(s2)
    800032f6:	e7a4                	sd	s1,72(a5)
    bcache.head.next = b;
    800032f8:	2a993c23          	sd	s1,696(s2)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    800032fc:	45848493          	addi	s1,s1,1112
    80003300:	fd349de3          	bne	s1,s3,800032da <binit+0x54>
  }
}
    ...
    8000330e:	6a02                	ld	s4,0(sp)
    80003310:	6145                	addi	sp,sp,48
    80003312:	8082                	ret

0000000080003314 <bread>:
}
...
bread(uint dev, uint blockno)
{
    ...
    80003324:	892e                	mv	s2,a1
  acquire(&bcache.lock);
    80003326:	00015517          	auipc	a0,0x15
    8000332a:	7c250513          	addi	a0,a0,1986 # 80018ae8 <bcache>
    8000332e:	ffffe097          	auipc	ra,0xffffe
    80003332:	8b6080e7          	jalr	-1866(ra) # 80000be4 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    80003336:	0001e497          	auipc	s1,0x1e
    8000333a:	a6a4b483          	ld	s1,-1430(s1) # 80020da0 <bcache+0x82b8>
    8000333e:	0001e797          	auipc	a5,0x1e
    80003342:	a1278793          	addi	a5,a5,-1518 # 80020d50 <bcache+0x8268>
    80003346:	02f48f63          	beq	s1,a5,80003384 <bread+0x70>
    8000334a:	873e                	mv	a4,a5
    8000334c:	a021                	j	80003354 <bread+0x40>
    8000334e:	68a4                	ld	s1,80(s1)
    80003350:	02e48a63          	beq	s1,a4,80003384 <bread+0x70>
    if(b->dev == dev && b->blockno == blockno){
    80003354:	449c                	lw	a5,8(s1)
    80003356:	ff379ce3          	bne	a5,s3,8000334e <bread+0x3a>
    8000335a:	44dc                	lw	a5,12(s1)
    8000335c:	ff2799e3          	bne	a5,s2,8000334e <bread+0x3a>
      b->refcnt++;
    ...
    8000336a:	78250513          	addi	a0,a0,1922 # 80018ae8 <bcache>
    ...
    8000337e:	466080e7          	jalr	1126(ra) # 800047e0 <acquiresleep>
      return b;
    80003382:	a8b9                	j	800033e0 <bread+0xcc>
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    80003384:	0001e497          	auipc	s1,0x1e
    80003388:	a144b483          	ld	s1,-1516(s1) # 80020d98 <bcache+0x82b0>
    8000338c:	0001e797          	auipc	a5,0x1e
    80003390:	9c478793          	addi	a5,a5,-1596 # 80020d50 <bcache+0x8268>
    80003394:	00f48863          	beq	s1,a5,800033a4 <bread+0x90>
    80003398:	873e                	mv	a4,a5
    if(b->refcnt == 0) {
    8000339a:	40bc                	lw	a5,64(s1)
    8000339c:	cf81                	beqz	a5,800033b4 <bread+0xa0>
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    8000339e:	64a4                	ld	s1,72(s1)
    800033a0:	fee49de3          	bne	s1,a4,8000339a <bread+0x86>
  panic("bget: no buffers");
    800033a4:	00005517          	auipc	a0,0x5
    800033a8:	20c50513          	addi	a0,a0,524 # 800085b0 <syscall_argc+0x70>
    800033ac:	ffffd097          	auipc	ra,0xffffd
    800033b0:	192080e7          	jalr	402(ra) # 8000053e <panic>
      b->dev = dev;
    800033b4:	0134a423          	sw	s3,8(s1)
      b->blockno = blockno;
    800033b8:	0124a623          	sw	s2,12(s1)
      b->valid = 0;
    800033bc:	0004a023          	sw	zero,0(s1)
      b->refcnt = 1;
    800033c0:	4785                	li	a5,1
    800033c2:	c0bc                	sw	a5,64(s1)
      release(&bcache.lock);
    800033c4:	00015517          	auipc	a0,0x15
    800033c8:	72450513          	addi	a0,a0,1828 # 80018ae8 <bcache>
    ...
    800033dc:	408080e7          	jalr	1032(ra) # 800047e0 <acquiresleep>
  struct buf *b;

  b = bget(dev, blockno);
  if(!b->valid) {
    800033e0:	409c                	lw	a5,0(s1)
    800033e2:	cb89                	beqz	a5,800033f4 <bread+0xe0>
    virtio_disk_rw(b, 0);
    b->valid = 1;
  }
  return b;
    ...
    800033fc:	f0e080e7          	jalr	-242(ra) # 80006306 <virtio_disk_rw>
    b->valid = 1;
    80003400:	4785                	li	a5,1
    80003402:	c09c                	sw	a5,0(s1)
  return b;
    80003404:	b7c5                	j	800033e4 <bread+0xd0>

0000000080003406 <bwrite>:
...
bwrite(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    80003412:	0541                	addi	a0,a0,16
    80003414:	00001097          	auipc	ra,0x1
    80003418:	466080e7          	jalr	1126(ra) # 8000487a <holdingsleep>
    8000341c:	cd01                	beqz	a0,80003434 <bwrite+0x2e>
    panic("bwrite");
  virtio_disk_rw(b, 1);
    8000341e:	4585                	li	a1,1
    80003420:	8526                	mv	a0,s1
    80003422:	00003097          	auipc	ra,0x3
    80003426:	ee4080e7          	jalr	-284(ra) # 80006306 <virtio_disk_rw>
}
    ...
    80003438:	19450513          	addi	a0,a0,404 # 800085c8 <syscall_argc+0x88>
    8000343c:	ffffd097          	auipc	ra,0xffffd
    80003440:	102080e7          	jalr	258(ra) # 8000053e <panic>

0000000080003444 <brelse>:
...
brelse(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    80003452:	01050913          	addi	s2,a0,16
    80003456:	854a                	mv	a0,s2
    80003458:	00001097          	auipc	ra,0x1
    8000345c:	422080e7          	jalr	1058(ra) # 8000487a <holdingsleep>
    80003460:	c92d                	beqz	a0,800034d2 <brelse+0x8e>
    panic("brelse");

  releasesleep(&b->lock);
    80003462:	854a                	mv	a0,s2
    80003464:	00001097          	auipc	ra,0x1
    80003468:	3d2080e7          	jalr	978(ra) # 80004836 <releasesleep>

  acquire(&bcache.lock);
    8000346c:	00015517          	auipc	a0,0x15
    80003470:	67c50513          	addi	a0,a0,1660 # 80018ae8 <bcache>
  ...
  if (b->refcnt == 0) {
    80003486:	eb05                	bnez	a4,800034b6 <brelse+0x72>
    // no one is waiting for it.
    b->next->prev = b->prev;
    80003488:	68bc                	ld	a5,80(s1)
    8000348a:	64b8                	ld	a4,72(s1)
    8000348c:	e7b8                	sd	a4,72(a5)
    b->prev->next = b->next;
    8000348e:	64bc                	ld	a5,72(s1)
    80003490:	68b8                	ld	a4,80(s1)
    80003492:	ebb8                	sd	a4,80(a5)
    b->next = bcache.head.next;
    80003494:	0001d797          	auipc	a5,0x1d
    80003498:	65478793          	addi	a5,a5,1620 # 80020ae8 <bcache+0x8000>
    8000349c:	2b87b703          	ld	a4,696(a5)
    800034a0:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    800034a2:	0001e717          	auipc	a4,0x1e
    800034a6:	8ae70713          	addi	a4,a4,-1874 # 80020d50 <bcache+0x8268>
    800034aa:	e4b8                	sd	a4,72(s1)
    bcache.head.next->prev = b;
    800034ac:	2b87b703          	ld	a4,696(a5)
    800034b0:	e724                	sd	s1,72(a4)
    bcache.head.next = b;
    800034b2:	2a97bc23          	sd	s1,696(a5)
  }
  
  release(&bcache.lock);
    800034b6:	00015517          	auipc	a0,0x15
    800034ba:	63250513          	addi	a0,a0,1586 # 80018ae8 <bcache>
    800034be:	ffffd097          	auipc	ra,0xffffd
    800034c2:	7da080e7          	jalr	2010(ra) # 80000c98 <release>
}
    ...
    800034d6:	0fe50513          	addi	a0,a0,254 # 800085d0 <syscall_argc+0x90>
    800034da:	ffffd097          	auipc	ra,0xffffd
    800034de:	064080e7          	jalr	100(ra) # 8000053e <panic>

00000000800034e2 <bpin>:
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800034f2:	5fa50513          	addi	a0,a0,1530 # 80018ae8 <bcache>
  ...
  release(&bcache.lock);
    ...
    80003508:	5e450513          	addi	a0,a0,1508 # 80018ae8 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    8000352a:	00015517          	auipc	a0,0x15
    8000352e:	5be50513          	addi	a0,a0,1470 # 80018ae8 <bcache>
    80003532:	ffffd097          	auipc	ra,0xffffd
    80003536:	6b2080e7          	jalr	1714(ra) # 80000be4 <acquire>
  b->refcnt--;
    8000353a:	40bc                	lw	a5,64(s1)
    8000353c:	37fd                	addiw	a5,a5,-1
    8000353e:	c0bc                	sw	a5,64(s1)
  release(&bcache.lock);
    80003540:	00015517          	auipc	a0,0x15
    80003544:	5a850513          	addi	a0,a0,1448 # 80018ae8 <bcache>
    80003548:	ffffd097          	auipc	ra,0xffffd
    8000354c:	750080e7          	jalr	1872(ra) # 80000c98 <release>
}
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    80003568:	00d5d59b          	srliw	a1,a1,0xd
    8000356c:	0001e797          	auipc	a5,0x1e
    80003570:	c587a783          	lw	a5,-936(a5) # 800211c4 <sb+0x1c>
    80003574:	9dbd                	addw	a1,a1,a5
    80003576:	00000097          	auipc	ra,0x0
    8000357a:	d9e080e7          	jalr	-610(ra) # 80003314 <bread>
  bi = b % BPB;
  m = 1 << (bi % 8);
    8000357e:	0074f713          	andi	a4,s1,7
    80003582:	4785                	li	a5,1
    80003584:	00e797bb          	sllw	a5,a5,a4
  if((bp->data[bi/8] & m) == 0)
    80003588:	14ce                	slli	s1,s1,0x33
    8000358a:	90d9                	srli	s1,s1,0x36
    8000358c:	00950733          	add	a4,a0,s1
    80003590:	05874703          	lbu	a4,88(a4)
    80003594:	00e7f6b3          	and	a3,a5,a4
    80003598:	c69d                	beqz	a3,800035c6 <bfree+0x6c>
    8000359a:	892a                	mv	s2,a0
    panic("freeing free block");
  bp->data[bi/8] &= ~m;
    8000359c:	94aa                	add	s1,s1,a0
    8000359e:	fff7c793          	not	a5,a5
    800035a2:	8ff9                	and	a5,a5,a4
    800035a4:	04f48c23          	sb	a5,88(s1)
  log_write(bp);
    800035a8:	00001097          	auipc	ra,0x1
    800035ac:	118080e7          	jalr	280(ra) # 800046c0 <log_write>
  brelse(bp);
    800035b0:	854a                	mv	a0,s2
    800035b2:	00000097          	auipc	ra,0x0
    800035b6:	e92080e7          	jalr	-366(ra) # 80003444 <brelse>
}
    ...
    800035ca:	01250513          	addi	a0,a0,18 # 800085d8 <syscall_argc+0x98>
    800035ce:	ffffd097          	auipc	ra,0xffffd
    800035d2:	f70080e7          	jalr	-144(ra) # 8000053e <panic>

00000000800035d6 <balloc>:
{
    800035d6:	711d                	addi	sp,sp,-96
    800035d8:	ec86                	sd	ra,88(sp)
    800035da:	e8a2                	sd	s0,80(sp)
    800035dc:	e4a6                	sd	s1,72(sp)
    ...
    800035ee:	1080                	addi	s0,sp,96
  for(b = 0; b < sb.size; b += BPB){
    800035f0:	0001e797          	auipc	a5,0x1e
    800035f4:	bbc7a783          	lw	a5,-1092(a5) # 800211ac <sb+0x4>
    800035f8:	cbd1                	beqz	a5,8000368c <balloc+0xb6>
    800035fa:	8baa                	mv	s7,a0
    800035fc:	4a81                	li	s5,0
    bp = bread(dev, BBLOCK(b, sb));
    800035fe:	0001eb17          	auipc	s6,0x1e
    80003602:	baab0b13          	addi	s6,s6,-1110 # 800211a8 <sb>
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    80003646:	cd2080e7          	jalr	-814(ra) # 80003314 <bread>
    8000364a:	892a                	mv	s2,a0
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
    8000364c:	004b2503          	lw	a0,4(s6)
    80003650:	000a849b          	sext.w	s1,s5
    80003654:	8662                	mv	a2,s8
    80003656:	faa4fde3          	bgeu	s1,a0,80003610 <balloc+0x3a>
      m = 1 << (bi % 8);
    8000365a:	41f6579b          	sraiw	a5,a2,0x1f
    8000365e:	01d7d69b          	srliw	a3,a5,0x1d
    80003662:	00c6873b          	addw	a4,a3,a2
    80003666:	00777793          	andi	a5,a4,7
    8000366a:	9f95                	subw	a5,a5,a3
    8000366c:	00f997bb          	sllw	a5,s3,a5
      if((bp->data[bi/8] & m) == 0){  // Is block free?
    80003670:	4037571b          	sraiw	a4,a4,0x3
    80003674:	00e906b3          	add	a3,s2,a4
    80003678:	0586c683          	lbu	a3,88(a3)
    8000367c:	00d7f5b3          	and	a1,a5,a3
    80003680:	cd91                	beqz	a1,8000369c <balloc+0xc6>
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
    80003682:	2605                	addiw	a2,a2,1
    80003684:	2485                	addiw	s1,s1,1
    80003686:	fd4618e3          	bne	a2,s4,80003656 <balloc+0x80>
    8000368a:	b759                	j	80003610 <balloc+0x3a>
  panic("balloc: out of blocks");
    8000368c:	00005517          	auipc	a0,0x5
    80003690:	f6450513          	addi	a0,a0,-156 # 800085f0 <syscall_argc+0xb0>
    80003694:	ffffd097          	auipc	ra,0xffffd
    80003698:	eaa080e7          	jalr	-342(ra) # 8000053e <panic>
        bp->data[bi/8] |= m;  // Mark block in use.
    8000369c:	974a                	add	a4,a4,s2
    8000369e:	8fd5                	or	a5,a5,a3
    800036a0:	04f70c23          	sb	a5,88(a4)
        log_write(bp);
    800036a4:	854a                	mv	a0,s2
    800036a6:	00001097          	auipc	ra,0x1
    800036aa:	01a080e7          	jalr	26(ra) # 800046c0 <log_write>
        brelse(bp);
    800036ae:	854a                	mv	a0,s2
    800036b0:	00000097          	auipc	ra,0x0
    800036b4:	d94080e7          	jalr	-620(ra) # 80003444 <brelse>
  bp = bread(dev, bno);
    800036b8:	85a6                	mv	a1,s1
    800036ba:	855e                	mv	a0,s7
    800036bc:	00000097          	auipc	ra,0x0
    800036c0:	c58080e7          	jalr	-936(ra) # 80003314 <bread>
    800036c4:	892a                	mv	s2,a0
  memset(bp->data, 0, BSIZE);
    800036c6:	40000613          	li	a2,1024
    800036ca:	4581                	li	a1,0
    800036cc:	05850513          	addi	a0,a0,88
    800036d0:	ffffd097          	auipc	ra,0xffffd
    800036d4:	610080e7          	jalr	1552(ra) # 80000ce0 <memset>
  log_write(bp);
    800036d8:	854a                	mv	a0,s2
    800036da:	00001097          	auipc	ra,0x1
    800036de:	fe6080e7          	jalr	-26(ra) # 800046c0 <log_write>
  brelse(bp);
    800036e2:	854a                	mv	a0,s2
    800036e4:	00000097          	auipc	ra,0x0
    800036e8:	d60080e7          	jalr	-672(ra) # 80003444 <brelse>
}
    800036ec:	8526                	mv	a0,s1
    800036ee:	60e6                	ld	ra,88(sp)
    800036f0:	6446                	ld	s0,80(sp)
    800036f2:	64a6                	ld	s1,72(sp)
    800036f4:	6906                	ld	s2,64(sp)
    800036f6:	79e2                	ld	s3,56(sp)
    800036f8:	7a42                	ld	s4,48(sp)
    800036fa:	7aa2                	ld	s5,40(sp)
    800036fc:	7b02                	ld	s6,32(sp)
    800036fe:	6be2                	ld	s7,24(sp)
    80003700:	6c42                	ld	s8,16(sp)
    80003702:	6ca2                	ld	s9,8(sp)
    80003704:	6125                	addi	sp,sp,96
    80003706:	8082                	ret
...
bmap(struct inode *ip, uint bn)
{
  ...
  if(bn < NDIRECT){
    8000371a:	47ad                	li	a5,11
    8000371c:	04b7fe63          	bgeu	a5,a1,80003778 <bmap+0x70>
  ...
  if(bn < NINDIRECT){
    ...
    8000372c:	0ae7e363          	bltu	a5,a4,800037d2 <bmap+0xca>
    // Load indirect block, allocating if necessary.
    if((addr = ip->addrs[NDIRECT]) == 0)
    80003730:	08052583          	lw	a1,128(a0)
    80003734:	c5ad                	beqz	a1,8000379e <bmap+0x96>
      ip->addrs[NDIRECT] = addr = balloc(ip->dev);
    bp = bread(ip->dev, addr);
    80003736:	00092503          	lw	a0,0(s2)
    8000373a:	00000097          	auipc	ra,0x0
    8000373e:	bda080e7          	jalr	-1062(ra) # 80003314 <bread>
    80003742:	8a2a                	mv	s4,a0
    a = (uint*)bp->data;
    80003744:	05850793          	addi	a5,a0,88
    if((addr = a[bn]) == 0){
    80003748:	02049593          	slli	a1,s1,0x20
    8000374c:	9181                	srli	a1,a1,0x20
    8000374e:	058a                	slli	a1,a1,0x2
    80003750:	00b784b3          	add	s1,a5,a1
    80003754:	0004a983          	lw	s3,0(s1)
    80003758:	04098d63          	beqz	s3,800037b2 <bmap+0xaa>
    ...
    80003762:	ce6080e7          	jalr	-794(ra) # 80003444 <brelse>
    return addr;
  }
  ...
  panic("bmap: out of range");
    ...
    80003776:	8082                	ret
    if((addr = ip->addrs[bn]) == 0)
    80003778:	02059493          	slli	s1,a1,0x20
    8000377c:	9081                	srli	s1,s1,0x20
    8000377e:	048a                	slli	s1,s1,0x2
    80003780:	94aa                	add	s1,s1,a0
    80003782:	0504a983          	lw	s3,80(s1)
    80003786:	fe0990e3          	bnez	s3,80003766 <bmap+0x5e>
      ip->addrs[bn] = addr = balloc(ip->dev);
    8000378a:	4108                	lw	a0,0(a0)
    8000378c:	00000097          	auipc	ra,0x0
    80003790:	e4a080e7          	jalr	-438(ra) # 800035d6 <balloc>
    80003794:	0005099b          	sext.w	s3,a0
    80003798:	0534a823          	sw	s3,80(s1)
    8000379c:	b7e9                	j	80003766 <bmap+0x5e>
      ip->addrs[NDIRECT] = addr = balloc(ip->dev);
    8000379e:	4108                	lw	a0,0(a0)
    800037a0:	00000097          	auipc	ra,0x0
    800037a4:	e36080e7          	jalr	-458(ra) # 800035d6 <balloc>
    800037a8:	0005059b          	sext.w	a1,a0
    800037ac:	08b92023          	sw	a1,128(s2)
    800037b0:	b759                	j	80003736 <bmap+0x2e>
      a[bn] = addr = balloc(ip->dev);
    800037b2:	00092503          	lw	a0,0(s2)
    800037b6:	00000097          	auipc	ra,0x0
    800037ba:	e20080e7          	jalr	-480(ra) # 800035d6 <balloc>
    800037be:	0005099b          	sext.w	s3,a0
    800037c2:	0134a023          	sw	s3,0(s1)
      log_write(bp);
    800037c6:	8552                	mv	a0,s4
    800037c8:	00001097          	auipc	ra,0x1
    800037cc:	ef8080e7          	jalr	-264(ra) # 800046c0 <log_write>
    800037d0:	b771                	j	8000375c <bmap+0x54>
  panic("bmap: out of range");
    800037d2:	00005517          	auipc	a0,0x5
    800037d6:	e3650513          	addi	a0,a0,-458 # 80008608 <syscall_argc+0xc8>
    800037da:	ffffd097          	auipc	ra,0xffffd
    800037de:	d64080e7          	jalr	-668(ra) # 8000053e <panic>

00000000800037e2 <iget>:
{
    ...
    800037ee:	e052                	sd	s4,0(sp)
    800037f0:	1800                	addi	s0,sp,48
    800037f2:	89aa                	mv	s3,a0
    800037f4:	8a2e                	mv	s4,a1
  acquire(&itable.lock);
    800037f6:	0001e517          	auipc	a0,0x1e
    800037fa:	9d250513          	addi	a0,a0,-1582 # 800211c8 <itable>
    800037fe:	ffffd097          	auipc	ra,0xffffd
    80003802:	3e6080e7          	jalr	998(ra) # 80000be4 <acquire>
  empty = 0;
    80003806:	4901                	li	s2,0
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    80003808:	0001e497          	auipc	s1,0x1e
    8000380c:	9d848493          	addi	s1,s1,-1576 # 800211e0 <itable+0x18>
    80003810:	0001f697          	auipc	a3,0x1f
    80003814:	46068693          	addi	a3,a3,1120 # 80022c70 <log>
    80003818:	a039                	j	80003826 <iget+0x44>
    if(empty == 0 && ip->ref == 0)    // Remember empty slot.
    8000381a:	02090b63          	beqz	s2,80003850 <iget+0x6e>
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    8000381e:	08848493          	addi	s1,s1,136
    80003822:	02d48a63          	beq	s1,a3,80003856 <iget+0x74>
    if(ip->ref > 0 && ip->dev == dev && ip->inum == inum){
    80003826:	449c                	lw	a5,8(s1)
    80003828:	fef059e3          	blez	a5,8000381a <iget+0x38>
    8000382c:	4098                	lw	a4,0(s1)
    8000382e:	ff3716e3          	bne	a4,s3,8000381a <iget+0x38>
    80003832:	40d8                	lw	a4,4(s1)
    80003834:	ff4713e3          	bne	a4,s4,8000381a <iget+0x38>
      ip->ref++;
    80003838:	2785                	addiw	a5,a5,1
    8000383a:	c49c                	sw	a5,8(s1)
      release(&itable.lock);
    8000383c:	0001e517          	auipc	a0,0x1e
    80003840:	98c50513          	addi	a0,a0,-1652 # 800211c8 <itable>
    80003844:	ffffd097          	auipc	ra,0xffffd
    80003848:	454080e7          	jalr	1108(ra) # 80000c98 <release>
      return ip;
    8000384c:	8926                	mv	s2,s1
    8000384e:	a03d                	j	8000387c <iget+0x9a>
    if(empty == 0 && ip->ref == 0)    // Remember empty slot.
    80003850:	f7f9                	bnez	a5,8000381e <iget+0x3c>
    80003852:	8926                	mv	s2,s1
    80003854:	b7e9                	j	8000381e <iget+0x3c>
  if(empty == 0)
    80003856:	02090c63          	beqz	s2,8000388e <iget+0xac>
  ip->dev = dev;
    8000385a:	01392023          	sw	s3,0(s2)
  ip->inum = inum;
    8000385e:	01492223          	sw	s4,4(s2)
  ip->ref = 1;
    80003862:	4785                	li	a5,1
    80003864:	00f92423          	sw	a5,8(s2)
  ip->valid = 0;
    80003868:	04092023          	sw	zero,64(s2)
  release(&itable.lock);
    8000386c:	0001e517          	auipc	a0,0x1e
    80003870:	95c50513          	addi	a0,a0,-1700 # 800211c8 <itable>
    80003874:	ffffd097          	auipc	ra,0xffffd
    80003878:	424080e7          	jalr	1060(ra) # 80000c98 <release>
}
    ...
    80003892:	d9250513          	addi	a0,a0,-622 # 80008620 <syscall_argc+0xe0>
    80003896:	ffffd097          	auipc	ra,0xffffd
    8000389a:	ca8080e7          	jalr	-856(ra) # 8000053e <panic>

000000008000389e <fsinit>:
fsinit(int dev) {
  ...
  bp = bread(dev, 1);
    ...
    800038b4:	a64080e7          	jalr	-1436(ra) # 80003314 <bread>
    800038b8:	84aa                	mv	s1,a0
  memmove(sb, bp->data, sizeof(*sb));
    800038ba:	0001e997          	auipc	s3,0x1e
    800038be:	8ee98993          	addi	s3,s3,-1810 # 800211a8 <sb>
    800038c2:	02000613          	li	a2,32
    800038c6:	05850593          	addi	a1,a0,88
    800038ca:	854e                	mv	a0,s3
    800038cc:	ffffd097          	auipc	ra,0xffffd
    800038d0:	474080e7          	jalr	1140(ra) # 80000d40 <memmove>
  brelse(bp);
    800038d4:	8526                	mv	a0,s1
    800038d6:	00000097          	auipc	ra,0x0
    800038da:	b6e080e7          	jalr	-1170(ra) # 80003444 <brelse>
  if(sb.magic != FSMAGIC)
    800038de:	0009a703          	lw	a4,0(s3)
    800038e2:	102037b7          	lui	a5,0x10203
    800038e6:	04078793          	addi	a5,a5,64 # 10203040 <_entry-0x6fdfcfc0>
    800038ea:	02f71263          	bne	a4,a5,8000390e <fsinit+0x70>
  initlog(dev, &sb);
    800038ee:	0001e597          	auipc	a1,0x1e
    800038f2:	8ba58593          	addi	a1,a1,-1862 # 800211a8 <sb>
    800038f6:	854a                	mv	a0,s2
    800038f8:	00001097          	auipc	ra,0x1
    800038fc:	b4c080e7          	jalr	-1204(ra) # 80004444 <initlog>
}
    ...
    80003912:	d2250513          	addi	a0,a0,-734 # 80008630 <syscall_argc+0xf0>
    80003916:	ffffd097          	auipc	ra,0xffffd
    8000391a:	c28080e7          	jalr	-984(ra) # 8000053e <panic>

000000008000391e <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80003930:	d1c58593          	addi	a1,a1,-740 # 80008648 <syscall_argc+0x108>
    80003934:	0001e517          	auipc	a0,0x1e
    80003938:	89450513          	addi	a0,a0,-1900 # 800211c8 <itable>
    8000393c:	ffffd097          	auipc	ra,0xffffd
    80003940:	218080e7          	jalr	536(ra) # 80000b54 <initlock>
  for(i = 0; i < NINODE; i++) {
    80003944:	0001e497          	auipc	s1,0x1e
    80003948:	8ac48493          	addi	s1,s1,-1876 # 800211f0 <itable+0x28>
    8000394c:	0001f997          	auipc	s3,0x1f
    80003950:	33498993          	addi	s3,s3,820 # 80022c80 <log+0x10>
    initsleeplock(&itable.inode[i].lock, "inode");
    80003954:	00005917          	auipc	s2,0x5
    80003958:	cfc90913          	addi	s2,s2,-772 # 80008650 <syscall_argc+0x110>
    8000395c:	85ca                	mv	a1,s2
    8000395e:	8526                	mv	a0,s1
    80003960:	00001097          	auipc	ra,0x1
    80003964:	e46080e7          	jalr	-442(ra) # 800047a6 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
    80003968:	08848493          	addi	s1,s1,136
    8000396c:	ff3498e3          	bne	s1,s3,8000395c <iinit+0x3e>
}
...
000000008000397e <ialloc>:
{
    8000397e:	715d                	addi	sp,sp,-80
    80003980:	e486                	sd	ra,72(sp)
    80003982:	e0a2                	sd	s0,64(sp)
    80003984:	fc26                	sd	s1,56(sp)
    80003986:	f84a                	sd	s2,48(sp)
    80003988:	f44e                	sd	s3,40(sp)
    8000398a:	f052                	sd	s4,32(sp)
    8000398c:	ec56                	sd	s5,24(sp)
    8000398e:	e85a                	sd	s6,16(sp)
    80003990:	e45e                	sd	s7,8(sp)
    80003992:	0880                	addi	s0,sp,80
  for(inum = 1; inum < sb.ninodes; inum++){
    80003994:	0001e717          	auipc	a4,0x1e
    80003998:	82072703          	lw	a4,-2016(a4) # 800211b4 <sb+0xc>
    8000399c:	4785                	li	a5,1
    8000399e:	04e7fa63          	bgeu	a5,a4,800039f2 <ialloc+0x74>
    800039a2:	8aaa                	mv	s5,a0
    800039a4:	8bae                	mv	s7,a1
    800039a6:	4485                	li	s1,1
    bp = bread(dev, IBLOCK(inum, sb));
    800039a8:	0001ea17          	auipc	s4,0x1e
    800039ac:	800a0a13          	addi	s4,s4,-2048 # 800211a8 <sb>
    800039b0:	00048b1b          	sext.w	s6,s1
    800039b4:	0044d593          	srli	a1,s1,0x4
    800039b8:	018a2783          	lw	a5,24(s4)
    800039bc:	9dbd                	addw	a1,a1,a5
    800039be:	8556                	mv	a0,s5
    800039c0:	00000097          	auipc	ra,0x0
    800039c4:	954080e7          	jalr	-1708(ra) # 80003314 <bread>
    800039c8:	892a                	mv	s2,a0
    dip = (struct dinode*)bp->data + inum%IPB;
    800039ca:	05850993          	addi	s3,a0,88
    800039ce:	00f4f793          	andi	a5,s1,15
    800039d2:	079a                	slli	a5,a5,0x6
    800039d4:	99be                	add	s3,s3,a5
    if(dip->type == 0){  // a free inode
    800039d6:	00099783          	lh	a5,0(s3)
    800039da:	c785                	beqz	a5,80003a02 <ialloc+0x84>
    brelse(bp);
    800039dc:	00000097          	auipc	ra,0x0
    800039e0:	a68080e7          	jalr	-1432(ra) # 80003444 <brelse>
  for(inum = 1; inum < sb.ninodes; inum++){
    800039e4:	0485                	addi	s1,s1,1
    800039e6:	00ca2703          	lw	a4,12(s4)
    800039ea:	0004879b          	sext.w	a5,s1
    800039ee:	fce7e1e3          	bltu	a5,a4,800039b0 <ialloc+0x32>
  panic("ialloc: no inodes");
    800039f2:	00005517          	auipc	a0,0x5
    800039f6:	c6650513          	addi	a0,a0,-922 # 80008658 <syscall_argc+0x118>
    800039fa:	ffffd097          	auipc	ra,0xffffd
    800039fe:	b44080e7          	jalr	-1212(ra) # 8000053e <panic>
      memset(dip, 0, sizeof(*dip));
    80003a02:	04000613          	li	a2,64
    80003a06:	4581                	li	a1,0
    80003a08:	854e                	mv	a0,s3
    80003a0a:	ffffd097          	auipc	ra,0xffffd
    80003a0e:	2d6080e7          	jalr	726(ra) # 80000ce0 <memset>
      dip->type = type;
    80003a12:	01799023          	sh	s7,0(s3)
      log_write(bp);   // mark it allocated on the disk
    80003a16:	854a                	mv	a0,s2
    80003a18:	00001097          	auipc	ra,0x1
    80003a1c:	ca8080e7          	jalr	-856(ra) # 800046c0 <log_write>
      brelse(bp);
    80003a20:	854a                	mv	a0,s2
    80003a22:	00000097          	auipc	ra,0x0
    80003a26:	a22080e7          	jalr	-1502(ra) # 80003444 <brelse>
      return iget(dev, inum);
    80003a2a:	85da                	mv	a1,s6
    80003a2c:	8556                	mv	a0,s5
    80003a2e:	00000097          	auipc	ra,0x0
    80003a32:	db4080e7          	jalr	-588(ra) # 800037e2 <iget>
}
...
0000000080003a4c <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80003a64:	7605a583          	lw	a1,1888(a1) # 800211c0 <sb+0x18>
    80003a68:	9dbd                	addw	a1,a1,a5
    80003a6a:	4108                	lw	a0,0(a0)
    80003a6c:	00000097          	auipc	ra,0x0
    80003a70:	8a8080e7          	jalr	-1880(ra) # 80003314 <bread>
    80003a74:	892a                	mv	s2,a0
  dip = (struct dinode*)bp->data + ip->inum%IPB;
    80003a76:	05850793          	addi	a5,a0,88
    80003a7a:	40c8                	lw	a0,4(s1)
    80003a7c:	893d                	andi	a0,a0,15
    80003a7e:	051a                	slli	a0,a0,0x6
    80003a80:	953e                	add	a0,a0,a5
  dip->type = ip->type;
    80003a82:	04449703          	lh	a4,68(s1)
    80003a86:	00e51023          	sh	a4,0(a0)
  dip->major = ip->major;
    80003a8a:	04649703          	lh	a4,70(s1)
    80003a8e:	00e51123          	sh	a4,2(a0)
  dip->minor = ip->minor;
    80003a92:	04849703          	lh	a4,72(s1)
    80003a96:	00e51223          	sh	a4,4(a0)
  dip->nlink = ip->nlink;
    80003a9a:	04a49703          	lh	a4,74(s1)
    80003a9e:	00e51323          	sh	a4,6(a0)
  dip->size = ip->size;
    80003aa2:	44f8                	lw	a4,76(s1)
    80003aa4:	c518                	sw	a4,8(a0)
  memmove(dip->addrs, ip->addrs, sizeof(ip->addrs));
    80003aa6:	03400613          	li	a2,52
    80003aaa:	05048593          	addi	a1,s1,80
    80003aae:	0531                	addi	a0,a0,12
    80003ab0:	ffffd097          	auipc	ra,0xffffd
    80003ab4:	290080e7          	jalr	656(ra) # 80000d40 <memmove>
  log_write(bp);
    80003ab8:	854a                	mv	a0,s2
    80003aba:	00001097          	auipc	ra,0x1
    80003abe:	c06080e7          	jalr	-1018(ra) # 800046c0 <log_write>
  brelse(bp);
    80003ac2:	854a                	mv	a0,s2
    80003ac4:	00000097          	auipc	ra,0x0
    80003ac8:	980080e7          	jalr	-1664(ra) # 80003444 <brelse>
}
...
0000000080003ad8 <idup>:
{
  ...
  acquire(&itable.lock);
    80003ae4:	0001d517          	auipc	a0,0x1d
    80003ae8:	6e450513          	addi	a0,a0,1764 # 800211c8 <itable>
  ...
  ip->ref++;
    ...
    80003af8:	c49c                	sw	a5,8(s1)
  release(&itable.lock);
    80003afa:	0001d517          	auipc	a0,0x1d
    80003afe:	6ce50513          	addi	a0,a0,1742 # 800211c8 <itable>
    80003b02:	ffffd097          	auipc	ra,0xffffd
    80003b06:	196080e7          	jalr	406(ra) # 80000c98 <release>
}
...
0000000080003b16 <ilock>:
{
  ...
  if(ip == 0 || ip->ref < 1)
    80003b22:	c115                	beqz	a0,80003b46 <ilock+0x30>
    80003b24:	84aa                	mv	s1,a0
    80003b26:	451c                	lw	a5,8(a0)
    80003b28:	00f05f63          	blez	a5,80003b46 <ilock+0x30>
  acquiresleep(&ip->lock);
    80003b2c:	0541                	addi	a0,a0,16
    80003b2e:	00001097          	auipc	ra,0x1
    80003b32:	cb2080e7          	jalr	-846(ra) # 800047e0 <acquiresleep>
  if(ip->valid == 0){
    80003b36:	40bc                	lw	a5,64(s1)
    80003b38:	cf99                	beqz	a5,80003b56 <ilock+0x40>
}
    ...
    80003b4a:	b2a50513          	addi	a0,a0,-1238 # 80008670 <syscall_argc+0x130>
    ...
    80003b5c:	0001d597          	auipc	a1,0x1d
    80003b60:	6645a583          	lw	a1,1636(a1) # 800211c0 <sb+0x18>
    80003b64:	9dbd                	addw	a1,a1,a5
    80003b66:	4088                	lw	a0,0(s1)
    80003b68:	fffff097          	auipc	ra,0xfffff
    80003b6c:	7ac080e7          	jalr	1964(ra) # 80003314 <bread>
    80003b70:	892a                	mv	s2,a0
    dip = (struct dinode*)bp->data + ip->inum%IPB;
    80003b72:	05850593          	addi	a1,a0,88
    80003b76:	40dc                	lw	a5,4(s1)
    80003b78:	8bbd                	andi	a5,a5,15
    80003b7a:	079a                	slli	a5,a5,0x6
    80003b7c:	95be                	add	a1,a1,a5
    ip->type = dip->type;
    80003b7e:	00059783          	lh	a5,0(a1)
    80003b82:	04f49223          	sh	a5,68(s1)
    ip->major = dip->major;
    80003b86:	00259783          	lh	a5,2(a1)
    80003b8a:	04f49323          	sh	a5,70(s1)
    ip->minor = dip->minor;
    80003b8e:	00459783          	lh	a5,4(a1)
    80003b92:	04f49423          	sh	a5,72(s1)
    ip->nlink = dip->nlink;
    80003b96:	00659783          	lh	a5,6(a1)
    80003b9a:	04f49523          	sh	a5,74(s1)
    ip->size = dip->size;
    80003b9e:	459c                	lw	a5,8(a1)
    80003ba0:	c4fc                	sw	a5,76(s1)
    memmove(ip->addrs, dip->addrs, sizeof(ip->addrs));
    80003ba2:	03400613          	li	a2,52
    80003ba6:	05b1                	addi	a1,a1,12
    80003ba8:	05048513          	addi	a0,s1,80
    ...
    80003bba:	88e080e7          	jalr	-1906(ra) # 80003444 <brelse>
    ip->valid = 1;
    80003bbe:	4785                	li	a5,1
    80003bc0:	c0bc                	sw	a5,64(s1)
    if(ip->type == 0)
    80003bc2:	04449783          	lh	a5,68(s1)
    80003bc6:	fbb5                	bnez	a5,80003b3a <ilock+0x24>
      panic("ilock: no type");
    80003bc8:	00005517          	auipc	a0,0x5
    80003bcc:	ab050513          	addi	a0,a0,-1360 # 80008678 <syscall_argc+0x138>
    80003bd0:	ffffd097          	auipc	ra,0xffffd
    80003bd4:	96e080e7          	jalr	-1682(ra) # 8000053e <panic>

0000000080003bd8 <iunlock>:
{
  ...
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    80003be4:	c905                	beqz	a0,80003c14 <iunlock+0x3c>
    80003be6:	84aa                	mv	s1,a0
    80003be8:	01050913          	addi	s2,a0,16
    80003bec:	854a                	mv	a0,s2
    80003bee:	00001097          	auipc	ra,0x1
    80003bf2:	c8c080e7          	jalr	-884(ra) # 8000487a <holdingsleep>
    80003bf6:	cd19                	beqz	a0,80003c14 <iunlock+0x3c>
    80003bf8:	449c                	lw	a5,8(s1)
    80003bfa:	00f05d63          	blez	a5,80003c14 <iunlock+0x3c>
  releasesleep(&ip->lock);
    80003bfe:	854a                	mv	a0,s2
    80003c00:	00001097          	auipc	ra,0x1
    80003c04:	c36080e7          	jalr	-970(ra) # 80004836 <releasesleep>
}
    ...
    80003c18:	a7450513          	addi	a0,a0,-1420 # 80008688 <syscall_argc+0x148>
...
itrunc(struct inode *ip)
{
  ...
  for(i = 0; i < NDIRECT; i++){
    80003c36:	05050493          	addi	s1,a0,80
    80003c3a:	08050913          	addi	s2,a0,128
    80003c3e:	a021                	j	80003c46 <itrunc+0x22>
    80003c40:	0491                	addi	s1,s1,4
    80003c42:	01248d63          	beq	s1,s2,80003c5c <itrunc+0x38>
    if(ip->addrs[i]){
    80003c46:	408c                	lw	a1,0(s1)
    80003c48:	dde5                	beqz	a1,80003c40 <itrunc+0x1c>
      bfree(ip->dev, ip->addrs[i]);
    80003c4a:	0009a503          	lw	a0,0(s3)
    80003c4e:	00000097          	auipc	ra,0x0
    80003c52:	90c080e7          	jalr	-1780(ra) # 8000355a <bfree>
      ip->addrs[i] = 0;
    80003c56:	0004a023          	sw	zero,0(s1)
    80003c5a:	b7dd                	j	80003c40 <itrunc+0x1c>
    }
  }

  if(ip->addrs[NDIRECT]){
    80003c5c:	0809a583          	lw	a1,128(s3)
    80003c60:	e185                	bnez	a1,80003c80 <itrunc+0x5c>
    brelse(bp);
  ...
  ip->size = 0;
    80003c62:	0409a623          	sw	zero,76(s3)
  iupdate(ip);
    80003c66:	854e                	mv	a0,s3
    80003c68:	00000097          	auipc	ra,0x0
    80003c6c:	de4080e7          	jalr	-540(ra) # 80003a4c <iupdate>
}
    ...
    80003c7a:	6a02                	ld	s4,0(sp)
    80003c7c:	6145                	addi	sp,sp,48
    80003c7e:	8082                	ret
    bp = bread(ip->dev, ip->addrs[NDIRECT]);
    80003c80:	0009a503          	lw	a0,0(s3)
    80003c84:	fffff097          	auipc	ra,0xfffff
    80003c88:	690080e7          	jalr	1680(ra) # 80003314 <bread>
    80003c8c:	8a2a                	mv	s4,a0
    for(j = 0; j < NINDIRECT; j++){
    80003c8e:	05850493          	addi	s1,a0,88
    80003c92:	45850913          	addi	s2,a0,1112
    80003c96:	a811                	j	80003caa <itrunc+0x86>
        bfree(ip->dev, a[j]);
    80003c98:	0009a503          	lw	a0,0(s3)
    80003c9c:	00000097          	auipc	ra,0x0
    80003ca0:	8be080e7          	jalr	-1858(ra) # 8000355a <bfree>
    for(j = 0; j < NINDIRECT; j++){
    80003ca4:	0491                	addi	s1,s1,4
    80003ca6:	01248563          	beq	s1,s2,80003cb0 <itrunc+0x8c>
      if(a[j])
    80003caa:	408c                	lw	a1,0(s1)
    80003cac:	dde5                	beqz	a1,80003ca4 <itrunc+0x80>
    80003cae:	b7ed                	j	80003c98 <itrunc+0x74>
    brelse(bp);
    80003cb0:	8552                	mv	a0,s4
    80003cb2:	fffff097          	auipc	ra,0xfffff
    80003cb6:	792080e7          	jalr	1938(ra) # 80003444 <brelse>
    bfree(ip->dev, ip->addrs[NDIRECT]);
    80003cba:	0809a583          	lw	a1,128(s3)
    80003cbe:	0009a503          	lw	a0,0(s3)
    80003cc2:	00000097          	auipc	ra,0x0
    80003cc6:	898080e7          	jalr	-1896(ra) # 8000355a <bfree>
    ip->addrs[NDIRECT] = 0;
    80003cca:	0809a023          	sw	zero,128(s3)
    80003cce:	bf51                	j	80003c62 <itrunc+0x3e>

0000000080003cd0 <iput>:
{
  ...
  acquire(&itable.lock);
    80003cde:	0001d517          	auipc	a0,0x1d
    80003ce2:	4ea50513          	addi	a0,a0,1258 # 800211c8 <itable>
    80003ce6:	ffffd097          	auipc	ra,0xffffd
    80003cea:	efe080e7          	jalr	-258(ra) # 80000be4 <acquire>
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    80003cee:	4498                	lw	a4,8(s1)
    80003cf0:	4785                	li	a5,1
    80003cf2:	02f70363          	beq	a4,a5,80003d18 <iput+0x48>
  ip->ref--;
    80003cf6:	449c                	lw	a5,8(s1)
    80003cf8:	37fd                	addiw	a5,a5,-1
    80003cfa:	c49c                	sw	a5,8(s1)
  release(&itable.lock);
    80003cfc:	0001d517          	auipc	a0,0x1d
    80003d00:	4cc50513          	addi	a0,a0,1228 # 800211c8 <itable>
    80003d04:	ffffd097          	auipc	ra,0xffffd
    80003d08:	f94080e7          	jalr	-108(ra) # 80000c98 <release>
}
    ...
    80003d16:	8082                	ret
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    80003d18:	40bc                	lw	a5,64(s1)
    80003d1a:	dff1                	beqz	a5,80003cf6 <iput+0x26>
    80003d1c:	04a49783          	lh	a5,74(s1)
    80003d20:	fbf9                	bnez	a5,80003cf6 <iput+0x26>
    acquiresleep(&ip->lock);
    80003d22:	01048913          	addi	s2,s1,16
    80003d26:	854a                	mv	a0,s2
    80003d28:	00001097          	auipc	ra,0x1
    80003d2c:	ab8080e7          	jalr	-1352(ra) # 800047e0 <acquiresleep>
    release(&itable.lock);
    80003d30:	0001d517          	auipc	a0,0x1d
    80003d34:	49850513          	addi	a0,a0,1176 # 800211c8 <itable>
    80003d38:	ffffd097          	auipc	ra,0xffffd
    80003d3c:	f60080e7          	jalr	-160(ra) # 80000c98 <release>
    itrunc(ip);
    80003d40:	8526                	mv	a0,s1
    80003d42:	00000097          	auipc	ra,0x0
    80003d46:	ee2080e7          	jalr	-286(ra) # 80003c24 <itrunc>
    ip->type = 0;
    80003d4a:	04049223          	sh	zero,68(s1)
    iupdate(ip);
    80003d4e:	8526                	mv	a0,s1
    80003d50:	00000097          	auipc	ra,0x0
    80003d54:	cfc080e7          	jalr	-772(ra) # 80003a4c <iupdate>
    ip->valid = 0;
    80003d58:	0404a023          	sw	zero,64(s1)
    releasesleep(&ip->lock);
    80003d5c:	854a                	mv	a0,s2
    80003d5e:	00001097          	auipc	ra,0x1
    80003d62:	ad8080e7          	jalr	-1320(ra) # 80004836 <releasesleep>
    acquire(&itable.lock);
    80003d66:	0001d517          	auipc	a0,0x1d
    80003d6a:	46250513          	addi	a0,a0,1122 # 800211c8 <itable>
    80003d6e:	ffffd097          	auipc	ra,0xffffd
    80003d72:	e76080e7          	jalr	-394(ra) # 80000be4 <acquire>
    80003d76:	b741                	j	80003cf6 <iput+0x26>

0000000080003d78 <iunlockput>:
{
  ...
  iunlock(ip);
    ...
    80003d88:	e54080e7          	jalr	-428(ra) # 80003bd8 <iunlock>
  iput(ip);
    80003d8c:	8526                	mv	a0,s1
    80003d8e:	00000097          	auipc	ra,0x0
    80003d92:	f42080e7          	jalr	-190(ra) # 80003cd0 <iput>
}
...
{
    80003da0:	1141                	addi	sp,sp,-16
    80003da2:	e422                	sd	s0,8(sp)
    80003da4:	0800                	addi	s0,sp,16
  st->dev = ip->dev;
    80003da6:	411c                	lw	a5,0(a0)
    80003da8:	c19c                	sw	a5,0(a1)
  st->ino = ip->inum;
    80003daa:	415c                	lw	a5,4(a0)
    80003dac:	c1dc                	sw	a5,4(a1)
  st->type = ip->type;
    80003dae:	04451783          	lh	a5,68(a0)
    80003db2:	00f59423          	sh	a5,8(a1)
  st->nlink = ip->nlink;
    80003db6:	04a51783          	lh	a5,74(a0)
    80003dba:	00f59523          	sh	a5,10(a1)
  st->size = ip->size;
    80003dbe:	04c56783          	lwu	a5,76(a0)
    80003dc2:	e99c                	sd	a5,16(a1)
}
    80003dc4:	6422                	ld	s0,8(sp)
    80003dc6:	0141                	addi	sp,sp,16
    80003dc8:	8082                	ret

0000000080003dca <readi>:
readi(struct inode *ip, int user_dst, uint64 dst, uint off, uint n)
{
  ...
  if(off > ip->size || off + n < off)
    ...
    80003dcc:	0ed7e963          	bltu	a5,a3,80003ebe <readi+0xf4>
{
    ...
    80003dee:	8baa                	mv	s7,a0
    80003df0:	8c2e                	mv	s8,a1
    80003df2:	8ab2                	mv	s5,a2
    80003df4:	84b6                	mv	s1,a3
    80003df6:	8b3a                	mv	s6,a4
  if(off > ip->size || off + n < off)
    80003df8:	9f35                	addw	a4,a4,a3
    return 0;
    80003dfa:	4501                	li	a0,0
  if(off > ip->size || off + n < off)
    80003dfc:	0ad76063          	bltu	a4,a3,80003e9c <readi+0xd2>
  if(off + n > ip->size)
    80003e00:	00e7f463          	bgeu	a5,a4,80003e08 <readi+0x3e>
    n = ip->size - off;
    80003e04:	40d78b3b          	subw	s6,a5,a3

  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    80003e08:	0a0b0963          	beqz	s6,80003eba <readi+0xf0>
    ...
    80003e14:	a82d                	j	80003e4e <readi+0x84>
    80003e16:	020a1d93          	slli	s11,s4,0x20
    80003e1a:	020ddd93          	srli	s11,s11,0x20
    80003e1e:	05890613          	addi	a2,s2,88
    80003e22:	86ee                	mv	a3,s11
    80003e24:	963a                	add	a2,a2,a4
    80003e26:	85d6                	mv	a1,s5
    80003e28:	8562                	mv	a0,s8
    80003e2a:	ffffe097          	auipc	ra,0xffffe
    80003e2e:	6ee080e7          	jalr	1774(ra) # 80002518 <either_copyout>
    80003e32:	05950d63          	beq	a0,s9,80003e8c <readi+0xc2>
      brelse(bp);
      tot = -1;
      break;
    }
    ...
    80003e3c:	60c080e7          	jalr	1548(ra) # 80003444 <brelse>
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    80003e40:	013a09bb          	addw	s3,s4,s3
    80003e44:	009a04bb          	addw	s1,s4,s1
    80003e48:	9aee                	add	s5,s5,s11
    80003e4a:	0569f763          	bgeu	s3,s6,80003e98 <readi+0xce>
    bp = bread(ip->dev, bmap(ip, off/BSIZE));
    80003e4e:	000ba903          	lw	s2,0(s7)
    80003e52:	00a4d59b          	srliw	a1,s1,0xa
    80003e56:	855e                	mv	a0,s7
    80003e58:	00000097          	auipc	ra,0x0
    80003e5c:	8b0080e7          	jalr	-1872(ra) # 80003708 <bmap>
    80003e60:	0005059b          	sext.w	a1,a0
    80003e64:	854a                	mv	a0,s2
    80003e66:	fffff097          	auipc	ra,0xfffff
    80003e6a:	4ae080e7          	jalr	1198(ra) # 80003314 <bread>
    80003e6e:	892a                	mv	s2,a0
    m = min(n - tot, BSIZE - off%BSIZE);
    80003e70:	3ff4f713          	andi	a4,s1,1023
    80003e74:	40ed07bb          	subw	a5,s10,a4
    80003e78:	413b06bb          	subw	a3,s6,s3
    80003e7c:	8a3e                	mv	s4,a5
    80003e7e:	2781                	sext.w	a5,a5
    80003e80:	0006861b          	sext.w	a2,a3
    80003e84:	f8f679e3          	bgeu	a2,a5,80003e16 <readi+0x4c>
    80003e88:	8a36                	mv	s4,a3
    80003e8a:	b771                	j	80003e16 <readi+0x4c>
      brelse(bp);
    80003e8c:	854a                	mv	a0,s2
    80003e8e:	fffff097          	auipc	ra,0xfffff
    80003e92:	5b6080e7          	jalr	1462(ra) # 80003444 <brelse>
      tot = -1;
    80003e96:	59fd                	li	s3,-1
  }
  return tot;
  ...
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    ...
    80003ebc:	bff1                	j	80003e98 <readi+0xce>
    return 0;
    80003ebe:	4501                	li	a0,0
}
    80003ec0:	8082                	ret

0000000080003ec2 <writei>:
writei(struct inode *ip, int user_src, uint64 src, uint off, uint n)
{
  ...
  if(off > ip->size || off + n < off)
    ...
    80003ec4:	10d7e863          	bltu	a5,a3,80003fd4 <writei+0x112>
{
    ...
    80003eee:	8bba                	mv	s7,a4
  if(off > ip->size || off + n < off)
    80003ef0:	00e687bb          	addw	a5,a3,a4
    80003ef4:	0ed7e263          	bltu	a5,a3,80003fd8 <writei+0x116>
    return -1;
  if(off + n > MAXFILE*BSIZE)
    80003ef8:	00043737          	lui	a4,0x43
    80003efc:	0ef76063          	bltu	a4,a5,80003fdc <writei+0x11a>
    return -1;

  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    80003f00:	0c0b8863          	beqz	s7,80003fd0 <writei+0x10e>
    80003f04:	4a01                	li	s4,0
    bp = bread(ip->dev, bmap(ip, off/BSIZE));
    m = min(n - tot, BSIZE - off%BSIZE);
    80003f06:	40000d13          	li	s10,1024
    if(either_copyin(bp->data + (off % BSIZE), user_src, src, m) == -1) {
    80003f0a:	5cfd                	li	s9,-1
    80003f0c:	a091                	j	80003f50 <writei+0x8e>
    80003f0e:	02099d93          	slli	s11,s3,0x20
    80003f12:	020ddd93          	srli	s11,s11,0x20
    80003f16:	05848513          	addi	a0,s1,88
    80003f1a:	86ee                	mv	a3,s11
    80003f1c:	8656                	mv	a2,s5
    80003f1e:	85e2                	mv	a1,s8
    80003f20:	953a                	add	a0,a0,a4
    80003f22:	ffffe097          	auipc	ra,0xffffe
    80003f26:	64c080e7          	jalr	1612(ra) # 8000256e <either_copyin>
    80003f2a:	07950263          	beq	a0,s9,80003f8e <writei+0xcc>
      brelse(bp);
      break;
    }
    log_write(bp);
    ...
    80003f34:	790080e7          	jalr	1936(ra) # 800046c0 <log_write>
    brelse(bp);
    80003f38:	8526                	mv	a0,s1
    80003f3a:	fffff097          	auipc	ra,0xfffff
    80003f3e:	50a080e7          	jalr	1290(ra) # 80003444 <brelse>
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    80003f42:	01498a3b          	addw	s4,s3,s4
    80003f46:	0129893b          	addw	s2,s3,s2
    80003f4a:	9aee                	add	s5,s5,s11
    80003f4c:	057a7663          	bgeu	s4,s7,80003f98 <writei+0xd6>
    bp = bread(ip->dev, bmap(ip, off/BSIZE));
    80003f50:	000b2483          	lw	s1,0(s6)
    80003f54:	00a9559b          	srliw	a1,s2,0xa
    80003f58:	855a                	mv	a0,s6
    80003f5a:	fffff097          	auipc	ra,0xfffff
    80003f5e:	7ae080e7          	jalr	1966(ra) # 80003708 <bmap>
    80003f62:	0005059b          	sext.w	a1,a0
    80003f66:	8526                	mv	a0,s1
    80003f68:	fffff097          	auipc	ra,0xfffff
    80003f6c:	3ac080e7          	jalr	940(ra) # 80003314 <bread>
    80003f70:	84aa                	mv	s1,a0
    m = min(n - tot, BSIZE - off%BSIZE);
    80003f72:	3ff97713          	andi	a4,s2,1023
    80003f76:	40ed07bb          	subw	a5,s10,a4
    80003f7a:	414b86bb          	subw	a3,s7,s4
    80003f7e:	89be                	mv	s3,a5
    80003f80:	2781                	sext.w	a5,a5
    80003f82:	0006861b          	sext.w	a2,a3
    80003f86:	f8f674e3          	bgeu	a2,a5,80003f0e <writei+0x4c>
    80003f8a:	89b6                	mv	s3,a3
    80003f8c:	b749                	j	80003f0e <writei+0x4c>
      brelse(bp);
    80003f8e:	8526                	mv	a0,s1
    80003f90:	fffff097          	auipc	ra,0xfffff
    80003f94:	4b4080e7          	jalr	1204(ra) # 80003444 <brelse>
  }

  if(off > ip->size)
    80003f98:	04cb2783          	lw	a5,76(s6)
    80003f9c:	0127f463          	bgeu	a5,s2,80003fa4 <writei+0xe2>
    ip->size = off;
    80003fa0:	052b2623          	sw	s2,76(s6)

  // write the i-node back to disk even if the size didn't change
  // because the loop above might have called bmap() and added a new
  // block to ip->addrs[].
  iupdate(ip);
    80003fa4:	855a                	mv	a0,s6
    80003fa6:	00000097          	auipc	ra,0x0
    80003faa:	aa6080e7          	jalr	-1370(ra) # 80003a4c <iupdate>

  return tot;
    80003fae:	000a051b          	sext.w	a0,s4
}
    ...
    80003fce:	8082                	ret
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    80003fd0:	8a5e                	mv	s4,s7
    80003fd2:	bfc9                	j	80003fa4 <writei+0xe2>
    return -1;
    ...
    80003fda:	bfe1                	j	80003fb2 <writei+0xf0>
    return -1;
    80003fdc:	557d                	li	a0,-1
    80003fde:	bfd1                	j	80003fb2 <writei+0xf0>

0000000080003fe0 <namecmp>:
...
{
    80003fe0:	1141                	addi	sp,sp,-16
    80003fe2:	e406                	sd	ra,8(sp)
    80003fe4:	e022                	sd	s0,0(sp)
    80003fe6:	0800                	addi	s0,sp,16
  return strncmp(s, t, DIRSIZ);
    80003fe8:	4639                	li	a2,14
    80003fea:	ffffd097          	auipc	ra,0xffffd
    80003fee:	dce080e7          	jalr	-562(ra) # 80000db8 <strncmp>
}
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  if(dp->type != T_DIR)
    8000400a:	04451703          	lh	a4,68(a0)
    8000400e:	4785                	li	a5,1
    80004010:	00f71a63          	bne	a4,a5,80004024 <dirlookup+0x2a>
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    80004020:	e79d                	bnez	a5,8000404e <dirlookup+0x54>
    80004022:	a8a5                	j	8000409a <dirlookup+0xa0>
    panic("dirlookup not DIR");
    80004024:	00004517          	auipc	a0,0x4
    80004028:	66c50513          	addi	a0,a0,1644 # 80008690 <syscall_argc+0x150>
    8000402c:	ffffc097          	auipc	ra,0xffffc
    80004030:	512080e7          	jalr	1298(ra) # 8000053e <panic>
      panic("dirlookup read");
    80004034:	00004517          	auipc	a0,0x4
    80004038:	67450513          	addi	a0,a0,1652 # 800086a8 <syscall_argc+0x168>
    8000403c:	ffffc097          	auipc	ra,0xffffc
    80004040:	502080e7          	jalr	1282(ra) # 8000053e <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
    80004044:	24c1                	addiw	s1,s1,16
    80004046:	04c92783          	lw	a5,76(s2)
    8000404a:	04f4f763          	bgeu	s1,a5,80004098 <dirlookup+0x9e>
    ...
    8000405e:	d70080e7          	jalr	-656(ra) # 80003dca <readi>
    80004062:	47c1                	li	a5,16
    80004064:	fcf518e3          	bne	a0,a5,80004034 <dirlookup+0x3a>
    if(de.inum == 0)
    80004068:	fc045783          	lhu	a5,-64(s0)
    8000406c:	dfe1                	beqz	a5,80004044 <dirlookup+0x4a>
    if(namecmp(name, de.name) == 0){
    8000406e:	fc240593          	addi	a1,s0,-62
    80004072:	854e                	mv	a0,s3
    80004074:	00000097          	auipc	ra,0x0
    80004078:	f6c080e7          	jalr	-148(ra) # 80003fe0 <namecmp>
    8000407c:	f561                	bnez	a0,80004044 <dirlookup+0x4a>
      if(poff)
    8000407e:	000a0463          	beqz	s4,80004086 <dirlookup+0x8c>
        *poff = off;
    ...
    80004092:	754080e7          	jalr	1876(ra) # 800037e2 <iget>
    80004096:	a011                	j	8000409a <dirlookup+0xa0>
  return 0;
...
{
    800040aa:	711d                	addi	sp,sp,-96
    800040ac:	ec86                	sd	ra,88(sp)
    800040ae:	e8a2                	sd	s0,80(sp)
    800040b0:	e4a6                	sd	s1,72(sp)
    800040b2:	e0ca                	sd	s2,64(sp)
    800040b4:	fc4e                	sd	s3,56(sp)
    800040b6:	f852                	sd	s4,48(sp)
    800040b8:	f456                	sd	s5,40(sp)
    800040ba:	f05a                	sd	s6,32(sp)
    800040bc:	ec5e                	sd	s7,24(sp)
    800040be:	e862                	sd	s8,16(sp)
    800040c0:	e466                	sd	s9,8(sp)
    800040c2:	1080                	addi	s0,sp,96
    800040c4:	84aa                	mv	s1,a0
    800040c6:	8b2e                	mv	s6,a1
    800040c8:	8ab2                	mv	s5,a2
  struct inode *ip, *next;

  if(*path == '/')
    800040ca:	00054703          	lbu	a4,0(a0)
    800040ce:	02f00793          	li	a5,47
    800040d2:	02f70363          	beq	a4,a5,800040f8 <namex+0x4e>
    ip = iget(ROOTDEV, ROOTINO);
  else
    ip = idup(myproc()->cwd);
    800040d6:	ffffe097          	auipc	ra,0xffffe
    800040da:	8da080e7          	jalr	-1830(ra) # 800019b0 <myproc>
    800040de:	15053503          	ld	a0,336(a0)
    800040e2:	00000097          	auipc	ra,0x0
    800040e6:	9f6080e7          	jalr	-1546(ra) # 80003ad8 <idup>
    800040ea:	89aa                	mv	s3,a0
  while(*path == '/')
    800040ec:	02f00913          	li	s2,47
  len = path - s;
    800040f0:	4b81                	li	s7,0
  if(len >= DIRSIZ)
    800040f2:	4cb5                	li	s9,13

  while((path = skipelem(path, name)) != 0){
    ilock(ip);
    if(ip->type != T_DIR){
    800040f4:	4c05                	li	s8,1
    800040f6:	a865                	j	800041ae <namex+0x104>
    ip = iget(ROOTDEV, ROOTINO);
    800040f8:	4585                	li	a1,1
    800040fa:	4505                	li	a0,1
    800040fc:	fffff097          	auipc	ra,0xfffff
    80004100:	6e6080e7          	jalr	1766(ra) # 800037e2 <iget>
    80004104:	89aa                	mv	s3,a0
    80004106:	b7dd                	j	800040ec <namex+0x42>
      iunlockput(ip);
    80004108:	854e                	mv	a0,s3
    8000410a:	00000097          	auipc	ra,0x0
    8000410e:	c6e080e7          	jalr	-914(ra) # 80003d78 <iunlockput>
      return 0;
    80004112:	4981                	li	s3,0
  if(nameiparent){
    iput(ip);
    return 0;
  }
  return ip;
    ...
    80004116:	60e6                	ld	ra,88(sp)
    80004118:	6446                	ld	s0,80(sp)
    8000411a:	64a6                	ld	s1,72(sp)
    8000411c:	6906                	ld	s2,64(sp)
    8000411e:	79e2                	ld	s3,56(sp)
    80004120:	7a42                	ld	s4,48(sp)
    80004122:	7aa2                	ld	s5,40(sp)
    80004124:	7b02                	ld	s6,32(sp)
    80004126:	6be2                	ld	s7,24(sp)
    80004128:	6c42                	ld	s8,16(sp)
    8000412a:	6ca2                	ld	s9,8(sp)
    8000412c:	6125                	addi	sp,sp,96
    8000412e:	8082                	ret
      iunlock(ip);
    80004130:	854e                	mv	a0,s3
    80004132:	00000097          	auipc	ra,0x0
    80004136:	aa6080e7          	jalr	-1370(ra) # 80003bd8 <iunlock>
      return ip;
    8000413a:	bfe9                	j	80004114 <namex+0x6a>
      iunlockput(ip);
    8000413c:	854e                	mv	a0,s3
    8000413e:	00000097          	auipc	ra,0x0
    80004142:	c3a080e7          	jalr	-966(ra) # 80003d78 <iunlockput>
      return 0;
    80004146:	89d2                	mv	s3,s4
    80004148:	b7f1                	j	80004114 <namex+0x6a>
  len = path - s;
    8000414a:	40b48633          	sub	a2,s1,a1
    8000414e:	00060a1b          	sext.w	s4,a2
  if(len >= DIRSIZ)
    80004152:	094cd463          	bge	s9,s4,800041da <namex+0x130>
  ...
  while(*path == '/')
    ...
    80004166:	01279763          	bne	a5,s2,80004174 <namex+0xca>
    path++;
    8000416a:	0485                	addi	s1,s1,1
  while(*path == '/')
    8000416c:	0004c783          	lbu	a5,0(s1)
    80004170:	ff278de3          	beq	a5,s2,8000416a <namex+0xc0>
    ilock(ip);
    80004174:	854e                	mv	a0,s3
    80004176:	00000097          	auipc	ra,0x0
    8000417a:	9a0080e7          	jalr	-1632(ra) # 80003b16 <ilock>
    if(ip->type != T_DIR){
    8000417e:	04499783          	lh	a5,68(s3)
    80004182:	f98793e3          	bne	a5,s8,80004108 <namex+0x5e>
    if(nameiparent && *path == '\0'){
    80004186:	000b0563          	beqz	s6,80004190 <namex+0xe6>
    8000418a:	0004c783          	lbu	a5,0(s1)
    8000418e:	d3cd                	beqz	a5,80004130 <namex+0x86>
    if((next = dirlookup(ip, name, 0)) == 0){
    80004190:	865e                	mv	a2,s7
    80004192:	85d6                	mv	a1,s5
    80004194:	854e                	mv	a0,s3
    80004196:	00000097          	auipc	ra,0x0
    8000419a:	e64080e7          	jalr	-412(ra) # 80003ffa <dirlookup>
    8000419e:	8a2a                	mv	s4,a0
    800041a0:	dd51                	beqz	a0,8000413c <namex+0x92>
    iunlockput(ip);
    800041a2:	854e                	mv	a0,s3
    800041a4:	00000097          	auipc	ra,0x0
    800041a8:	bd4080e7          	jalr	-1068(ra) # 80003d78 <iunlockput>
    ip = next;
    800041ac:	89d2                	mv	s3,s4
  while(*path == '/')
    800041ae:	0004c783          	lbu	a5,0(s1)
    800041b2:	05279763          	bne	a5,s2,80004200 <namex+0x156>
    path++;
    800041b6:	0485                	addi	s1,s1,1
  while(*path == '/')
    800041b8:	0004c783          	lbu	a5,0(s1)
    800041bc:	ff278de3          	beq	a5,s2,800041b6 <namex+0x10c>
  if(*path == 0)
    800041c0:	c79d                	beqz	a5,800041ee <namex+0x144>
    path++;
  ...
  while(*path != '/' && *path != 0)
    800041c8:	01278963          	beq	a5,s2,800041da <namex+0x130>
    800041cc:	dfbd                	beqz	a5,8000414a <namex+0xa0>
    path++;
    800041ce:	0485                	addi	s1,s1,1
  while(*path != '/' && *path != 0)
    800041d0:	0004c783          	lbu	a5,0(s1)
    800041d4:	ff279ce3          	bne	a5,s2,800041cc <namex+0x122>
    800041d8:	bf8d                	j	8000414a <namex+0xa0>
    memmove(name, s, len);
    ...
    name[len] = 0;
    800041e6:	9a56                	add	s4,s4,s5
    800041e8:	000a0023          	sb	zero,0(s4)
    800041ec:	bf9d                	j	80004162 <namex+0xb8>
  if(nameiparent){
    800041ee:	f20b03e3          	beqz	s6,80004114 <namex+0x6a>
    iput(ip);
    800041f2:	854e                	mv	a0,s3
    800041f4:	00000097          	auipc	ra,0x0
    800041f8:	adc080e7          	jalr	-1316(ra) # 80003cd0 <iput>
    return 0;
    800041fc:	4981                	li	s3,0
    800041fe:	bf19                	j	80004114 <namex+0x6a>
  if(*path == 0)
    80004200:	d7fd                	beqz	a5,800041ee <namex+0x144>
  while(*path != '/' && *path != 0)
    80004202:	0004c783          	lbu	a5,0(s1)
    80004206:	85a6                	mv	a1,s1
    80004208:	b7d1                	j	800041cc <namex+0x122>
...
000000008000420a <dirlink>:
{
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    80004226:	dd8080e7          	jalr	-552(ra) # 80003ffa <dirlookup>
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80004244:	b8a080e7          	jalr	-1142(ra) # 80003dca <readi>
  ...
  strncpy(de.name, name, DIRSIZ);
    ...
    8000426a:	b8e080e7          	jalr	-1138(ra) # 80000df4 <strncpy>
  de.inum = inum;
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80004282:	c44080e7          	jalr	-956(ra) # 80003ec2 <writei>
    80004286:	872a                	mv	a4,a0
    80004288:	47c1                	li	a5,16
  return 0;
    8000428a:	4501                	li	a0,0
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    8000428c:	02f71863          	bne	a4,a5,800042bc <dirlink+0xb2>
}
    ...
    800042a4:	a30080e7          	jalr	-1488(ra) # 80003cd0 <iput>
    return -1;
    800042a8:	557d                	li	a0,-1
    800042aa:	b7dd                	j	80004290 <dirlink+0x86>
      panic("dirlink read");
    800042ac:	00004517          	auipc	a0,0x4
    800042b0:	40c50513          	addi	a0,a0,1036 # 800086b8 <syscall_argc+0x178>
    800042b4:	ffffc097          	auipc	ra,0xffffc
    800042b8:	28a080e7          	jalr	650(ra) # 8000053e <panic>
    panic("dirlink");
    800042bc:	00004517          	auipc	a0,0x4
    800042c0:	50c50513          	addi	a0,a0,1292 # 800087c8 <syscall_argc+0x288>
    800042c4:	ffffc097          	auipc	ra,0xffffc
    800042c8:	27a080e7          	jalr	634(ra) # 8000053e <panic>

00000000800042cc <namei>:
...
namei(char *path)
{
  ...
  return namex(path, 0, name);
    800042d4:	fe040613          	addi	a2,s0,-32
    800042d8:	4581                	li	a1,0
    800042da:	00000097          	auipc	ra,0x0
    800042de:	dd0080e7          	jalr	-560(ra) # 800040aa <namex>
}
...
nameiparent(char *path, char *name)
{
    ...
    800042f2:	862e                	mv	a2,a1
  return namex(path, 1, name);
    800042f4:	4585                	li	a1,1
    800042f6:	00000097          	auipc	ra,0x0
    800042fa:	db4080e7          	jalr	-588(ra) # 800040aa <namex>
}
    800042fe:	60a2                	ld	ra,8(sp)
    80004300:	6402                	ld	s0,0(sp)
    80004302:	0141                	addi	sp,sp,16
    80004304:	8082                	ret

0000000080004306 <write_head>:
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    80004312:	0001f917          	auipc	s2,0x1f
    80004316:	95e90913          	addi	s2,s2,-1698 # 80022c70 <log>
    8000431a:	01892583          	lw	a1,24(s2)
    8000431e:	02892503          	lw	a0,40(s2)
    80004322:	fffff097          	auipc	ra,0xfffff
    80004326:	ff2080e7          	jalr	-14(ra) # 80003314 <bread>
    8000432a:	84aa                	mv	s1,a0
  struct logheader *hb = (struct logheader *) (buf->data);
  int i;
  hb->n = log.lh.n;
    8000432c:	02c92683          	lw	a3,44(s2)
    80004330:	cd34                	sw	a3,88(a0)
  for (i = 0; i < log.lh.n; i++) {
    80004332:	02d05763          	blez	a3,80004360 <write_head+0x5a>
    80004336:	0001f797          	auipc	a5,0x1f
    8000433a:	96a78793          	addi	a5,a5,-1686 # 80022ca0 <log+0x30>
    8000433e:	05c50713          	addi	a4,a0,92
    80004342:	36fd                	addiw	a3,a3,-1
    80004344:	1682                	slli	a3,a3,0x20
    80004346:	9281                	srli	a3,a3,0x20
    80004348:	068a                	slli	a3,a3,0x2
    8000434a:	0001f617          	auipc	a2,0x1f
    8000434e:	95a60613          	addi	a2,a2,-1702 # 80022ca4 <log+0x34>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    8000435c:	fed79ce3          	bne	a5,a3,80004354 <write_head+0x4e>
  }
  bwrite(buf);
    80004360:	8526                	mv	a0,s1
    80004362:	fffff097          	auipc	ra,0xfffff
    80004366:	0a4080e7          	jalr	164(ra) # 80003406 <bwrite>
  brelse(buf);
    8000436a:	8526                	mv	a0,s1
    8000436c:	fffff097          	auipc	ra,0xfffff
    80004370:	0d8080e7          	jalr	216(ra) # 80003444 <brelse>
}
...
0000000080004380 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    80004380:	0001f797          	auipc	a5,0x1f
    80004384:	91c7a783          	lw	a5,-1764(a5) # 80022c9c <log+0x2c>
    80004388:	0af05d63          	blez	a5,80004442 <install_trans+0xc2>
{
    ...
    800043a2:	0001fa97          	auipc	s5,0x1f
    800043a6:	8fea8a93          	addi	s5,s5,-1794 # 80022ca0 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    800043aa:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    800043ac:	0001f997          	auipc	s3,0x1f
    800043b0:	8c498993          	addi	s3,s3,-1852 # 80022c70 <log>
    800043b4:	a035                	j	800043e0 <install_trans+0x60>
      bunpin(dbuf);
    800043b6:	8526                	mv	a0,s1
    800043b8:	fffff097          	auipc	ra,0xfffff
    800043bc:	166080e7          	jalr	358(ra) # 8000351e <bunpin>
    brelse(lbuf);
    800043c0:	854a                	mv	a0,s2
    800043c2:	fffff097          	auipc	ra,0xfffff
    800043c6:	082080e7          	jalr	130(ra) # 80003444 <brelse>
    brelse(dbuf);
    800043ca:	8526                	mv	a0,s1
    800043cc:	fffff097          	auipc	ra,0xfffff
    800043d0:	078080e7          	jalr	120(ra) # 80003444 <brelse>
  for (tail = 0; tail < log.lh.n; tail++) {
    800043d4:	2a05                	addiw	s4,s4,1
    800043d6:	0a91                	addi	s5,s5,4
    800043d8:	02c9a783          	lw	a5,44(s3)
    800043dc:	04fa5963          	bge	s4,a5,8000442e <install_trans+0xae>
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    ...
    800043f2:	f26080e7          	jalr	-218(ra) # 80003314 <bread>
    ...
    80004404:	f14080e7          	jalr	-236(ra) # 80003314 <bread>
    ...
    80004424:	fe6080e7          	jalr	-26(ra) # 80003406 <bwrite>
    if(recovering == 0)
    80004428:	f80b1ce3          	bnez	s6,800043c0 <install_trans+0x40>
...
0000000080004444 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    80004456:	0001f497          	auipc	s1,0x1f
    8000445a:	81a48493          	addi	s1,s1,-2022 # 80022c70 <log>
    8000445e:	00004597          	auipc	a1,0x4
    80004462:	26a58593          	addi	a1,a1,618 # 800086c8 <syscall_argc+0x188>
  ...
  log.start = sb->logstart;
    ...
    80004474:	cc8c                	sw	a1,24(s1)
  log.size = sb->nlog;
    80004476:	0109a783          	lw	a5,16(s3)
    8000447a:	ccdc                	sw	a5,28(s1)
  log.dev = dev;
    8000447c:	0324a423          	sw	s2,40(s1)
  struct buf *buf = bread(log.dev, log.start);
    80004480:	854a                	mv	a0,s2
    80004482:	fffff097          	auipc	ra,0xfffff
    80004486:	e92080e7          	jalr	-366(ra) # 80003314 <bread>
  log.lh.n = lh->n;
    8000448a:	4d3c                	lw	a5,88(a0)
    8000448c:	d4dc                	sw	a5,44(s1)
  for (i = 0; i < log.lh.n; i++) {
    8000448e:	02f05563          	blez	a5,800044b8 <initlog+0x74>
    80004492:	05c50713          	addi	a4,a0,92
    80004496:	0001f697          	auipc	a3,0x1f
    8000449a:	80a68693          	addi	a3,a3,-2038 # 80022ca0 <log+0x30>
    8000449e:	37fd                	addiw	a5,a5,-1
    800044a0:	1782                	slli	a5,a5,0x20
    800044a2:	9381                	srli	a5,a5,0x20
    800044a4:	078a                	slli	a5,a5,0x2
    800044a6:	06050613          	addi	a2,a0,96
    800044aa:	97b2                	add	a5,a5,a2
    log.lh.block[i] = lh->block[i];
    800044ac:	4310                	lw	a2,0(a4)
    800044ae:	c290                	sw	a2,0(a3)
  for (i = 0; i < log.lh.n; i++) {
    800044b0:	0711                	addi	a4,a4,4
    800044b2:	0691                	addi	a3,a3,4
    800044b4:	fef71ce3          	bne	a4,a5,800044ac <initlog+0x68>
  brelse(buf);
    800044b8:	fffff097          	auipc	ra,0xfffff
    800044bc:	f8c080e7          	jalr	-116(ra) # 80003444 <brelse>
...
recover_from_log(void)
{
  ...
  install_trans(1); // if committed, copy from log to disk
    ...
    800044c6:	ebe080e7          	jalr	-322(ra) # 80004380 <install_trans>
  log.lh.n = 0;
    800044ca:	0001e797          	auipc	a5,0x1e
    800044ce:	7c07a923          	sw	zero,2002(a5) # 80022c9c <log+0x2c>
  write_head(); // clear the log
    800044d2:	00000097          	auipc	ra,0x0
    800044d6:	e34080e7          	jalr	-460(ra) # 80004306 <write_head>
}
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    800044f4:	0001e517          	auipc	a0,0x1e
    800044f8:	77c50513          	addi	a0,a0,1916 # 80022c70 <log>
    800044fc:	ffffc097          	auipc	ra,0xffffc
    80004500:	6e8080e7          	jalr	1768(ra) # 80000be4 <acquire>
  while(1){
    if(log.committing){
    80004504:	0001e497          	auipc	s1,0x1e
    80004508:	76c48493          	addi	s1,s1,1900 # 80022c70 <log>
      sleep(&log, &log.lock);
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
    8000450c:	4979                	li	s2,30
    8000450e:	a039                	j	8000451c <begin_op+0x34>
      sleep(&log, &log.lock);
    80004510:	85a6                	mv	a1,s1
    80004512:	8526                	mv	a0,s1
    80004514:	ffffe097          	auipc	ra,0xffffe
    80004518:	c54080e7          	jalr	-940(ra) # 80002168 <sleep>
    if(log.committing){
    8000451c:	50dc                	lw	a5,36(s1)
    8000451e:	fbed                	bnez	a5,80004510 <begin_op+0x28>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
    80004520:	509c                	lw	a5,32(s1)
    80004522:	0017871b          	addiw	a4,a5,1
    ...
    80004534:	54d8                	lw	a4,44(s1)
    80004536:	9fb9                	addw	a5,a5,a4
    80004538:	00f95963          	bge	s2,a5,8000454a <begin_op+0x62>
      // this op might exhaust log space; wait for commit.
      sleep(&log, &log.lock);
    8000453c:	85a6                	mv	a1,s1
    8000453e:	8526                	mv	a0,s1
    80004540:	ffffe097          	auipc	ra,0xffffe
    80004544:	c28080e7          	jalr	-984(ra) # 80002168 <sleep>
    80004548:	bfd1                	j	8000451c <begin_op+0x34>
    } else {
      log.outstanding += 1;
    8000454a:	0001e517          	auipc	a0,0x1e
    8000454e:	72650513          	addi	a0,a0,1830 # 80022c70 <log>
    80004552:	d114                	sw	a3,32(a0)
      release(&log.lock);
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    8000457e:	6f648493          	addi	s1,s1,1782 # 80022c70 <log>
  ...
  if(log.committing)
    ...
    80004598:	efb9                	bnez	a5,800045f6 <end_op+0x8e>
    panic("log.committing");
  if(log.outstanding == 0){
    8000459a:	06091663          	bnez	s2,80004606 <end_op+0x9e>
    do_commit = 1;
    log.committing = 1;
    8000459e:	0001e497          	auipc	s1,0x1e
    800045a2:	6d248493          	addi	s1,s1,1746 # 80022c70 <log>
    800045a6:	4785                	li	a5,1
    800045a8:	d0dc                	sw	a5,36(s1)
...
commit()
{
  if (log.lh.n > 0) {
    ...
    800045fa:	0da50513          	addi	a0,a0,218 # 800086d0 <syscall_argc+0x190>
    800045fe:	ffffc097          	auipc	ra,0xffffc
    80004602:	f40080e7          	jalr	-192(ra) # 8000053e <panic>
    wakeup(&log);
    80004606:	0001e497          	auipc	s1,0x1e
    8000460a:	66a48493          	addi	s1,s1,1642 # 80022c70 <log>
    8000460e:	8526                	mv	a0,s1
    80004610:	ffffe097          	auipc	ra,0xffffe
    80004614:	ce4080e7          	jalr	-796(ra) # 800022f4 <wakeup>
  release(&log.lock);
    80004618:	8526                	mv	a0,s1
    8000461a:	ffffc097          	auipc	ra,0xffffc
    8000461e:	67e080e7          	jalr	1662(ra) # 80000c98 <release>
  if(do_commit){
    80004622:	b7c9                	j	800045e4 <end_op+0x7c>
  for (tail = 0; tail < log.lh.n; tail++) {
    80004624:	0001ea97          	auipc	s5,0x1e
    80004628:	67ca8a93          	addi	s5,s5,1660 # 80022ca0 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    8000462c:	0001ea17          	auipc	s4,0x1e
    80004630:	644a0a13          	addi	s4,s4,1604 # 80022c70 <log>
    80004634:	018a2583          	lw	a1,24(s4)
    80004638:	012585bb          	addw	a1,a1,s2
    8000463c:	2585                	addiw	a1,a1,1
    8000463e:	028a2503          	lw	a0,40(s4)
    80004642:	fffff097          	auipc	ra,0xfffff
    80004646:	cd2080e7          	jalr	-814(ra) # 80003314 <bread>
    8000464a:	84aa                	mv	s1,a0
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
    8000464c:	000aa583          	lw	a1,0(s5)
    80004650:	028a2503          	lw	a0,40(s4)
    80004654:	fffff097          	auipc	ra,0xfffff
    80004658:	cc0080e7          	jalr	-832(ra) # 80003314 <bread>
    8000465c:	89aa                	mv	s3,a0
    memmove(to->data, from->data, BSIZE);
    8000465e:	40000613          	li	a2,1024
    80004662:	05850593          	addi	a1,a0,88
    80004666:	05848513          	addi	a0,s1,88
    8000466a:	ffffc097          	auipc	ra,0xffffc
    8000466e:	6d6080e7          	jalr	1750(ra) # 80000d40 <memmove>
    bwrite(to);  // write the log
    80004672:	8526                	mv	a0,s1
    80004674:	fffff097          	auipc	ra,0xfffff
    80004678:	d92080e7          	jalr	-622(ra) # 80003406 <bwrite>
    brelse(from);
    8000467c:	854e                	mv	a0,s3
    8000467e:	fffff097          	auipc	ra,0xfffff
    80004682:	dc6080e7          	jalr	-570(ra) # 80003444 <brelse>
    brelse(to);
    80004686:	8526                	mv	a0,s1
    80004688:	fffff097          	auipc	ra,0xfffff
    8000468c:	dbc080e7          	jalr	-580(ra) # 80003444 <brelse>
  for (tail = 0; tail < log.lh.n; tail++) {
    80004690:	2905                	addiw	s2,s2,1
    80004692:	0a91                	addi	s5,s5,4
    80004694:	02ca2783          	lw	a5,44(s4)
    80004698:	f8f94ee3          	blt	s2,a5,80004634 <end_op+0xcc>
    write_log();     // Write modified blocks from cache to log
    write_head();    // Write header to disk -- the real commit
    8000469c:	00000097          	auipc	ra,0x0
    800046a0:	c6a080e7          	jalr	-918(ra) # 80004306 <write_head>
    install_trans(0); // Now install writes to home locations
    800046a4:	4501                	li	a0,0
    800046a6:	00000097          	auipc	ra,0x0
    800046aa:	cda080e7          	jalr	-806(ra) # 80004380 <install_trans>
    log.lh.n = 0;
    800046ae:	0001e797          	auipc	a5,0x1e
    800046b2:	5e07a723          	sw	zero,1518(a5) # 80022c9c <log+0x2c>
    write_head();    // Erase the transaction from the log
    800046b6:	00000097          	auipc	ra,0x0
    800046ba:	c50080e7          	jalr	-944(ra) # 80004306 <write_head>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    800046d2:	5a290913          	addi	s2,s2,1442 # 80022c70 <log>
    800046d6:	854a                	mv	a0,s2
    800046d8:	ffffc097          	auipc	ra,0xffffc
    800046dc:	50c080e7          	jalr	1292(ra) # 80000be4 <acquire>
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    800046e0:	02c92603          	lw	a2,44(s2)
    800046e4:	47f5                	li	a5,29
    800046e6:	06c7c563          	blt	a5,a2,80004750 <log_write+0x90>
    800046ea:	0001e797          	auipc	a5,0x1e
    800046ee:	5a27a783          	lw	a5,1442(a5) # 80022c8c <log+0x1c>
    800046f2:	37fd                	addiw	a5,a5,-1
    800046f4:	04f65e63          	bge	a2,a5,80004750 <log_write+0x90>
    panic("too big a transaction");
  if (log.outstanding < 1)
    800046f8:	0001e797          	auipc	a5,0x1e
    800046fc:	5987a783          	lw	a5,1432(a5) # 80022c90 <log+0x20>
    80004700:	06f05063          	blez	a5,80004760 <log_write+0xa0>
    panic("log_write outside of trans");

  for (i = 0; i < log.lh.n; i++) {
    80004704:	4781                	li	a5,0
    80004706:	06c05563          	blez	a2,80004770 <log_write+0xb0>
    if (log.lh.block[i] == b->blockno)   // log absorption
    8000470a:	44cc                	lw	a1,12(s1)
    8000470c:	0001e717          	auipc	a4,0x1e
    80004710:	59470713          	addi	a4,a4,1428 # 80022ca0 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
    80004714:	4781                	li	a5,0
    if (log.lh.block[i] == b->blockno)   // log absorption
    80004716:	4314                	lw	a3,0(a4)
    80004718:	04b68c63          	beq	a3,a1,80004770 <log_write+0xb0>
  for (i = 0; i < log.lh.n; i++) {
    8000471c:	2785                	addiw	a5,a5,1
    8000471e:	0711                	addi	a4,a4,4
    80004720:	fef61be3          	bne	a2,a5,80004716 <log_write+0x56>
      break;
  }
  log.lh.block[i] = b->blockno;
    ...
    8000472c:	54878793          	addi	a5,a5,1352 # 80022c70 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    8000473c:	daa080e7          	jalr	-598(ra) # 800034e2 <bpin>
    log.lh.n++;
    80004740:	0001e717          	auipc	a4,0x1e
    80004744:	53070713          	addi	a4,a4,1328 # 80022c70 <log>
    80004748:	575c                	lw	a5,44(a4)
    8000474a:	2785                	addiw	a5,a5,1
    8000474c:	d75c                	sw	a5,44(a4)
    8000474e:	a835                	j	8000478a <log_write+0xca>
    panic("too big a transaction");
    80004750:	00004517          	auipc	a0,0x4
    80004754:	f9050513          	addi	a0,a0,-112 # 800086e0 <syscall_argc+0x1a0>
    80004758:	ffffc097          	auipc	ra,0xffffc
    8000475c:	de6080e7          	jalr	-538(ra) # 8000053e <panic>
    panic("log_write outside of trans");
    80004760:	00004517          	auipc	a0,0x4
    80004764:	f9850513          	addi	a0,a0,-104 # 800086f8 <syscall_argc+0x1b8>
    80004768:	ffffc097          	auipc	ra,0xffffc
    8000476c:	dd6080e7          	jalr	-554(ra) # 8000053e <panic>
  log.lh.block[i] = b->blockno;
    80004770:	00878713          	addi	a4,a5,8
    80004774:	00271693          	slli	a3,a4,0x2
    80004778:	0001e717          	auipc	a4,0x1e
    8000477c:	4f870713          	addi	a4,a4,1272 # 80022c70 <log>
    80004780:	9736                	add	a4,a4,a3
    80004782:	44d4                	lw	a3,12(s1)
    80004784:	cb14                	sw	a3,16(a4)
  if (i == log.lh.n) {  // Add new block to log?
    80004786:	faf608e3          	beq	a2,a5,80004736 <log_write+0x76>
  }
  release(&log.lock);
    8000478a:	0001e517          	auipc	a0,0x1e
    8000478e:	4e650513          	addi	a0,a0,1254 # 80022c70 <log>
...
00000000800047a6 <initsleeplock>:
#include "proc.h"
#include "sleeplock.h"
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    800047ba:	f6258593          	addi	a1,a1,-158 # 80008718 <syscall_argc+0x1d8>
    800047be:	0521                	addi	a0,a0,8
    800047c0:	ffffc097          	auipc	ra,0xffffc
    800047c4:	394080e7          	jalr	916(ra) # 80000b54 <initlock>
  lk->name = name;
    800047c8:	0324b023          	sd	s2,32(s1)
  lk->locked = 0;
    800047cc:	0004a023          	sw	zero,0(s1)
  lk->pid = 0;
    800047d0:	0204a423          	sw	zero,40(s1)
}
...
acquiresleep(struct sleeplock *lk)
{
  ...
  while (lk->locked) {
    ...
    800047fe:	cb89                	beqz	a5,80004810 <acquiresleep+0x30>
    sleep(lk, &lk->lk);
    80004800:	85ca                	mv	a1,s2
    80004802:	8526                	mv	a0,s1
    80004804:	ffffe097          	auipc	ra,0xffffe
    80004808:	964080e7          	jalr	-1692(ra) # 80002168 <sleep>
  while (lk->locked) {
    8000480c:	409c                	lw	a5,0(s1)
    8000480e:	fbed                	bnez	a5,80004800 <acquiresleep+0x20>
  }
  lk->locked = 1;
    80004810:	4785                	li	a5,1
    80004812:	c09c                	sw	a5,0(s1)
  lk->pid = myproc()->pid;
    80004814:	ffffd097          	auipc	ra,0xffffd
    80004818:	19c080e7          	jalr	412(ra) # 800019b0 <myproc>
    8000481c:	591c                	lw	a5,48(a0)
    8000481e:	d49c                	sw	a5,40(s1)
  release(&lk->lk);
    80004820:	854a                	mv	a0,s2
    80004822:	ffffc097          	auipc	ra,0xffffc
    80004826:	476080e7          	jalr	1142(ra) # 80000c98 <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  wakeup(lk);
    ...
    80004860:	a98080e7          	jalr	-1384(ra) # 800022f4 <wakeup>
  release(&lk->lk);
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    8000488a:	00850913          	addi	s2,a0,8
    8000488e:	854a                	mv	a0,s2
    80004890:	ffffc097          	auipc	ra,0xffffc
    80004894:	354080e7          	jalr	852(ra) # 80000be4 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
    80004898:	409c                	lw	a5,0(s1)
    8000489a:	ef99                	bnez	a5,800048b8 <holdingsleep+0x3e>
  ...
  return r;
    ...
    800048b6:	8082                	ret
  r = lk->locked && (lk->pid == myproc()->pid);
    800048b8:	0284a983          	lw	s3,40(s1)
    800048bc:	ffffd097          	auipc	ra,0xffffd
    800048c0:	0f4080e7          	jalr	244(ra) # 800019b0 <myproc>
    800048c4:	5904                	lw	s1,48(a0)
    800048c6:	413484b3          	sub	s1,s1,s3
    800048ca:	0014b493          	seqz	s1,s1
    800048ce:	bfc1                	j	8000489e <holdingsleep+0x24>

00000000800048d0 <fileinit>:
...
fileinit(void)
{
    ...
    800048d2:	e406                	sd	ra,8(sp)
    800048d4:	e022                	sd	s0,0(sp)
    800048d6:	0800                	addi	s0,sp,16
  initlock(&ftable.lock, "ftable");
    800048d8:	00004597          	auipc	a1,0x4
    800048dc:	e5058593          	addi	a1,a1,-432 # 80008728 <syscall_argc+0x1e8>
    800048e0:	0001e517          	auipc	a0,0x1e
    800048e4:	4d850513          	addi	a0,a0,1240 # 80022db8 <ftable>
    800048e8:	ffffc097          	auipc	ra,0xffffc
    800048ec:	26c080e7          	jalr	620(ra) # 80000b54 <initlock>
}
    800048f0:	60a2                	ld	ra,8(sp)
    800048f2:	6402                	ld	s0,0(sp)
    800048f4:	0141                	addi	sp,sp,16
    800048f6:	8082                	ret

00000000800048f8 <filealloc>:
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    80004902:	0001e517          	auipc	a0,0x1e
    80004906:	4b650513          	addi	a0,a0,1206 # 80022db8 <ftable>
    8000490a:	ffffc097          	auipc	ra,0xffffc
    8000490e:	2da080e7          	jalr	730(ra) # 80000be4 <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    80004912:	0001e497          	auipc	s1,0x1e
    80004916:	4be48493          	addi	s1,s1,1214 # 80022dd0 <ftable+0x18>
    8000491a:	0001f717          	auipc	a4,0x1f
    8000491e:	45670713          	addi	a4,a4,1110 # 80023d70 <ftable+0xfb8>
    if(f->ref == 0){
    80004922:	40dc                	lw	a5,4(s1)
    80004924:	cf99                	beqz	a5,80004942 <filealloc+0x4a>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    80004926:	02848493          	addi	s1,s1,40
    8000492a:	fee49ce3          	bne	s1,a4,80004922 <filealloc+0x2a>
      f->ref = 1;
      release(&ftable.lock);
      return f;
    }
  ...
  release(&ftable.lock);
    8000492e:	0001e517          	auipc	a0,0x1e
    80004932:	48a50513          	addi	a0,a0,1162 # 80022db8 <ftable>
    80004936:	ffffc097          	auipc	ra,0xffffc
    8000493a:	362080e7          	jalr	866(ra) # 80000c98 <release>
  return 0;
    8000493e:	4481                	li	s1,0
    80004940:	a819                	j	80004956 <filealloc+0x5e>
      f->ref = 1;
    80004942:	4785                	li	a5,1
    80004944:	c0dc                	sw	a5,4(s1)
      release(&ftable.lock);
    80004946:	0001e517          	auipc	a0,0x1e
    8000494a:	47250513          	addi	a0,a0,1138 # 80022db8 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80004972:	44a50513          	addi	a0,a0,1098 # 80022db8 <ftable>
    80004976:	ffffc097          	auipc	ra,0xffffc
    8000497a:	26e080e7          	jalr	622(ra) # 80000be4 <acquire>
  if(f->ref < 1)
    8000497e:	40dc                	lw	a5,4(s1)
    80004980:	02f05263          	blez	a5,800049a4 <filedup+0x42>
    panic("filedup");
  f->ref++;
    80004984:	2785                	addiw	a5,a5,1
    80004986:	c0dc                	sw	a5,4(s1)
  release(&ftable.lock);
    80004988:	0001e517          	auipc	a0,0x1e
    8000498c:	43050513          	addi	a0,a0,1072 # 80022db8 <ftable>
  ...
  return f;
    ...
    800049a8:	d8c50513          	addi	a0,a0,-628 # 80008730 <syscall_argc+0x1f0>
    800049ac:	ffffc097          	auipc	ra,0xffffc
    800049b0:	b92080e7          	jalr	-1134(ra) # 8000053e <panic>

00000000800049b4 <fileclose>:
...
fileclose(struct file *f)
{
    ...
    800049c2:	e456                	sd	s5,8(sp)
    800049c4:	0080                	addi	s0,sp,64
    800049c6:	84aa                	mv	s1,a0
  struct file ff;

  acquire(&ftable.lock);
    800049c8:	0001e517          	auipc	a0,0x1e
    800049cc:	3f050513          	addi	a0,a0,1008 # 80022db8 <ftable>
    800049d0:	ffffc097          	auipc	ra,0xffffc
    800049d4:	214080e7          	jalr	532(ra) # 80000be4 <acquire>
  if(f->ref < 1)
    800049d8:	40dc                	lw	a5,4(s1)
    800049da:	06f05163          	blez	a5,80004a3c <fileclose+0x88>
    panic("fileclose");
  if(--f->ref > 0){
    800049de:	37fd                	addiw	a5,a5,-1
    800049e0:	0007871b          	sext.w	a4,a5
    800049e4:	c0dc                	sw	a5,4(s1)
    800049e6:	06e04363          	bgtz	a4,80004a4c <fileclose+0x98>
    release(&ftable.lock);
    return;
  }
  ff = *f;
    800049ea:	0004a903          	lw	s2,0(s1)
    800049ee:	0094ca83          	lbu	s5,9(s1)
    800049f2:	0104ba03          	ld	s4,16(s1)
    800049f6:	0184b983          	ld	s3,24(s1)
  f->ref = 0;
    800049fa:	0004a223          	sw	zero,4(s1)
  f->type = FD_NONE;
    800049fe:	0004a023          	sw	zero,0(s1)
  release(&ftable.lock);
    80004a02:	0001e517          	auipc	a0,0x1e
    80004a06:	3b650513          	addi	a0,a0,950 # 80022db8 <ftable>
    80004a0a:	ffffc097          	auipc	ra,0xffffc
    80004a0e:	28e080e7          	jalr	654(ra) # 80000c98 <release>

  if(ff.type == FD_PIPE){
    80004a12:	4785                	li	a5,1
    80004a14:	04f90d63          	beq	s2,a5,80004a6e <fileclose+0xba>
    pipeclose(ff.pipe, ff.writable);
  } else if(ff.type == FD_INODE || ff.type == FD_DEVICE){
    80004a18:	3979                	addiw	s2,s2,-2
    80004a1a:	4785                	li	a5,1
    80004a1c:	0527e063          	bltu	a5,s2,80004a5c <fileclose+0xa8>
    begin_op();
    80004a20:	00000097          	auipc	ra,0x0
    80004a24:	ac8080e7          	jalr	-1336(ra) # 800044e8 <begin_op>
    iput(ff.ip);
    80004a28:	854e                	mv	a0,s3
    80004a2a:	fffff097          	auipc	ra,0xfffff
    80004a2e:	2a6080e7          	jalr	678(ra) # 80003cd0 <iput>
    end_op();
    80004a32:	00000097          	auipc	ra,0x0
    80004a36:	b36080e7          	jalr	-1226(ra) # 80004568 <end_op>
    80004a3a:	a00d                	j	80004a5c <fileclose+0xa8>
    panic("fileclose");
    80004a3c:	00004517          	auipc	a0,0x4
    80004a40:	cfc50513          	addi	a0,a0,-772 # 80008738 <syscall_argc+0x1f8>
    80004a44:	ffffc097          	auipc	ra,0xffffc
    80004a48:	afa080e7          	jalr	-1286(ra) # 8000053e <panic>
    release(&ftable.lock);
    80004a4c:	0001e517          	auipc	a0,0x1e
    80004a50:	36c50513          	addi	a0,a0,876 # 80022db8 <ftable>
    80004a54:	ffffc097          	auipc	ra,0xffffc
    80004a58:	244080e7          	jalr	580(ra) # 80000c98 <release>
  }
}
    ...
    80004a6c:	8082                	ret
    pipeclose(ff.pipe, ff.writable);
    80004a6e:	85d6                	mv	a1,s5
    80004a70:	8552                	mv	a0,s4
    80004a72:	00000097          	auipc	ra,0x0
    80004a76:	34c080e7          	jalr	844(ra) # 80004dbe <pipeclose>
    80004a7a:	b7cd                	j	80004a5c <fileclose+0xa8>

0000000080004a7c <filestat>:
...
{
    80004a7c:	715d                	addi	sp,sp,-80
    80004a7e:	e486                	sd	ra,72(sp)
    80004a80:	e0a2                	sd	s0,64(sp)
    80004a82:	fc26                	sd	s1,56(sp)
    80004a84:	f84a                	sd	s2,48(sp)
  ...
  struct proc *p = myproc();
    ...
    80004a92:	f22080e7          	jalr	-222(ra) # 800019b0 <myproc>
  struct stat st;
  ...
  if(f->type == FD_INODE || f->type == FD_DEVICE){
    ...
    80004a9c:	04f76763          	bltu	a4,a5,80004aea <filestat+0x6e>
    80004aa0:	892a                	mv	s2,a0
    ilock(f->ip);
    80004aa2:	6c88                	ld	a0,24(s1)
    80004aa4:	fffff097          	auipc	ra,0xfffff
    80004aa8:	072080e7          	jalr	114(ra) # 80003b16 <ilock>
    stati(f->ip, &st);
    80004aac:	fb840593          	addi	a1,s0,-72
    80004ab0:	6c88                	ld	a0,24(s1)
    80004ab2:	fffff097          	auipc	ra,0xfffff
    80004ab6:	2ee080e7          	jalr	750(ra) # 80003da0 <stati>
    iunlock(f->ip);
    80004aba:	6c88                	ld	a0,24(s1)
    80004abc:	fffff097          	auipc	ra,0xfffff
    80004ac0:	11c080e7          	jalr	284(ra) # 80003bd8 <iunlock>
    if(copyout(p->pagetable, addr, (char *)&st, sizeof(st)) < 0)
    80004ac4:	46e1                	li	a3,24
    80004ac6:	fb840613          	addi	a2,s0,-72
    80004aca:	85ce                	mv	a1,s3
    80004acc:	05093503          	ld	a0,80(s2)
    80004ad0:	ffffd097          	auipc	ra,0xffffd
    80004ad4:	ba2080e7          	jalr	-1118(ra) # 80001672 <copyout>
    80004ad8:	41f5551b          	sraiw	a0,a0,0x1f
      return -1;
    return 0;
  }
  return -1;
  ...
  return -1;
    ...
    80004aec:	bfc5                	j	80004adc <filestat+0x60>

0000000080004aee <fileread>:
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->readable == 0)
    80004afc:	00854783          	lbu	a5,8(a0)
    80004b00:	c3d5                	beqz	a5,80004ba4 <fileread+0xb6>
    80004b02:	84aa                	mv	s1,a0
    80004b04:	89ae                	mv	s3,a1
    80004b06:	8932                	mv	s2,a2
    return -1;

  if(f->type == FD_PIPE){
    80004b08:	411c                	lw	a5,0(a0)
    80004b0a:	4705                	li	a4,1
    80004b0c:	04e78963          	beq	a5,a4,80004b5e <fileread+0x70>
    r = piperead(f->pipe, addr, n);
  } else if(f->type == FD_DEVICE){
    80004b10:	470d                	li	a4,3
    80004b12:	04e78d63          	beq	a5,a4,80004b6c <fileread+0x7e>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].read)
      return -1;
    r = devsw[f->major].read(1, addr, n);
  } else if(f->type == FD_INODE){
    80004b16:	4709                	li	a4,2
    80004b18:	06e79e63          	bne	a5,a4,80004b94 <fileread+0xa6>
    ilock(f->ip);
    80004b1c:	6d08                	ld	a0,24(a0)
    80004b1e:	fffff097          	auipc	ra,0xfffff
    80004b22:	ff8080e7          	jalr	-8(ra) # 80003b16 <ilock>
    if((r = readi(f->ip, 1, addr, f->off, n)) > 0)
    80004b26:	874a                	mv	a4,s2
    80004b28:	5094                	lw	a3,32(s1)
    80004b2a:	864e                	mv	a2,s3
    80004b2c:	4585                	li	a1,1
    80004b2e:	6c88                	ld	a0,24(s1)
    80004b30:	fffff097          	auipc	ra,0xfffff
    80004b34:	29a080e7          	jalr	666(ra) # 80003dca <readi>
    80004b38:	892a                	mv	s2,a0
    80004b3a:	00a05563          	blez	a0,80004b44 <fileread+0x56>
      f->off += r;
    80004b3e:	509c                	lw	a5,32(s1)
    80004b40:	9fa9                	addw	a5,a5,a0
    80004b42:	d09c                	sw	a5,32(s1)
    iunlock(f->ip);
    80004b44:	6c88                	ld	a0,24(s1)
    80004b46:	fffff097          	auipc	ra,0xfffff
    80004b4a:	092080e7          	jalr	146(ra) # 80003bd8 <iunlock>
  } else {
    panic("fileread");
  }
  ...
  return r;
    ...
    80004b5a:	6145                	addi	sp,sp,48
    80004b5c:	8082                	ret
    r = piperead(f->pipe, addr, n);
    80004b5e:	6908                	ld	a0,16(a0)
    80004b60:	00000097          	auipc	ra,0x0
    80004b64:	3c8080e7          	jalr	968(ra) # 80004f28 <piperead>
    80004b68:	892a                	mv	s2,a0
    80004b6a:	b7d5                	j	80004b4e <fileread+0x60>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].read)
    80004b6c:	02451783          	lh	a5,36(a0)
    80004b70:	03079693          	slli	a3,a5,0x30
    80004b74:	92c1                	srli	a3,a3,0x30
    80004b76:	4725                	li	a4,9
    80004b78:	02d76863          	bltu	a4,a3,80004ba8 <fileread+0xba>
    80004b7c:	0792                	slli	a5,a5,0x4
    80004b7e:	0001e717          	auipc	a4,0x1e
    80004b82:	19a70713          	addi	a4,a4,410 # 80022d18 <devsw>
    80004b86:	97ba                	add	a5,a5,a4
    80004b88:	639c                	ld	a5,0(a5)
    80004b8a:	c38d                	beqz	a5,80004bac <fileread+0xbe>
    r = devsw[f->major].read(1, addr, n);
    80004b8c:	4505                	li	a0,1
    80004b8e:	9782                	jalr	a5
    80004b90:	892a                	mv	s2,a0
    80004b92:	bf75                	j	80004b4e <fileread+0x60>
    panic("fileread");
    80004b94:	00004517          	auipc	a0,0x4
    80004b98:	bb450513          	addi	a0,a0,-1100 # 80008748 <syscall_argc+0x208>
    80004b9c:	ffffc097          	auipc	ra,0xffffc
    80004ba0:	9a2080e7          	jalr	-1630(ra) # 8000053e <panic>
    return -1;
    80004ba4:	597d                	li	s2,-1
    80004ba6:	b765                	j	80004b4e <fileread+0x60>
      return -1;
    80004ba8:	597d                	li	s2,-1
    80004baa:	b755                	j	80004b4e <fileread+0x60>
    80004bac:	597d                	li	s2,-1
    80004bae:	b745                	j	80004b4e <fileread+0x60>

0000000080004bb0 <filewrite>:
...
filewrite(struct file *f, uint64 addr, int n)
{
    ...
    80004bc2:	e45e                	sd	s7,8(sp)
    80004bc4:	e062                	sd	s8,0(sp)
    80004bc6:	0880                	addi	s0,sp,80
  int r, ret = 0;

  if(f->writable == 0)
    80004bc8:	00954783          	lbu	a5,9(a0)
    80004bcc:	10078663          	beqz	a5,80004cd8 <filewrite+0x128>
    80004bd0:	892a                	mv	s2,a0
    80004bd2:	8aae                	mv	s5,a1
    80004bd4:	8a32                	mv	s4,a2
    return -1;

  if(f->type == FD_PIPE){
    80004bd6:	411c                	lw	a5,0(a0)
    80004bd8:	4705                	li	a4,1
    80004bda:	02e78263          	beq	a5,a4,80004bfe <filewrite+0x4e>
    ret = pipewrite(f->pipe, addr, n);
  } else if(f->type == FD_DEVICE){
    80004bde:	470d                	li	a4,3
    80004be0:	02e78663          	beq	a5,a4,80004c0c <filewrite+0x5c>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].write)
      return -1;
    ret = devsw[f->major].write(1, addr, n);
  } else if(f->type == FD_INODE){
    80004be4:	4709                	li	a4,2
    80004be6:	0ee79163          	bne	a5,a4,80004cc8 <filewrite+0x118>
    ...
    int i = 0;
    while(i < n){
    80004bea:	0ac05d63          	blez	a2,80004ca4 <filewrite+0xf4>
    int i = 0;
    80004bee:	4981                	li	s3,0
    80004bf0:	6b05                	lui	s6,0x1
    80004bf2:	c00b0b13          	addi	s6,s6,-1024 # c00 <_entry-0x7ffff400>
    80004bf6:	6b85                	lui	s7,0x1
    80004bf8:	c00b8b9b          	addiw	s7,s7,-1024
    80004bfc:	a861                	j	80004c94 <filewrite+0xe4>
    ret = pipewrite(f->pipe, addr, n);
    80004bfe:	6908                	ld	a0,16(a0)
    80004c00:	00000097          	auipc	ra,0x0
    80004c04:	22e080e7          	jalr	558(ra) # 80004e2e <pipewrite>
    80004c08:	8a2a                	mv	s4,a0
    80004c0a:	a045                	j	80004caa <filewrite+0xfa>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].write)
    80004c0c:	02451783          	lh	a5,36(a0)
    80004c10:	03079693          	slli	a3,a5,0x30
    80004c14:	92c1                	srli	a3,a3,0x30
    80004c16:	4725                	li	a4,9
    80004c18:	0cd76263          	bltu	a4,a3,80004cdc <filewrite+0x12c>
    80004c1c:	0792                	slli	a5,a5,0x4
    80004c1e:	0001e717          	auipc	a4,0x1e
    80004c22:	0fa70713          	addi	a4,a4,250 # 80022d18 <devsw>
    80004c26:	97ba                	add	a5,a5,a4
    80004c28:	679c                	ld	a5,8(a5)
    80004c2a:	cbdd                	beqz	a5,80004ce0 <filewrite+0x130>
    ret = devsw[f->major].write(1, addr, n);
    80004c2c:	4505                	li	a0,1
    80004c2e:	9782                	jalr	a5
    80004c30:	8a2a                	mv	s4,a0
    80004c32:	a8a5                	j	80004caa <filewrite+0xfa>
    80004c34:	00048c1b          	sext.w	s8,s1
      int n1 = n - i;
      if(n1 > max)
        n1 = max;
    ...
    80004c3c:	8b0080e7          	jalr	-1872(ra) # 800044e8 <begin_op>
      ilock(f->ip);
    80004c40:	01893503          	ld	a0,24(s2)
    80004c44:	fffff097          	auipc	ra,0xfffff
    80004c48:	ed2080e7          	jalr	-302(ra) # 80003b16 <ilock>
      if ((r = writei(f->ip, 1, addr + i, f->off, n1)) > 0)
    80004c4c:	8762                	mv	a4,s8
    80004c4e:	02092683          	lw	a3,32(s2)
    80004c52:	01598633          	add	a2,s3,s5
    80004c56:	4585                	li	a1,1
    80004c58:	01893503          	ld	a0,24(s2)
    80004c5c:	fffff097          	auipc	ra,0xfffff
    80004c60:	266080e7          	jalr	614(ra) # 80003ec2 <writei>
    80004c64:	84aa                	mv	s1,a0
    80004c66:	00a05763          	blez	a0,80004c74 <filewrite+0xc4>
        f->off += r;
    80004c6a:	02092783          	lw	a5,32(s2)
    80004c6e:	9fa9                	addw	a5,a5,a0
    80004c70:	02f92023          	sw	a5,32(s2)
      iunlock(f->ip);
    80004c74:	01893503          	ld	a0,24(s2)
    80004c78:	fffff097          	auipc	ra,0xfffff
    80004c7c:	f60080e7          	jalr	-160(ra) # 80003bd8 <iunlock>
      end_op();
    80004c80:	00000097          	auipc	ra,0x0
    80004c84:	8e8080e7          	jalr	-1816(ra) # 80004568 <end_op>

      if(r != n1){
    80004c88:	009c1f63          	bne	s8,s1,80004ca6 <filewrite+0xf6>
        // error from writei
        break;
      }
      i += r;
    80004c8c:	013489bb          	addw	s3,s1,s3
    while(i < n){
    80004c90:	0149db63          	bge	s3,s4,80004ca6 <filewrite+0xf6>
      int n1 = n - i;
    80004c94:	413a07bb          	subw	a5,s4,s3
      if(n1 > max)
    80004c98:	84be                	mv	s1,a5
    80004c9a:	2781                	sext.w	a5,a5
    80004c9c:	f8fb5ce3          	bge	s6,a5,80004c34 <filewrite+0x84>
    80004ca0:	84de                	mv	s1,s7
    80004ca2:	bf49                	j	80004c34 <filewrite+0x84>
    int i = 0;
    80004ca4:	4981                	li	s3,0
    }
    ret = (i == n ? n : -1);
    80004ca6:	013a1f63          	bne	s4,s3,80004cc4 <filewrite+0x114>
  } else {
    panic("filewrite");
  }
  ...
  return ret;
    ...
    80004cb2:	7942                	ld	s2,48(sp)
    80004cb4:	79a2                	ld	s3,40(sp)
    80004cb6:	7a02                	ld	s4,32(sp)
    80004cb8:	6ae2                	ld	s5,24(sp)
    80004cba:	6b42                	ld	s6,16(sp)
    80004cbc:	6ba2                	ld	s7,8(sp)
    80004cbe:	6c02                	ld	s8,0(sp)
    80004cc0:	6161                	addi	sp,sp,80
    80004cc2:	8082                	ret
    ret = (i == n ? n : -1);
    80004cc4:	5a7d                	li	s4,-1
    80004cc6:	b7d5                	j	80004caa <filewrite+0xfa>
    panic("filewrite");
    80004cc8:	00004517          	auipc	a0,0x4
    80004ccc:	a9050513          	addi	a0,a0,-1392 # 80008758 <syscall_argc+0x218>
    80004cd0:	ffffc097          	auipc	ra,0xffffc
    80004cd4:	86e080e7          	jalr	-1938(ra) # 8000053e <panic>
    return -1;
    80004cd8:	5a7d                	li	s4,-1
    80004cda:	bfc1                	j	80004caa <filewrite+0xfa>
      return -1;
    80004cdc:	5a7d                	li	s4,-1
    80004cde:	b7f1                	j	80004caa <filewrite+0xfa>
    80004ce0:	5a7d                	li	s4,-1
    80004ce2:	b7e1                	j	80004caa <filewrite+0xfa>

0000000080004ce4 <pipealloc>:
...
pipealloc(struct file **f0, struct file **f1)
{
    ...
    80004cf0:	e052                	sd	s4,0(sp)
    80004cf2:	1800                	addi	s0,sp,48
    80004cf4:	84aa                	mv	s1,a0
    80004cf6:	8a2e                	mv	s4,a1
  struct pipe *pi;

  pi = 0;
  *f0 = *f1 = 0;
    80004cf8:	0005b023          	sd	zero,0(a1)
    80004cfc:	00053023          	sd	zero,0(a0)
  if((*f0 = filealloc()) == 0 || (*f1 = filealloc()) == 0)
    80004d00:	00000097          	auipc	ra,0x0
    80004d04:	bf8080e7          	jalr	-1032(ra) # 800048f8 <filealloc>
    80004d08:	e088                	sd	a0,0(s1)
    80004d0a:	c551                	beqz	a0,80004d96 <pipealloc+0xb2>
    80004d0c:	00000097          	auipc	ra,0x0
    80004d10:	bec080e7          	jalr	-1044(ra) # 800048f8 <filealloc>
    80004d14:	00aa3023          	sd	a0,0(s4)
    80004d18:	c92d                	beqz	a0,80004d8a <pipealloc+0xa6>
    goto bad;
  if((pi = (struct pipe*)kalloc()) == 0)
    80004d1a:	ffffc097          	auipc	ra,0xffffc
    80004d1e:	dda080e7          	jalr	-550(ra) # 80000af4 <kalloc>
    80004d22:	892a                	mv	s2,a0
    80004d24:	c125                	beqz	a0,80004d84 <pipealloc+0xa0>
    goto bad;
  pi->readopen = 1;
    80004d26:	4985                	li	s3,1
    80004d28:	23352023          	sw	s3,544(a0)
  pi->writeopen = 1;
    80004d2c:	23352223          	sw	s3,548(a0)
  pi->nwrite = 0;
    80004d30:	20052e23          	sw	zero,540(a0)
  pi->nread = 0;
    80004d34:	20052c23          	sw	zero,536(a0)
  initlock(&pi->lock, "pipe");
    80004d38:	00004597          	auipc	a1,0x4
    80004d3c:	a3058593          	addi	a1,a1,-1488 # 80008768 <syscall_argc+0x228>
    80004d40:	ffffc097          	auipc	ra,0xffffc
    80004d44:	e14080e7          	jalr	-492(ra) # 80000b54 <initlock>
  (*f0)->type = FD_PIPE;
    80004d48:	609c                	ld	a5,0(s1)
    80004d4a:	0137a023          	sw	s3,0(a5)
  (*f0)->readable = 1;
    80004d4e:	609c                	ld	a5,0(s1)
    80004d50:	01378423          	sb	s3,8(a5)
  (*f0)->writable = 0;
    80004d54:	609c                	ld	a5,0(s1)
    80004d56:	000784a3          	sb	zero,9(a5)
  (*f0)->pipe = pi;
    80004d5a:	609c                	ld	a5,0(s1)
    80004d5c:	0127b823          	sd	s2,16(a5)
  (*f1)->type = FD_PIPE;
    80004d60:	000a3783          	ld	a5,0(s4)
    80004d64:	0137a023          	sw	s3,0(a5)
  (*f1)->readable = 0;
    80004d68:	000a3783          	ld	a5,0(s4)
    80004d6c:	00078423          	sb	zero,8(a5)
  (*f1)->writable = 1;
    80004d70:	000a3783          	ld	a5,0(s4)
    80004d74:	013784a3          	sb	s3,9(a5)
  (*f1)->pipe = pi;
    80004d78:	000a3783          	ld	a5,0(s4)
    80004d7c:	0127b823          	sd	s2,16(a5)
  return 0;
    80004d80:	4501                	li	a0,0
    80004d82:	a025                	j	80004daa <pipealloc+0xc6>
 ...
 bad:
  ...
  if(*f0)
    ...
    80004d86:	e501                	bnez	a0,80004d8e <pipealloc+0xaa>
    80004d88:	a039                	j	80004d96 <pipealloc+0xb2>
    80004d8a:	6088                	ld	a0,0(s1)
    80004d8c:	c51d                	beqz	a0,80004dba <pipealloc+0xd6>
    fileclose(*f0);
    80004d8e:	00000097          	auipc	ra,0x0
    80004d92:	c26080e7          	jalr	-986(ra) # 800049b4 <fileclose>
  if(*f1)
  ...
  if(*f1)
    80004d9c:	c799                	beqz	a5,80004daa <pipealloc+0xc6>
    fileclose(*f1);
    80004d9e:	853e                	mv	a0,a5
    80004da0:	00000097          	auipc	ra,0x0
    80004da4:	c14080e7          	jalr	-1004(ra) # 800049b4 <fileclose>
  return -1;
    80004da8:	557d                	li	a0,-1
}
    80004daa:	70a2                	ld	ra,40(sp)
    80004dac:	7402                	ld	s0,32(sp)
    80004dae:	64e2                	ld	s1,24(sp)
    80004db0:	6942                	ld	s2,16(sp)
    80004db2:	69a2                	ld	s3,8(sp)
    80004db4:	6a02                	ld	s4,0(sp)
    80004db6:	6145                	addi	sp,sp,48
    80004db8:	8082                	ret
  return -1;
    80004dba:	557d                	li	a0,-1
    80004dbc:	b7fd                	j	80004daa <pipealloc+0xc6>

0000000080004dbe <pipeclose>:
...
pipeclose(struct pipe *pi, int writable)
{
    ...
    80004dc6:	e04a                	sd	s2,0(sp)
    80004dc8:	1000                	addi	s0,sp,32
    80004dca:	84aa                	mv	s1,a0
    80004dcc:	892e                	mv	s2,a1
  acquire(&pi->lock);
    80004dce:	ffffc097          	auipc	ra,0xffffc
    80004dd2:	e16080e7          	jalr	-490(ra) # 80000be4 <acquire>
  if(writable){
    80004dd6:	02090d63          	beqz	s2,80004e10 <pipeclose+0x52>
    pi->writeopen = 0;
    80004dda:	2204a223          	sw	zero,548(s1)
    wakeup(&pi->nread);
    80004dde:	21848513          	addi	a0,s1,536
    80004de2:	ffffd097          	auipc	ra,0xffffd
    80004de6:	512080e7          	jalr	1298(ra) # 800022f4 <wakeup>
  } else {
    pi->readopen = 0;
    wakeup(&pi->nwrite);
  }
  if(pi->readopen == 0 && pi->writeopen == 0){
    80004dea:	2204b783          	ld	a5,544(s1)
    80004dee:	eb95                	bnez	a5,80004e22 <pipeclose+0x64>
    release(&pi->lock);
    ...
    80004e00:	bfc080e7          	jalr	-1028(ra) # 800009f8 <kfree>
  } else
    release(&pi->lock);
}
    ...
    80004e0e:	8082                	ret
    pi->readopen = 0;
    80004e10:	2204a023          	sw	zero,544(s1)
    wakeup(&pi->nwrite);
    80004e14:	21c48513          	addi	a0,s1,540
    80004e18:	ffffd097          	auipc	ra,0xffffd
    80004e1c:	4dc080e7          	jalr	1244(ra) # 800022f4 <wakeup>
    80004e20:	b7e9                	j	80004dea <pipeclose+0x2c>
    release(&pi->lock);
    80004e22:	8526                	mv	a0,s1
    80004e24:	ffffc097          	auipc	ra,0xffffc
    80004e28:	e74080e7          	jalr	-396(ra) # 80000c98 <release>
}
    80004e2c:	bfe1                	j	80004e04 <pipeclose+0x46>

0000000080004e2e <pipewrite>:

int
pipewrite(struct pipe *pi, uint64 addr, int n)
{
    80004e2e:	7159                	addi	sp,sp,-112
    80004e30:	f486                	sd	ra,104(sp)
    80004e32:	f0a2                	sd	s0,96(sp)
    80004e34:	eca6                	sd	s1,88(sp)
    80004e36:	e8ca                	sd	s2,80(sp)
    80004e38:	e4ce                	sd	s3,72(sp)
    80004e3a:	e0d2                	sd	s4,64(sp)
    80004e3c:	fc56                	sd	s5,56(sp)
    80004e3e:	f85a                	sd	s6,48(sp)
    80004e40:	f45e                	sd	s7,40(sp)
    80004e42:	f062                	sd	s8,32(sp)
    80004e44:	ec66                	sd	s9,24(sp)
    80004e46:	1880                	addi	s0,sp,112
    80004e48:	84aa                	mv	s1,a0
    80004e4a:	8aae                	mv	s5,a1
    80004e4c:	8a32                	mv	s4,a2
  int i = 0;
  struct proc *pr = myproc();
    80004e4e:	ffffd097          	auipc	ra,0xffffd
    80004e52:	b62080e7          	jalr	-1182(ra) # 800019b0 <myproc>
    80004e56:	89aa                	mv	s3,a0

  acquire(&pi->lock);
    80004e58:	8526                	mv	a0,s1
    80004e5a:	ffffc097          	auipc	ra,0xffffc
    80004e5e:	d8a080e7          	jalr	-630(ra) # 80000be4 <acquire>
  while(i < n){
    80004e62:	0d405163          	blez	s4,80004f24 <pipewrite+0xf6>
    80004e66:	8ba6                	mv	s7,s1
  int i = 0;
    ...
    80004e6a:	5b7d                	li	s6,-1
      wakeup(&pi->nread);
    80004e6c:	21848c93          	addi	s9,s1,536
      sleep(&pi->nwrite, &pi->lock);
    80004e70:	21c48c13          	addi	s8,s1,540
    80004e74:	a08d                	j	80004ed6 <pipewrite+0xa8>
      release(&pi->lock);
  ...
  return i;
    ...
    80004e84:	70a6                	ld	ra,104(sp)
    80004e86:	7406                	ld	s0,96(sp)
    80004e88:	64e6                	ld	s1,88(sp)
    80004e8a:	6946                	ld	s2,80(sp)
    80004e8c:	69a6                	ld	s3,72(sp)
    80004e8e:	6a06                	ld	s4,64(sp)
    80004e90:	7ae2                	ld	s5,56(sp)
    80004e92:	7b42                	ld	s6,48(sp)
    80004e94:	7ba2                	ld	s7,40(sp)
    80004e96:	7c02                	ld	s8,32(sp)
    80004e98:	6ce2                	ld	s9,24(sp)
    80004e9a:	6165                	addi	sp,sp,112
    80004e9c:	8082                	ret
      wakeup(&pi->nread);
    80004e9e:	8566                	mv	a0,s9
    80004ea0:	ffffd097          	auipc	ra,0xffffd
    80004ea4:	454080e7          	jalr	1108(ra) # 800022f4 <wakeup>
      sleep(&pi->nwrite, &pi->lock);
    80004ea8:	85de                	mv	a1,s7
    80004eaa:	8562                	mv	a0,s8
    80004eac:	ffffd097          	auipc	ra,0xffffd
    80004eb0:	2bc080e7          	jalr	700(ra) # 80002168 <sleep>
    80004eb4:	a839                	j	80004ed2 <pipewrite+0xa4>
      pi->data[pi->nwrite++ % PIPESIZE] = ch;
    80004eb6:	21c4a783          	lw	a5,540(s1)
    80004eba:	0017871b          	addiw	a4,a5,1
    80004ebe:	20e4ae23          	sw	a4,540(s1)
    80004ec2:	1ff7f793          	andi	a5,a5,511
    80004ec6:	97a6                	add	a5,a5,s1
    80004ec8:	f9f44703          	lbu	a4,-97(s0)
    80004ecc:	00e78c23          	sb	a4,24(a5)
      i++;
    80004ed0:	2905                	addiw	s2,s2,1
  while(i < n){
    80004ed2:	03495d63          	bge	s2,s4,80004f0c <pipewrite+0xde>
    if(pi->readopen == 0 || pr->killed){
    80004ed6:	2204a783          	lw	a5,544(s1)
    80004eda:	dfd1                	beqz	a5,80004e76 <pipewrite+0x48>
    80004edc:	0289a783          	lw	a5,40(s3)
    80004ee0:	fbd9                	bnez	a5,80004e76 <pipewrite+0x48>
    if(pi->nwrite == pi->nread + PIPESIZE){ //DOC: pipewrite-full
    80004ee2:	2184a783          	lw	a5,536(s1)
    80004ee6:	21c4a703          	lw	a4,540(s1)
    80004eea:	2007879b          	addiw	a5,a5,512
    80004eee:	faf708e3          	beq	a4,a5,80004e9e <pipewrite+0x70>
      if(copyin(pr->pagetable, &ch, addr + i, 1) == -1)
    80004ef2:	4685                	li	a3,1
    80004ef4:	01590633          	add	a2,s2,s5
    80004ef8:	f9f40593          	addi	a1,s0,-97
    80004efc:	0509b503          	ld	a0,80(s3)
    80004f00:	ffffc097          	auipc	ra,0xffffc
    80004f04:	7fe080e7          	jalr	2046(ra) # 800016fe <copyin>
    80004f08:	fb6517e3          	bne	a0,s6,80004eb6 <pipewrite+0x88>
  wakeup(&pi->nread);
    80004f0c:	21848513          	addi	a0,s1,536
    80004f10:	ffffd097          	auipc	ra,0xffffd
    80004f14:	3e4080e7          	jalr	996(ra) # 800022f4 <wakeup>
  release(&pi->lock);
    80004f18:	8526                	mv	a0,s1
    80004f1a:	ffffc097          	auipc	ra,0xffffc
    80004f1e:	d7e080e7          	jalr	-642(ra) # 80000c98 <release>
  return i;
    80004f22:	b785                	j	80004e82 <pipewrite+0x54>
  int i = 0;
    80004f24:	4901                	li	s2,0
    80004f26:	b7dd                	j	80004f0c <pipewrite+0xde>

0000000080004f28 <piperead>:
...
piperead(struct pipe *pi, uint64 addr, int n)
{
    ...
    80004f34:	f052                	sd	s4,32(sp)
    80004f36:	ec56                	sd	s5,24(sp)
    80004f38:	e85a                	sd	s6,16(sp)
    80004f3a:	0880                	addi	s0,sp,80
    80004f3c:	84aa                	mv	s1,a0
    80004f3e:	892e                	mv	s2,a1
    80004f40:	8ab2                	mv	s5,a2
  int i;
  struct proc *pr = myproc();
    80004f42:	ffffd097          	auipc	ra,0xffffd
    80004f46:	a6e080e7          	jalr	-1426(ra) # 800019b0 <myproc>
    80004f4a:	8a2a                	mv	s4,a0
  char ch;

  acquire(&pi->lock);
    80004f4c:	8b26                	mv	s6,s1
  ...
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    80004f64:	02f71463          	bne	a4,a5,80004f8c <piperead+0x64>
    80004f68:	2244a783          	lw	a5,548(s1)
    80004f6c:	c385                	beqz	a5,80004f8c <piperead+0x64>
    if(pr->killed){
    80004f6e:	028a2783          	lw	a5,40(s4)
    80004f72:	ebc1                	bnez	a5,80005002 <piperead+0xda>
    sleep(&pi->nread, &pi->lock); //DOC: piperead-sleep
    80004f74:	85da                	mv	a1,s6
    80004f76:	854e                	mv	a0,s3
    80004f78:	ffffd097          	auipc	ra,0xffffd
    80004f7c:	1f0080e7          	jalr	496(ra) # 80002168 <sleep>
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    80004f80:	2184a703          	lw	a4,536(s1)
    80004f84:	21c4a783          	lw	a5,540(s1)
    80004f88:	fef700e3          	beq	a4,a5,80004f68 <piperead+0x40>
  }
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    80004f8c:	09505263          	blez	s5,80005010 <piperead+0xe8>
    ...
    if(pi->nread == pi->nwrite)
    80004f94:	2184a783          	lw	a5,536(s1)
    80004f98:	21c4a703          	lw	a4,540(s1)
    80004f9c:	02f70d63          	beq	a4,a5,80004fd6 <piperead+0xae>
    ch = pi->data[pi->nread++ % PIPESIZE];
    80004fa0:	0017871b          	addiw	a4,a5,1
    80004fa4:	20e4ac23          	sw	a4,536(s1)
    80004fa8:	1ff7f793          	andi	a5,a5,511
    80004fac:	97a6                	add	a5,a5,s1
    80004fae:	0187c783          	lbu	a5,24(a5)
    80004fb2:	faf40fa3          	sb	a5,-65(s0)
    if(copyout(pr->pagetable, addr + i, &ch, 1) == -1)
    80004fb6:	4685                	li	a3,1
    80004fb8:	fbf40613          	addi	a2,s0,-65
    80004fbc:	85ca                	mv	a1,s2
    80004fbe:	050a3503          	ld	a0,80(s4)
    80004fc2:	ffffc097          	auipc	ra,0xffffc
    80004fc6:	6b0080e7          	jalr	1712(ra) # 80001672 <copyout>
    80004fca:	01650663          	beq	a0,s6,80004fd6 <piperead+0xae>
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    80004fce:	2985                	addiw	s3,s3,1
    80004fd0:	0905                	addi	s2,s2,1
    80004fd2:	fd3a91e3          	bne	s5,s3,80004f94 <piperead+0x6c>
      break;
  }
  wakeup(&pi->nwrite);  //DOC: piperead-wakeup
    80004fd6:	21c48513          	addi	a0,s1,540
    80004fda:	ffffd097          	auipc	ra,0xffffd
    80004fde:	31a080e7          	jalr	794(ra) # 800022f4 <wakeup>
  release(&pi->lock);
  ...
  return i;
    ...
    80005008:	c94080e7          	jalr	-876(ra) # 80000c98 <release>
      return -1;
    8000500c:	59fd                	li	s3,-1
    8000500e:	bff9                	j	80004fec <piperead+0xc4>
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    80005010:	4981                	li	s3,0
    80005012:	b7d1                	j	80004fd6 <piperead+0xae>
...
{
    80005014:	df010113          	addi	sp,sp,-528
    80005018:	20113423          	sd	ra,520(sp)
    8000501c:	20813023          	sd	s0,512(sp)
    80005020:	ffa6                	sd	s1,504(sp)
    80005022:	fbca                	sd	s2,496(sp)
    80005024:	f7ce                	sd	s3,488(sp)
    80005026:	f3d2                	sd	s4,480(sp)
    80005028:	efd6                	sd	s5,472(sp)
    8000502a:	ebda                	sd	s6,464(sp)
    8000502c:	e7de                	sd	s7,456(sp)
    8000502e:	e3e2                	sd	s8,448(sp)
    80005030:	ff66                	sd	s9,440(sp)
    80005032:	fb6a                	sd	s10,432(sp)
    80005034:	f76e                	sd	s11,424(sp)
    80005036:	0c00                	addi	s0,sp,528
    80005038:	84aa                	mv	s1,a0
    8000503a:	dea43c23          	sd	a0,-520(s0)
    8000503e:	e0b43023          	sd	a1,-512(s0)
  ...
  struct proc *p = myproc();
    ...
    80005046:	96e080e7          	jalr	-1682(ra) # 800019b0 <myproc>
    8000504a:	892a                	mv	s2,a0

  begin_op();
    8000504c:	fffff097          	auipc	ra,0xfffff
    80005050:	49c080e7          	jalr	1180(ra) # 800044e8 <begin_op>

  if((ip = namei(path)) == 0){
    80005054:	8526                	mv	a0,s1
    80005056:	fffff097          	auipc	ra,0xfffff
    8000505a:	276080e7          	jalr	630(ra) # 800042cc <namei>
    8000505e:	c92d                	beqz	a0,800050d0 <exec+0xbc>
  ...
  ilock(ip);
    ...
    80005066:	ab4080e7          	jalr	-1356(ra) # 80003b16 <ilock>

  // Check ELF header
  if(readi(ip, 0, (uint64)&elf, 0, sizeof(elf)) != sizeof(elf))
    8000506a:	04000713          	li	a4,64
    8000506e:	4681                	li	a3,0
    80005070:	e5040613          	addi	a2,s0,-432
    80005074:	4581                	li	a1,0
    80005076:	8526                	mv	a0,s1
    80005078:	fffff097          	auipc	ra,0xfffff
    8000507c:	d52080e7          	jalr	-686(ra) # 80003dca <readi>
    80005080:	04000793          	li	a5,64
    80005084:	00f51a63          	bne	a0,a5,80005098 <exec+0x84>
    goto bad;
  if(elf.magic != ELF_MAGIC)
    80005088:	e5042703          	lw	a4,-432(s0)
    8000508c:	464c47b7          	lui	a5,0x464c4
    80005090:	57f78793          	addi	a5,a5,1407 # 464c457f <_entry-0x39b3ba81>
    80005094:	04f70463          	beq	a4,a5,800050dc <exec+0xc8>
 ...
 bad:
  ...
  if(ip){
    ...
    8000509e:	cde080e7          	jalr	-802(ra) # 80003d78 <iunlockput>
    end_op();
    800050a2:	fffff097          	auipc	ra,0xfffff
    800050a6:	4c6080e7          	jalr	1222(ra) # 80004568 <end_op>
  }
  return -1;
    800050aa:	557d                	li	a0,-1
}
    800050ac:	20813083          	ld	ra,520(sp)
    800050b0:	20013403          	ld	s0,512(sp)
    800050b4:	74fe                	ld	s1,504(sp)
    800050b6:	795e                	ld	s2,496(sp)
    800050b8:	79be                	ld	s3,488(sp)
    800050ba:	7a1e                	ld	s4,480(sp)
    ...
    800050c8:	7dba                	ld	s11,424(sp)
    800050ca:	21010113          	addi	sp,sp,528
    800050ce:	8082                	ret
    end_op();
    800050d0:	fffff097          	auipc	ra,0xfffff
    800050d4:	498080e7          	jalr	1176(ra) # 80004568 <end_op>
    return -1;
    800050d8:	557d                	li	a0,-1
    800050da:	bfc9                	j	800050ac <exec+0x98>
  if((pagetable = proc_pagetable(p)) == 0)
    800050dc:	854a                	mv	a0,s2
    800050de:	ffffd097          	auipc	ra,0xffffd
    800050e2:	996080e7          	jalr	-1642(ra) # 80001a74 <proc_pagetable>
    800050e6:	8baa                	mv	s7,a0
    800050e8:	d945                	beqz	a0,80005098 <exec+0x84>
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    800050ea:	e7042983          	lw	s3,-400(s0)
    800050ee:	e8845783          	lhu	a5,-376(s0)
    800050f2:	c7ad                	beqz	a5,8000515c <exec+0x148>
  uint64 argc, sz = 0, sp, ustack[MAXARG], stackbase;
    800050f4:	4901                	li	s2,0
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    800050f6:	4b01                	li	s6,0
    if((ph.vaddr % PGSIZE) != 0)
    800050f8:	6c85                	lui	s9,0x1
    800050fa:	fffc8793          	addi	a5,s9,-1 # fff <_entry-0x7ffff001>
    800050fe:	def43823          	sd	a5,-528(s0)
    80005102:	a42d                	j	8000532c <exec+0x318>
  uint64 pa;
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80005108:	66c50513          	addi	a0,a0,1644 # 80008770 <syscall_argc+0x230>
    ...
    80005114:	8756                	mv	a4,s5
    80005116:	012d86bb          	addw	a3,s11,s2
    8000511a:	4581                	li	a1,0
    8000511c:	8526                	mv	a0,s1
    8000511e:	fffff097          	auipc	ra,0xfffff
    80005122:	cac080e7          	jalr	-852(ra) # 80003dca <readi>
    80005126:	2501                	sext.w	a0,a0
    80005128:	1aaa9963          	bne	s5,a0,800052da <exec+0x2c6>
  for(i = 0; i < sz; i += PGSIZE){
    8000512c:	6785                	lui	a5,0x1
    8000512e:	0127893b          	addw	s2,a5,s2
    80005132:	77fd                	lui	a5,0xfffff
    80005134:	01478a3b          	addw	s4,a5,s4
    80005138:	1f897163          	bgeu	s2,s8,8000531a <exec+0x306>
    pa = walkaddr(pagetable, va + i);
    8000513c:	02091593          	slli	a1,s2,0x20
    80005140:	9181                	srli	a1,a1,0x20
    80005142:	95ea                	add	a1,a1,s10
    80005144:	855e                	mv	a0,s7
    80005146:	ffffc097          	auipc	ra,0xffffc
    8000514a:	f28080e7          	jalr	-216(ra) # 8000106e <walkaddr>
    8000514e:	862a                	mv	a2,a0
    if(pa == 0)
    80005150:	d955                	beqz	a0,80005104 <exec+0xf0>
      n = PGSIZE;
    80005152:	8ae6                	mv	s5,s9
    if(sz - i < PGSIZE)
    80005154:	fd9a70e3          	bgeu	s4,s9,80005114 <exec+0x100>
      n = sz - i;
    80005158:	8ad2                	mv	s5,s4
    8000515a:	bf6d                	j	80005114 <exec+0x100>
  uint64 argc, sz = 0, sp, ustack[MAXARG], stackbase;
    8000515c:	4901                	li	s2,0
  iunlockput(ip);
    8000515e:	8526                	mv	a0,s1
    80005160:	fffff097          	auipc	ra,0xfffff
    80005164:	c18080e7          	jalr	-1000(ra) # 80003d78 <iunlockput>
  end_op();
    80005168:	fffff097          	auipc	ra,0xfffff
    8000516c:	400080e7          	jalr	1024(ra) # 80004568 <end_op>
  p = myproc();
    80005170:	ffffd097          	auipc	ra,0xffffd
    80005174:	840080e7          	jalr	-1984(ra) # 800019b0 <myproc>
    80005178:	8aaa                	mv	s5,a0
  uint64 oldsz = p->sz;
    8000517a:	04853d03          	ld	s10,72(a0)
  sz = PGROUNDUP(sz);
    8000517e:	6785                	lui	a5,0x1
    80005180:	17fd                	addi	a5,a5,-1
    80005182:	993e                	add	s2,s2,a5
    80005184:	757d                	lui	a0,0xfffff
    80005186:	00a977b3          	and	a5,s2,a0
    8000518a:	e0f43423          	sd	a5,-504(s0)
  if((sz1 = uvmalloc(pagetable, sz, sz + 2*PGSIZE)) == 0)
    8000518e:	6609                	lui	a2,0x2
    80005190:	963e                	add	a2,a2,a5
    80005192:	85be                	mv	a1,a5
    80005194:	855e                	mv	a0,s7
    80005196:	ffffc097          	auipc	ra,0xffffc
    8000519a:	28c080e7          	jalr	652(ra) # 80001422 <uvmalloc>
    8000519e:	8b2a                	mv	s6,a0
  ip = 0;
    800051a0:	4481                	li	s1,0
  if((sz1 = uvmalloc(pagetable, sz, sz + 2*PGSIZE)) == 0)
    800051a2:	12050c63          	beqz	a0,800052da <exec+0x2c6>
  uvmclear(pagetable, sz-2*PGSIZE);
    800051a6:	75f9                	lui	a1,0xffffe
    800051a8:	95aa                	add	a1,a1,a0
    800051aa:	855e                	mv	a0,s7
    800051ac:	ffffc097          	auipc	ra,0xffffc
    800051b0:	494080e7          	jalr	1172(ra) # 80001640 <uvmclear>
  stackbase = sp - PGSIZE;
    800051b4:	7c7d                	lui	s8,0xfffff
    800051b6:	9c5a                	add	s8,s8,s6
  for(argc = 0; argv[argc]; argc++) {
    800051b8:	e0043783          	ld	a5,-512(s0)
    800051bc:	6388                	ld	a0,0(a5)
    800051be:	c535                	beqz	a0,8000522a <exec+0x216>
    800051c0:	e9040993          	addi	s3,s0,-368
    800051c4:	f9040c93          	addi	s9,s0,-112
  sp = sz;
    800051c8:	895a                	mv	s2,s6
    sp -= strlen(argv[argc]) + 1;
    800051ca:	ffffc097          	auipc	ra,0xffffc
    800051ce:	c9a080e7          	jalr	-870(ra) # 80000e64 <strlen>
    800051d2:	2505                	addiw	a0,a0,1
    800051d4:	40a90933          	sub	s2,s2,a0
    sp -= sp % 16; // riscv sp must be 16-byte aligned
    800051d8:	ff097913          	andi	s2,s2,-16
    if(sp < stackbase)
    800051dc:	13896363          	bltu	s2,s8,80005302 <exec+0x2ee>
    if(copyout(pagetable, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
    800051e0:	e0043d83          	ld	s11,-512(s0)
    800051e4:	000dba03          	ld	s4,0(s11)
    800051e8:	8552                	mv	a0,s4
    800051ea:	ffffc097          	auipc	ra,0xffffc
    800051ee:	c7a080e7          	jalr	-902(ra) # 80000e64 <strlen>
    800051f2:	0015069b          	addiw	a3,a0,1
    800051f6:	8652                	mv	a2,s4
    800051f8:	85ca                	mv	a1,s2
    800051fa:	855e                	mv	a0,s7
    800051fc:	ffffc097          	auipc	ra,0xffffc
    80005200:	476080e7          	jalr	1142(ra) # 80001672 <copyout>
    80005204:	10054363          	bltz	a0,8000530a <exec+0x2f6>
    ustack[argc] = sp;
    80005208:	0129b023          	sd	s2,0(s3)
  for(argc = 0; argv[argc]; argc++) {
    8000520c:	0485                	addi	s1,s1,1
    8000520e:	008d8793          	addi	a5,s11,8
    80005212:	e0f43023          	sd	a5,-512(s0)
    80005216:	008db503          	ld	a0,8(s11)
    8000521a:	c911                	beqz	a0,8000522e <exec+0x21a>
    if(argc >= MAXARG)
    8000521c:	09a1                	addi	s3,s3,8
    8000521e:	fb3c96e3          	bne	s9,s3,800051ca <exec+0x1b6>
  sz = sz1;
    80005222:	e1643423          	sd	s6,-504(s0)
  ip = 0;
    80005226:	4481                	li	s1,0
    80005228:	a84d                	j	800052da <exec+0x2c6>
  sp = sz;
    8000522a:	895a                	mv	s2,s6
  for(argc = 0; argv[argc]; argc++) {
    8000522c:	4481                	li	s1,0
  ustack[argc] = 0;
    8000522e:	00349793          	slli	a5,s1,0x3
    80005232:	f9040713          	addi	a4,s0,-112
    80005236:	97ba                	add	a5,a5,a4
    80005238:	f007b023          	sd	zero,-256(a5) # f00 <_entry-0x7ffff100>
  sp -= (argc+1) * sizeof(uint64);
    8000523c:	00148693          	addi	a3,s1,1
    80005240:	068e                	slli	a3,a3,0x3
    80005242:	40d90933          	sub	s2,s2,a3
  sp -= sp % 16;
    80005246:	ff097913          	andi	s2,s2,-16
  if(sp < stackbase)
    8000524a:	01897663          	bgeu	s2,s8,80005256 <exec+0x242>
  sz = sz1;
    8000524e:	e1643423          	sd	s6,-504(s0)
  ip = 0;
    80005252:	4481                	li	s1,0
    80005254:	a059                	j	800052da <exec+0x2c6>
  if(copyout(pagetable, sp, (char *)ustack, (argc+1)*sizeof(uint64)) < 0)
    80005256:	e9040613          	addi	a2,s0,-368
    8000525a:	85ca                	mv	a1,s2
    8000525c:	855e                	mv	a0,s7
    8000525e:	ffffc097          	auipc	ra,0xffffc
    80005262:	414080e7          	jalr	1044(ra) # 80001672 <copyout>
    80005266:	0a054663          	bltz	a0,80005312 <exec+0x2fe>
  p->trapframe->a1 = sp;
    8000526a:	058ab783          	ld	a5,88(s5)
    8000526e:	0727bc23          	sd	s2,120(a5)
  for(last=s=path; *s; s++)
    80005272:	df843783          	ld	a5,-520(s0)
    80005276:	0007c703          	lbu	a4,0(a5)
    8000527a:	cf11                	beqz	a4,80005296 <exec+0x282>
    8000527c:	0785                	addi	a5,a5,1
    if(*s == '/')
    8000527e:	02f00693          	li	a3,47
    80005282:	a039                	j	80005290 <exec+0x27c>
      last = s+1;
    80005284:	def43c23          	sd	a5,-520(s0)
  for(last=s=path; *s; s++)
    80005288:	0785                	addi	a5,a5,1
    8000528a:	fff7c703          	lbu	a4,-1(a5)
    8000528e:	c701                	beqz	a4,80005296 <exec+0x282>
    if(*s == '/')
    80005290:	fed71ce3          	bne	a4,a3,80005288 <exec+0x274>
    80005294:	bfc5                	j	80005284 <exec+0x270>
  safestrcpy(p->name, last, sizeof(p->name));
    80005296:	4641                	li	a2,16
    80005298:	df843583          	ld	a1,-520(s0)
    8000529c:	158a8513          	addi	a0,s5,344
    800052a0:	ffffc097          	auipc	ra,0xffffc
    800052a4:	b92080e7          	jalr	-1134(ra) # 80000e32 <safestrcpy>
  oldpagetable = p->pagetable;
    800052a8:	050ab503          	ld	a0,80(s5)
  p->pagetable = pagetable;
    800052ac:	057ab823          	sd	s7,80(s5)
  p->sz = sz;
    800052b0:	056ab423          	sd	s6,72(s5)
  p->trapframe->epc = elf.entry;  // initial program counter = main
    800052b4:	058ab783          	ld	a5,88(s5)
    800052b8:	e6843703          	ld	a4,-408(s0)
    800052bc:	ef98                	sd	a4,24(a5)
  p->trapframe->sp = sp; // initial stack pointer
    800052be:	058ab783          	ld	a5,88(s5)
    800052c2:	0327b823          	sd	s2,48(a5)
  proc_freepagetable(oldpagetable, oldsz);
    800052c6:	85ea                	mv	a1,s10
    800052c8:	ffffd097          	auipc	ra,0xffffd
    800052cc:	848080e7          	jalr	-1976(ra) # 80001b10 <proc_freepagetable>
  return argc; // this ends up in a0, the first argument to main(argc, argv)
    800052d0:	0004851b          	sext.w	a0,s1
    800052d4:	bbe1                	j	800050ac <exec+0x98>
    800052d6:	e1243423          	sd	s2,-504(s0)
    proc_freepagetable(pagetable, sz);
    800052da:	e0843583          	ld	a1,-504(s0)
    800052de:	855e                	mv	a0,s7
    800052e0:	ffffd097          	auipc	ra,0xffffd
    800052e4:	830080e7          	jalr	-2000(ra) # 80001b10 <proc_freepagetable>
  if(ip){
    800052e8:	da0498e3          	bnez	s1,80005098 <exec+0x84>
  return -1;
    800052ec:	557d                	li	a0,-1
    800052ee:	bb7d                	j	800050ac <exec+0x98>
    800052f0:	e1243423          	sd	s2,-504(s0)
    800052f4:	b7dd                	j	800052da <exec+0x2c6>
    800052f6:	e1243423          	sd	s2,-504(s0)
    800052fa:	b7c5                	j	800052da <exec+0x2c6>
    800052fc:	e1243423          	sd	s2,-504(s0)
    80005300:	bfe9                	j	800052da <exec+0x2c6>
  sz = sz1;
    80005302:	e1643423          	sd	s6,-504(s0)
  ip = 0;
    80005306:	4481                	li	s1,0
    80005308:	bfc9                	j	800052da <exec+0x2c6>
  sz = sz1;
    8000530a:	e1643423          	sd	s6,-504(s0)
  ip = 0;
    8000530e:	4481                	li	s1,0
    80005310:	b7e9                	j	800052da <exec+0x2c6>
  sz = sz1;
    80005312:	e1643423          	sd	s6,-504(s0)
  ip = 0;
    80005316:	4481                	li	s1,0
    80005318:	b7c9                	j	800052da <exec+0x2c6>
    if((sz1 = uvmalloc(pagetable, sz, ph.vaddr + ph.memsz)) == 0)
    8000531a:	e0843903          	ld	s2,-504(s0)
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    8000531e:	2b05                	addiw	s6,s6,1
    80005320:	0389899b          	addiw	s3,s3,56
    80005324:	e8845783          	lhu	a5,-376(s0)
    80005328:	e2fb5be3          	bge	s6,a5,8000515e <exec+0x14a>
    ...
    80005340:	a8e080e7          	jalr	-1394(ra) # 80003dca <readi>
    80005344:	03800793          	li	a5,56
    80005348:	f8f517e3          	bne	a0,a5,800052d6 <exec+0x2c2>
    if(ph.type != ELF_PROG_LOAD)
    8000534c:	e1842783          	lw	a5,-488(s0)
    80005350:	4705                	li	a4,1
    80005352:	fce796e3          	bne	a5,a4,8000531e <exec+0x30a>
    if(ph.memsz < ph.filesz)
    80005356:	e4043603          	ld	a2,-448(s0)
    8000535a:	e3843783          	ld	a5,-456(s0)
    8000535e:	f8f669e3          	bltu	a2,a5,800052f0 <exec+0x2dc>
    if(ph.vaddr + ph.memsz < ph.vaddr)
    80005362:	e2843783          	ld	a5,-472(s0)
    80005366:	963e                	add	a2,a2,a5
    80005368:	f8f667e3          	bltu	a2,a5,800052f6 <exec+0x2e2>
    if((sz1 = uvmalloc(pagetable, sz, ph.vaddr + ph.memsz)) == 0)
    8000536c:	85ca                	mv	a1,s2
    8000536e:	855e                	mv	a0,s7
    80005370:	ffffc097          	auipc	ra,0xffffc
    80005374:	0b2080e7          	jalr	178(ra) # 80001422 <uvmalloc>
    80005378:	e0a43423          	sd	a0,-504(s0)
    8000537c:	d141                	beqz	a0,800052fc <exec+0x2e8>
    if((ph.vaddr % PGSIZE) != 0)
    8000537e:	e2843d03          	ld	s10,-472(s0)
    80005382:	df043783          	ld	a5,-528(s0)
    80005386:	00fd77b3          	and	a5,s10,a5
    8000538a:	fba1                	bnez	a5,800052da <exec+0x2c6>
    if(loadseg(pagetable, ph.vaddr, ip, ph.off, ph.filesz) < 0)
    8000538c:	e2042d83          	lw	s11,-480(s0)
    80005390:	e3842c03          	lw	s8,-456(s0)
  for(i = 0; i < sz; i += PGSIZE){
    80005394:	f80c03e3          	beqz	s8,8000531a <exec+0x306>
    80005398:	8a62                	mv	s4,s8
    8000539a:	4901                	li	s2,0
    8000539c:	b345                	j	8000513c <exec+0x128>

000000008000539e <argfd>:
...
argfd(int n, int *pfd, struct file **pf)
{
    ...
    800053a6:	e84a                	sd	s2,16(sp)
    800053a8:	1800                	addi	s0,sp,48
    800053aa:	892e                	mv	s2,a1
    800053ac:	84b2                	mv	s1,a2
  int fd;
  struct file *f;

  if(argint(n, &fd) < 0)
    800053ae:	fdc40593          	addi	a1,s0,-36
    800053b2:	ffffe097          	auipc	ra,0xffffe
    800053b6:	a28080e7          	jalr	-1496(ra) # 80002dda <argint>
    800053ba:	04054063          	bltz	a0,800053fa <argfd+0x5c>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    800053be:	fdc42703          	lw	a4,-36(s0)
    800053c2:	47bd                	li	a5,15
    800053c4:	02e7ed63          	bltu	a5,a4,800053fe <argfd+0x60>
    800053c8:	ffffc097          	auipc	ra,0xffffc
    800053cc:	5e8080e7          	jalr	1512(ra) # 800019b0 <myproc>
    800053d0:	fdc42703          	lw	a4,-36(s0)
    800053d4:	01a70793          	addi	a5,a4,26
    800053d8:	078e                	slli	a5,a5,0x3
    800053da:	953e                	add	a0,a0,a5
    800053dc:	611c                	ld	a5,0(a0)
    800053de:	c395                	beqz	a5,80005402 <argfd+0x64>
    return -1;
  if(pfd)
    800053e0:	00090463          	beqz	s2,800053e8 <argfd+0x4a>
    *pfd = fd;
  ...
  if(pf)
    800053ea:	c091                	beqz	s1,800053ee <argfd+0x50>
    *pf = f;
    ...
    800053fc:	bfcd                	j	800053ee <argfd+0x50>
    return -1;
    800053fe:	557d                	li	a0,-1
    80005400:	b7fd                	j	800053ee <argfd+0x50>
    80005402:	557d                	li	a0,-1
    80005404:	b7ed                	j	800053ee <argfd+0x50>
...
fdalloc(struct file *f)
{
  ...
  struct proc *p = myproc();
    ...
    80005416:	59e080e7          	jalr	1438(ra) # 800019b0 <myproc>
    8000541a:	862a                	mv	a2,a0

  for(fd = 0; fd < NOFILE; fd++){
    8000541c:	0d050793          	addi	a5,a0,208 # fffffffffffff0d0 <end+0xffffffff7ffd80d0>
...
create(char *path, short type, short major, short minor)
{
    ...
    8000545a:	89ae                	mv	s3,a1
    8000545c:	8ab2                	mv	s5,a2
    8000545e:	8a36                	mv	s4,a3
  struct inode *ip, *dp;
  char name[DIRSIZ];
  ...
  if((dp = nameiparent(path, name)) == 0)
    ...
    80005468:	e86080e7          	jalr	-378(ra) # 800042ea <nameiparent>
    8000546c:	892a                	mv	s2,a0
    8000546e:	12050f63          	beqz	a0,800055ac <create+0x164>
    return 0;

  ilock(dp);
    80005472:	ffffe097          	auipc	ra,0xffffe
    80005476:	6a4080e7          	jalr	1700(ra) # 80003b16 <ilock>
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    80005486:	b78080e7          	jalr	-1160(ra) # 80003ffa <dirlookup>
    8000548a:	84aa                	mv	s1,a0
    8000548c:	c921                	beqz	a0,800054dc <create+0x94>
    iunlockput(dp);
    8000548e:	854a                	mv	a0,s2
    80005490:	fffff097          	auipc	ra,0xfffff
    80005494:	8e8080e7          	jalr	-1816(ra) # 80003d78 <iunlockput>
    ilock(ip);
    80005498:	8526                	mv	a0,s1
    8000549a:	ffffe097          	auipc	ra,0xffffe
    8000549e:	67c080e7          	jalr	1660(ra) # 80003b16 <ilock>
    if(type == T_FILE && (ip->type == T_FILE || ip->type == T_DEVICE))
    800054a2:	2981                	sext.w	s3,s3
    800054a4:	4789                	li	a5,2
    800054a6:	02f99463          	bne	s3,a5,800054ce <create+0x86>
    800054aa:	0444d783          	lhu	a5,68(s1)
    800054ae:	37f9                	addiw	a5,a5,-2
    800054b0:	17c2                	slli	a5,a5,0x30
    800054b2:	93c1                	srli	a5,a5,0x30
    800054b4:	4705                	li	a4,1
    800054b6:	00f76c63          	bltu	a4,a5,800054ce <create+0x86>
  ...
  return ip;
    ...
    800054d4:	8a8080e7          	jalr	-1880(ra) # 80003d78 <iunlockput>
    return 0;
    800054d8:	4481                	li	s1,0
    800054da:	b7c5                	j	800054ba <create+0x72>
  if((ip = ialloc(dp->dev, type)) == 0)
    800054dc:	85ce                	mv	a1,s3
    800054de:	00092503          	lw	a0,0(s2)
    800054e2:	ffffe097          	auipc	ra,0xffffe
    800054e6:	49c080e7          	jalr	1180(ra) # 8000397e <ialloc>
    800054ea:	84aa                	mv	s1,a0
    800054ec:	c529                	beqz	a0,80005536 <create+0xee>
  ilock(ip);
    800054ee:	ffffe097          	auipc	ra,0xffffe
    800054f2:	628080e7          	jalr	1576(ra) # 80003b16 <ilock>
  ip->major = major;
    800054f6:	05549323          	sh	s5,70(s1)
  ip->minor = minor;
    800054fa:	05449423          	sh	s4,72(s1)
  ip->nlink = 1;
  ...
  iupdate(ip);
    ...
    8000550a:	546080e7          	jalr	1350(ra) # 80003a4c <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
    8000550e:	2981                	sext.w	s3,s3
    80005510:	4785                	li	a5,1
    80005512:	02f98a63          	beq	s3,a5,80005546 <create+0xfe>
  if(dirlink(dp, name, ip->inum) < 0)
    80005516:	40d0                	lw	a2,4(s1)
    80005518:	fb040593          	addi	a1,s0,-80
    8000551c:	854a                	mv	a0,s2
    8000551e:	fffff097          	auipc	ra,0xfffff
    80005522:	cec080e7          	jalr	-788(ra) # 8000420a <dirlink>
    80005526:	06054b63          	bltz	a0,8000559c <create+0x154>
  iunlockput(dp);
    8000552a:	854a                	mv	a0,s2
    8000552c:	fffff097          	auipc	ra,0xfffff
    80005530:	84c080e7          	jalr	-1972(ra) # 80003d78 <iunlockput>
  return ip;
    80005534:	b759                	j	800054ba <create+0x72>
    panic("create: ialloc");
    80005536:	00003517          	auipc	a0,0x3
    8000553a:	25a50513          	addi	a0,a0,602 # 80008790 <syscall_argc+0x250>
    ...
    80005556:	4fa080e7          	jalr	1274(ra) # 80003a4c <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
    8000555a:	40d0                	lw	a2,4(s1)
    8000555c:	00003597          	auipc	a1,0x3
    80005560:	24458593          	addi	a1,a1,580 # 800087a0 <syscall_argc+0x260>
    80005564:	8526                	mv	a0,s1
    80005566:	fffff097          	auipc	ra,0xfffff
    8000556a:	ca4080e7          	jalr	-860(ra) # 8000420a <dirlink>
    8000556e:	00054f63          	bltz	a0,8000558c <create+0x144>
    80005572:	00492603          	lw	a2,4(s2)
    80005576:	00003597          	auipc	a1,0x3
    8000557a:	23258593          	addi	a1,a1,562 # 800087a8 <syscall_argc+0x268>
    8000557e:	8526                	mv	a0,s1
    80005580:	fffff097          	auipc	ra,0xfffff
    80005584:	c8a080e7          	jalr	-886(ra) # 8000420a <dirlink>
    80005588:	f80557e3          	bgez	a0,80005516 <create+0xce>
      panic("create dots");
    8000558c:	00003517          	auipc	a0,0x3
    80005590:	22450513          	addi	a0,a0,548 # 800087b0 <syscall_argc+0x270>
    80005594:	ffffb097          	auipc	ra,0xffffb
    80005598:	faa080e7          	jalr	-86(ra) # 8000053e <panic>
    panic("create: dirlink");
    8000559c:	00003517          	auipc	a0,0x3
    800055a0:	22450513          	addi	a0,a0,548 # 800087c0 <syscall_argc+0x280>
    800055a4:	ffffb097          	auipc	ra,0xffffb
    800055a8:	f9a080e7          	jalr	-102(ra) # 8000053e <panic>
    return 0;
    800055ac:	84aa                	mv	s1,a0
    800055ae:	b731                	j	800054ba <create+0x72>
...
00000000800055b0 <sys_dup>:
{
  ...
  if(argfd(0, 0, &f) < 0)
    ...
    800055c6:	ddc080e7          	jalr	-548(ra) # 8000539e <argfd>
    return -1;
  ...
  if((fd=fdalloc(f)) < 0)
    ...
    800055d8:	e32080e7          	jalr	-462(ra) # 80005406 <fdalloc>
  ...
  filedup(f);
    ...
    800055ec:	37a080e7          	jalr	890(ra) # 80004962 <filedup>
  return fd;
...
00000000800055fe <sys_read>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    80005612:	d90080e7          	jalr	-624(ra) # 8000539e <argfd>
    return -1;
    80005616:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    80005618:	04054163          	bltz	a0,8000565a <sys_read+0x5c>
    8000561c:	fe440593          	addi	a1,s0,-28
    80005620:	4509                	li	a0,2
    80005622:	ffffd097          	auipc	ra,0xffffd
    80005626:	7b8080e7          	jalr	1976(ra) # 80002dda <argint>
    return -1;
    8000562a:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    8000562c:	02054763          	bltz	a0,8000565a <sys_read+0x5c>
    80005630:	fd840593          	addi	a1,s0,-40
    80005634:	4505                	li	a0,1
    80005636:	ffffd097          	auipc	ra,0xffffd
    8000563a:	7c6080e7          	jalr	1990(ra) # 80002dfc <argaddr>
    return -1;
    8000563e:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    80005640:	00054d63          	bltz	a0,8000565a <sys_read+0x5c>
  return fileread(f, p, n);
    ...
    80005654:	49e080e7          	jalr	1182(ra) # 80004aee <fileread>
...
0000000080005664 <sys_write>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    80005678:	d2a080e7          	jalr	-726(ra) # 8000539e <argfd>
    return -1;
    8000567c:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    8000567e:	04054163          	bltz	a0,800056c0 <sys_write+0x5c>
    80005682:	fe440593          	addi	a1,s0,-28
    80005686:	4509                	li	a0,2
    80005688:	ffffd097          	auipc	ra,0xffffd
    8000568c:	752080e7          	jalr	1874(ra) # 80002dda <argint>
    return -1;
    80005690:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    80005692:	02054763          	bltz	a0,800056c0 <sys_write+0x5c>
    80005696:	fd840593          	addi	a1,s0,-40
    8000569a:	4505                	li	a0,1
    8000569c:	ffffd097          	auipc	ra,0xffffd
    800056a0:	760080e7          	jalr	1888(ra) # 80002dfc <argaddr>
    return -1;
    800056a4:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    800056a6:	00054d63          	bltz	a0,800056c0 <sys_write+0x5c>
  return filewrite(f, p, n);
    ...
    800056ba:	4fa080e7          	jalr	1274(ra) # 80004bb0 <filewrite>
...
00000000800056ca <sys_close>:
{
  ...
  if(argfd(0, &fd, &f) < 0)
    800056d2:	fe040613          	addi	a2,s0,-32
    800056d6:	fec40593          	addi	a1,s0,-20
    800056da:	4501                	li	a0,0
    800056dc:	00000097          	auipc	ra,0x0
    800056e0:	cc2080e7          	jalr	-830(ra) # 8000539e <argfd>
    return -1;
    800056e4:	57fd                	li	a5,-1
  if(argfd(0, &fd, &f) < 0)
    800056e6:	02054463          	bltz	a0,8000570e <sys_close+0x44>
  myproc()->ofile[fd] = 0;
    800056ea:	ffffc097          	auipc	ra,0xffffc
    800056ee:	2c6080e7          	jalr	710(ra) # 800019b0 <myproc>
    800056f2:	fec42783          	lw	a5,-20(s0)
    800056f6:	07e9                	addi	a5,a5,26
    800056f8:	078e                	slli	a5,a5,0x3
    800056fa:	97aa                	add	a5,a5,a0
    800056fc:	0007b023          	sd	zero,0(a5)
  fileclose(f);
    80005700:	fe043503          	ld	a0,-32(s0)
    80005704:	fffff097          	auipc	ra,0xfffff
    80005708:	2b0080e7          	jalr	688(ra) # 800049b4 <fileclose>
  return 0;
...
0000000080005718 <sys_fstat>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    ...
    8000572c:	c76080e7          	jalr	-906(ra) # 8000539e <argfd>
    return -1;
    80005730:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    80005732:	02054563          	bltz	a0,8000575c <sys_fstat+0x44>
    80005736:	fe040593          	addi	a1,s0,-32
    8000573a:	4505                	li	a0,1
    8000573c:	ffffd097          	auipc	ra,0xffffd
    80005740:	6c0080e7          	jalr	1728(ra) # 80002dfc <argaddr>
    return -1;
    80005744:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    80005746:	00054b63          	bltz	a0,8000575c <sys_fstat+0x44>
  return filestat(f, st);
    8000574a:	fe043583          	ld	a1,-32(s0)
    8000574e:	fe843503          	ld	a0,-24(s0)
    80005752:	fffff097          	auipc	ra,0xfffff
    80005756:	32a080e7          	jalr	810(ra) # 80004a7c <filestat>
...
0000000080005766 <sys_link>:
{
    80005766:	7169                	addi	sp,sp,-304
    80005768:	f606                	sd	ra,296(sp)
    8000576a:	f222                	sd	s0,288(sp)
    8000576c:	ee26                	sd	s1,280(sp)
    8000576e:	ea4a                	sd	s2,272(sp)
    80005770:	1a00                	addi	s0,sp,304
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    80005772:	08000613          	li	a2,128
    80005776:	ed040593          	addi	a1,s0,-304
    8000577a:	4501                	li	a0,0
    8000577c:	ffffd097          	auipc	ra,0xffffd
    80005780:	6a2080e7          	jalr	1698(ra) # 80002e1e <argstr>
    return -1;
    80005784:	57fd                	li	a5,-1
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    80005786:	10054e63          	bltz	a0,800058a2 <sys_link+0x13c>
    8000578a:	08000613          	li	a2,128
    8000578e:	f5040593          	addi	a1,s0,-176
    80005792:	4505                	li	a0,1
    80005794:	ffffd097          	auipc	ra,0xffffd
    80005798:	68a080e7          	jalr	1674(ra) # 80002e1e <argstr>
    return -1;
    8000579c:	57fd                	li	a5,-1
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    8000579e:	10054263          	bltz	a0,800058a2 <sys_link+0x13c>
  begin_op();
    800057a2:	fffff097          	auipc	ra,0xfffff
    800057a6:	d46080e7          	jalr	-698(ra) # 800044e8 <begin_op>
  if((ip = namei(old)) == 0){
    800057aa:	ed040513          	addi	a0,s0,-304
    800057ae:	fffff097          	auipc	ra,0xfffff
    800057b2:	b1e080e7          	jalr	-1250(ra) # 800042cc <namei>
    800057b6:	84aa                	mv	s1,a0
    800057b8:	c551                	beqz	a0,80005844 <sys_link+0xde>
  ilock(ip);
    800057ba:	ffffe097          	auipc	ra,0xffffe
    800057be:	35c080e7          	jalr	860(ra) # 80003b16 <ilock>
  if(ip->type == T_DIR){
    800057c2:	04449703          	lh	a4,68(s1)
    800057c6:	4785                	li	a5,1
    800057c8:	08f70463          	beq	a4,a5,80005850 <sys_link+0xea>
  ip->nlink++;
  ...
  iupdate(ip);
    ...
    800057dc:	274080e7          	jalr	628(ra) # 80003a4c <iupdate>
  iunlock(ip);
    800057e0:	8526                	mv	a0,s1
    800057e2:	ffffe097          	auipc	ra,0xffffe
    800057e6:	3f6080e7          	jalr	1014(ra) # 80003bd8 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
    800057ea:	fd040593          	addi	a1,s0,-48
    800057ee:	f5040513          	addi	a0,s0,-176
    800057f2:	fffff097          	auipc	ra,0xfffff
    800057f6:	af8080e7          	jalr	-1288(ra) # 800042ea <nameiparent>
    800057fa:	892a                	mv	s2,a0
    800057fc:	c935                	beqz	a0,80005870 <sys_link+0x10a>
  ilock(dp);
    800057fe:	ffffe097          	auipc	ra,0xffffe
    80005802:	318080e7          	jalr	792(ra) # 80003b16 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
    80005806:	00092703          	lw	a4,0(s2)
    8000580a:	409c                	lw	a5,0(s1)
    8000580c:	04f71d63          	bne	a4,a5,80005866 <sys_link+0x100>
    80005810:	40d0                	lw	a2,4(s1)
    80005812:	fd040593          	addi	a1,s0,-48
    80005816:	854a                	mv	a0,s2
    80005818:	fffff097          	auipc	ra,0xfffff
    8000581c:	9f2080e7          	jalr	-1550(ra) # 8000420a <dirlink>
    80005820:	04054363          	bltz	a0,80005866 <sys_link+0x100>
  iunlockput(dp);
    80005824:	854a                	mv	a0,s2
    80005826:	ffffe097          	auipc	ra,0xffffe
    8000582a:	552080e7          	jalr	1362(ra) # 80003d78 <iunlockput>
  iput(ip);
    8000582e:	8526                	mv	a0,s1
    80005830:	ffffe097          	auipc	ra,0xffffe
    80005834:	4a0080e7          	jalr	1184(ra) # 80003cd0 <iput>
  end_op();
    80005838:	fffff097          	auipc	ra,0xfffff
    8000583c:	d30080e7          	jalr	-720(ra) # 80004568 <end_op>
  return 0;
    80005840:	4781                	li	a5,0
    80005842:	a085                	j	800058a2 <sys_link+0x13c>
    end_op();
    80005844:	fffff097          	auipc	ra,0xfffff
    80005848:	d24080e7          	jalr	-732(ra) # 80004568 <end_op>
    return -1;
    8000584c:	57fd                	li	a5,-1
    8000584e:	a891                	j	800058a2 <sys_link+0x13c>
    iunlockput(ip);
    80005850:	8526                	mv	a0,s1
    80005852:	ffffe097          	auipc	ra,0xffffe
    80005856:	526080e7          	jalr	1318(ra) # 80003d78 <iunlockput>
    end_op();
    8000585a:	fffff097          	auipc	ra,0xfffff
    8000585e:	d0e080e7          	jalr	-754(ra) # 80004568 <end_op>
    return -1;
    80005862:	57fd                	li	a5,-1
    80005864:	a83d                	j	800058a2 <sys_link+0x13c>
    iunlockput(dp);
    80005866:	854a                	mv	a0,s2
    80005868:	ffffe097          	auipc	ra,0xffffe
    8000586c:	510080e7          	jalr	1296(ra) # 80003d78 <iunlockput>
  ilock(ip);
    80005870:	8526                	mv	a0,s1
    80005872:	ffffe097          	auipc	ra,0xffffe
    80005876:	2a4080e7          	jalr	676(ra) # 80003b16 <ilock>
  ip->nlink--;
  ...
  iupdate(ip);
    ...
    8000588a:	1c6080e7          	jalr	454(ra) # 80003a4c <iupdate>
  iunlockput(ip);
    8000588e:	8526                	mv	a0,s1
    80005890:	ffffe097          	auipc	ra,0xffffe
    80005894:	4e8080e7          	jalr	1256(ra) # 80003d78 <iunlockput>
  end_op();
    80005898:	fffff097          	auipc	ra,0xfffff
    8000589c:	cd0080e7          	jalr	-816(ra) # 80004568 <end_op>
  return -1;
    800058a0:	57fd                	li	a5,-1
}
    800058a2:	853e                	mv	a0,a5
    800058a4:	70b2                	ld	ra,296(sp)
    800058a6:	7412                	ld	s0,288(sp)
    800058a8:	64f2                	ld	s1,280(sp)
    800058aa:	6952                	ld	s2,272(sp)
    800058ac:	6155                	addi	sp,sp,304
    800058ae:	8082                	ret

00000000800058b0 <sys_unlink>:
{
    800058b0:	7151                	addi	sp,sp,-240
    800058b2:	f586                	sd	ra,232(sp)
    800058b4:	f1a2                	sd	s0,224(sp)
    800058b6:	eda6                	sd	s1,216(sp)
    800058b8:	e9ca                	sd	s2,208(sp)
    800058ba:	e5ce                	sd	s3,200(sp)
    800058bc:	1980                	addi	s0,sp,240
  if(argstr(0, path, MAXPATH) < 0)
    800058be:	08000613          	li	a2,128
    800058c2:	f3040593          	addi	a1,s0,-208
    800058c6:	4501                	li	a0,0
    800058c8:	ffffd097          	auipc	ra,0xffffd
    800058cc:	556080e7          	jalr	1366(ra) # 80002e1e <argstr>
    800058d0:	18054163          	bltz	a0,80005a52 <sys_unlink+0x1a2>
  begin_op();
    800058d4:	fffff097          	auipc	ra,0xfffff
    800058d8:	c14080e7          	jalr	-1004(ra) # 800044e8 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
    800058dc:	fb040593          	addi	a1,s0,-80
    800058e0:	f3040513          	addi	a0,s0,-208
    800058e4:	fffff097          	auipc	ra,0xfffff
    800058e8:	a06080e7          	jalr	-1530(ra) # 800042ea <nameiparent>
    800058ec:	84aa                	mv	s1,a0
    800058ee:	c979                	beqz	a0,800059c4 <sys_unlink+0x114>
  ilock(dp);
    800058f0:	ffffe097          	auipc	ra,0xffffe
    800058f4:	226080e7          	jalr	550(ra) # 80003b16 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    800058f8:	00003597          	auipc	a1,0x3
    800058fc:	ea858593          	addi	a1,a1,-344 # 800087a0 <syscall_argc+0x260>
    80005900:	fb040513          	addi	a0,s0,-80
    80005904:	ffffe097          	auipc	ra,0xffffe
    80005908:	6dc080e7          	jalr	1756(ra) # 80003fe0 <namecmp>
    8000590c:	14050a63          	beqz	a0,80005a60 <sys_unlink+0x1b0>
    80005910:	00003597          	auipc	a1,0x3
    80005914:	e9858593          	addi	a1,a1,-360 # 800087a8 <syscall_argc+0x268>
    80005918:	fb040513          	addi	a0,s0,-80
    8000591c:	ffffe097          	auipc	ra,0xffffe
    80005920:	6c4080e7          	jalr	1732(ra) # 80003fe0 <namecmp>
    80005924:	12050e63          	beqz	a0,80005a60 <sys_unlink+0x1b0>
  if((ip = dirlookup(dp, name, &off)) == 0)
    80005928:	f2c40613          	addi	a2,s0,-212
    8000592c:	fb040593          	addi	a1,s0,-80
    80005930:	8526                	mv	a0,s1
    80005932:	ffffe097          	auipc	ra,0xffffe
    80005936:	6c8080e7          	jalr	1736(ra) # 80003ffa <dirlookup>
    8000593a:	892a                	mv	s2,a0
    8000593c:	12050263          	beqz	a0,80005a60 <sys_unlink+0x1b0>
  ilock(ip);
    80005940:	ffffe097          	auipc	ra,0xffffe
    80005944:	1d6080e7          	jalr	470(ra) # 80003b16 <ilock>
  if(ip->nlink < 1)
    80005948:	04a91783          	lh	a5,74(s2)
    8000594c:	08f05263          	blez	a5,800059d0 <sys_unlink+0x120>
  if(ip->type == T_DIR && !isdirempty(ip)){
    80005950:	04491703          	lh	a4,68(s2)
    80005954:	4785                	li	a5,1
    80005956:	08f70563          	beq	a4,a5,800059e0 <sys_unlink+0x130>
  memset(&de, 0, sizeof(de));
    8000595a:	4641                	li	a2,16
    8000595c:	4581                	li	a1,0
    8000595e:	fc040513          	addi	a0,s0,-64
    80005962:	ffffb097          	auipc	ra,0xffffb
    80005966:	37e080e7          	jalr	894(ra) # 80000ce0 <memset>
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    8000596a:	4741                	li	a4,16
    8000596c:	f2c42683          	lw	a3,-212(s0)
    80005970:	fc040613          	addi	a2,s0,-64
    80005974:	4581                	li	a1,0
    80005976:	8526                	mv	a0,s1
    80005978:	ffffe097          	auipc	ra,0xffffe
    8000597c:	54a080e7          	jalr	1354(ra) # 80003ec2 <writei>
    80005980:	47c1                	li	a5,16
    80005982:	0af51563          	bne	a0,a5,80005a2c <sys_unlink+0x17c>
  if(ip->type == T_DIR){
    80005986:	04491703          	lh	a4,68(s2)
    8000598a:	4785                	li	a5,1
    8000598c:	0af70863          	beq	a4,a5,80005a3c <sys_unlink+0x18c>
  iunlockput(dp);
    80005990:	8526                	mv	a0,s1
    80005992:	ffffe097          	auipc	ra,0xffffe
    80005996:	3e6080e7          	jalr	998(ra) # 80003d78 <iunlockput>
  ip->nlink--;
    8000599a:	04a95783          	lhu	a5,74(s2)
    8000599e:	37fd                	addiw	a5,a5,-1
    800059a0:	04f91523          	sh	a5,74(s2)
  iupdate(ip);
    800059a4:	854a                	mv	a0,s2
    800059a6:	ffffe097          	auipc	ra,0xffffe
    800059aa:	0a6080e7          	jalr	166(ra) # 80003a4c <iupdate>
  iunlockput(ip);
    800059ae:	854a                	mv	a0,s2
    800059b0:	ffffe097          	auipc	ra,0xffffe
    800059b4:	3c8080e7          	jalr	968(ra) # 80003d78 <iunlockput>
  end_op();
    800059b8:	fffff097          	auipc	ra,0xfffff
    800059bc:	bb0080e7          	jalr	-1104(ra) # 80004568 <end_op>
  return 0;
    800059c0:	4501                	li	a0,0
    800059c2:	a84d                	j	80005a74 <sys_unlink+0x1c4>
    end_op();
    800059c4:	fffff097          	auipc	ra,0xfffff
    800059c8:	ba4080e7          	jalr	-1116(ra) # 80004568 <end_op>
    return -1;
    800059cc:	557d                	li	a0,-1
    800059ce:	a05d                	j	80005a74 <sys_unlink+0x1c4>
    panic("unlink: nlink < 1");
    800059d0:	00003517          	auipc	a0,0x3
    800059d4:	e0050513          	addi	a0,a0,-512 # 800087d0 <syscall_argc+0x290>
    800059d8:	ffffb097          	auipc	ra,0xffffb
    800059dc:	b66080e7          	jalr	-1178(ra) # 8000053e <panic>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    800059e0:	04c92703          	lw	a4,76(s2)
    800059e4:	02000793          	li	a5,32
    800059e8:	f6e7f9e3          	bgeu	a5,a4,8000595a <sys_unlink+0xaa>
    800059ec:	02000993          	li	s3,32
    if(readi(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80005a00:	3ce080e7          	jalr	974(ra) # 80003dca <readi>
    80005a04:	47c1                	li	a5,16
    80005a06:	00f51b63          	bne	a0,a5,80005a1c <sys_unlink+0x16c>
    if(de.inum != 0)
    80005a0a:	f1845783          	lhu	a5,-232(s0)
    80005a0e:	e7a1                	bnez	a5,80005a56 <sys_unlink+0x1a6>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    80005a10:	29c1                	addiw	s3,s3,16
    80005a12:	04c92783          	lw	a5,76(s2)
    80005a16:	fcf9ede3          	bltu	s3,a5,800059f0 <sys_unlink+0x140>
    80005a1a:	b781                	j	8000595a <sys_unlink+0xaa>
      panic("isdirempty: readi");
    80005a1c:	00003517          	auipc	a0,0x3
    80005a20:	dcc50513          	addi	a0,a0,-564 # 800087e8 <syscall_argc+0x2a8>
    80005a24:	ffffb097          	auipc	ra,0xffffb
    80005a28:	b1a080e7          	jalr	-1254(ra) # 8000053e <panic>
    panic("unlink: writei");
    80005a2c:	00003517          	auipc	a0,0x3
    80005a30:	dd450513          	addi	a0,a0,-556 # 80008800 <syscall_argc+0x2c0>
    80005a34:	ffffb097          	auipc	ra,0xffffb
    80005a38:	b0a080e7          	jalr	-1270(ra) # 8000053e <panic>
    dp->nlink--;
    80005a3c:	04a4d783          	lhu	a5,74(s1)
    80005a40:	37fd                	addiw	a5,a5,-1
    80005a42:	04f49523          	sh	a5,74(s1)
    iupdate(dp);
    80005a46:	8526                	mv	a0,s1
    80005a48:	ffffe097          	auipc	ra,0xffffe
    80005a4c:	004080e7          	jalr	4(ra) # 80003a4c <iupdate>
    80005a50:	b781                	j	80005990 <sys_unlink+0xe0>
    return -1;
    80005a52:	557d                	li	a0,-1
    80005a54:	a005                	j	80005a74 <sys_unlink+0x1c4>
    iunlockput(ip);
    80005a56:	854a                	mv	a0,s2
    80005a58:	ffffe097          	auipc	ra,0xffffe
    80005a5c:	320080e7          	jalr	800(ra) # 80003d78 <iunlockput>
  iunlockput(dp);
    80005a60:	8526                	mv	a0,s1
    80005a62:	ffffe097          	auipc	ra,0xffffe
    80005a66:	316080e7          	jalr	790(ra) # 80003d78 <iunlockput>
  end_op();
    80005a6a:	fffff097          	auipc	ra,0xfffff
    80005a6e:	afe080e7          	jalr	-1282(ra) # 80004568 <end_op>
  return -1;
...
sys_open(void)
{
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    ...
    80005a9e:	384080e7          	jalr	900(ra) # 80002e1e <argstr>
    return -1;
    80005aa2:	54fd                	li	s1,-1
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    80005aa4:	0c054163          	bltz	a0,80005b66 <sys_open+0xe4>
    80005aa8:	f4c40593          	addi	a1,s0,-180
    80005aac:	4505                	li	a0,1
    80005aae:	ffffd097          	auipc	ra,0xffffd
    80005ab2:	32c080e7          	jalr	812(ra) # 80002dda <argint>
    80005ab6:	0a054863          	bltz	a0,80005b66 <sys_open+0xe4>

  begin_op();
    80005aba:	fffff097          	auipc	ra,0xfffff
    80005abe:	a2e080e7          	jalr	-1490(ra) # 800044e8 <begin_op>

  if(omode & O_CREATE){
    80005ac2:	f4c42783          	lw	a5,-180(s0)
    80005ac6:	2007f793          	andi	a5,a5,512
    80005aca:	cbdd                	beqz	a5,80005b80 <sys_open+0xfe>
    ...
    if(ip == 0){
    80005ae0:	c959                	beqz	a0,80005b76 <sys_open+0xf4>
      end_op();
      return -1;
    }
  }
  ...
  if(ip->type == T_DEVICE && (ip->major < 0 || ip->major >= NDEV)){
    ...
    80005ae8:	00f71763          	bne	a4,a5,80005af6 <sys_open+0x74>
    80005aec:	04695703          	lhu	a4,70(s2)
    80005af0:	47a5                	li	a5,9
    80005af2:	0ce7ec63          	bltu	a5,a4,80005bca <sys_open+0x148>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
    ...
    80005afa:	e02080e7          	jalr	-510(ra) # 800048f8 <filealloc>
    80005afe:	89aa                	mv	s3,a0
    80005b00:	10050263          	beqz	a0,80005c04 <sys_open+0x182>
    80005b04:	00000097          	auipc	ra,0x0
    80005b08:	902080e7          	jalr	-1790(ra) # 80005406 <fdalloc>
    80005b0c:	84aa                	mv	s1,a0
    80005b0e:	0e054663          	bltz	a0,80005bfa <sys_open+0x178>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  if(ip->type == T_DEVICE){
    ...
    80005b18:	0cf70463          	beq	a4,a5,80005be0 <sys_open+0x15e>
    f->type = FD_DEVICE;
    f->major = ip->major;
  } else {
    f->type = FD_INODE;
  ...
  if((omode & O_TRUNC) && ip->type == T_FILE){
    ...
    80005b48:	c791                	beqz	a5,80005b54 <sys_open+0xd2>
    80005b4a:	04491703          	lh	a4,68(s2)
    80005b4e:	4789                	li	a5,2
    80005b50:	08f70f63          	beq	a4,a5,80005bee <sys_open+0x16c>
    itrunc(ip);
  }
  ...
  iunlock(ip);
    ...
    80005b5a:	082080e7          	jalr	130(ra) # 80003bd8 <iunlock>
  end_op();
    80005b5e:	fffff097          	auipc	ra,0xfffff
    80005b62:	a0a080e7          	jalr	-1526(ra) # 80004568 <end_op>
  ...
  return fd;
    ...
    80005b7a:	9f2080e7          	jalr	-1550(ra) # 80004568 <end_op>
      return -1;
    80005b7e:	b7e5                	j	80005b66 <sys_open+0xe4>
    if((ip = namei(path)) == 0){
    80005b80:	f5040513          	addi	a0,s0,-176
    80005b84:	ffffe097          	auipc	ra,0xffffe
    80005b88:	748080e7          	jalr	1864(ra) # 800042cc <namei>
    80005b8c:	892a                	mv	s2,a0
    80005b8e:	c905                	beqz	a0,80005bbe <sys_open+0x13c>
    ilock(ip);
    80005b90:	ffffe097          	auipc	ra,0xffffe
    80005b94:	f86080e7          	jalr	-122(ra) # 80003b16 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
    80005b98:	04491703          	lh	a4,68(s2)
    80005b9c:	4785                	li	a5,1
    80005b9e:	f4f712e3          	bne	a4,a5,80005ae2 <sys_open+0x60>
    80005ba2:	f4c42783          	lw	a5,-180(s0)
    80005ba6:	dba1                	beqz	a5,80005af6 <sys_open+0x74>
      iunlockput(ip);
    80005ba8:	854a                	mv	a0,s2
    80005baa:	ffffe097          	auipc	ra,0xffffe
    80005bae:	1ce080e7          	jalr	462(ra) # 80003d78 <iunlockput>
      end_op();
    80005bb2:	fffff097          	auipc	ra,0xfffff
    80005bb6:	9b6080e7          	jalr	-1610(ra) # 80004568 <end_op>
      return -1;
    80005bba:	54fd                	li	s1,-1
    80005bbc:	b76d                	j	80005b66 <sys_open+0xe4>
      end_op();
    80005bbe:	fffff097          	auipc	ra,0xfffff
    80005bc2:	9aa080e7          	jalr	-1622(ra) # 80004568 <end_op>
      return -1;
    80005bc6:	54fd                	li	s1,-1
    80005bc8:	bf79                	j	80005b66 <sys_open+0xe4>
    iunlockput(ip);
    80005bca:	854a                	mv	a0,s2
    80005bcc:	ffffe097          	auipc	ra,0xffffe
    80005bd0:	1ac080e7          	jalr	428(ra) # 80003d78 <iunlockput>
    end_op();
    80005bd4:	fffff097          	auipc	ra,0xfffff
    80005bd8:	994080e7          	jalr	-1644(ra) # 80004568 <end_op>
    return -1;
    80005bdc:	54fd                	li	s1,-1
    80005bde:	b761                	j	80005b66 <sys_open+0xe4>
    f->type = FD_DEVICE;
    80005be0:	00f9a023          	sw	a5,0(s3)
    f->major = ip->major;
    80005be4:	04691783          	lh	a5,70(s2)
    80005be8:	02f99223          	sh	a5,36(s3)
    80005bec:	bf2d                	j	80005b26 <sys_open+0xa4>
    itrunc(ip);
    80005bee:	854a                	mv	a0,s2
    80005bf0:	ffffe097          	auipc	ra,0xffffe
    80005bf4:	034080e7          	jalr	52(ra) # 80003c24 <itrunc>
    80005bf8:	bfb1                	j	80005b54 <sys_open+0xd2>
      fileclose(f);
    80005bfa:	854e                	mv	a0,s3
    80005bfc:	fffff097          	auipc	ra,0xfffff
    80005c00:	db8080e7          	jalr	-584(ra) # 800049b4 <fileclose>
    iunlockput(ip);
    80005c04:	854a                	mv	a0,s2
    80005c06:	ffffe097          	auipc	ra,0xffffe
    80005c0a:	172080e7          	jalr	370(ra) # 80003d78 <iunlockput>
    end_op();
    80005c0e:	fffff097          	auipc	ra,0xfffff
    80005c12:	95a080e7          	jalr	-1702(ra) # 80004568 <end_op>
    return -1;
    80005c16:	54fd                	li	s1,-1
    80005c18:	b7b9                	j	80005b66 <sys_open+0xe4>

0000000080005c1a <sys_mkdir>:

uint64
sys_mkdir(void)
{
    80005c1a:	7175                	addi	sp,sp,-144
    80005c1c:	e506                	sd	ra,136(sp)
    80005c1e:	e122                	sd	s0,128(sp)
    80005c20:	0900                	addi	s0,sp,144
  char path[MAXPATH];
  struct inode *ip;

  begin_op();
    80005c22:	fffff097          	auipc	ra,0xfffff
    80005c26:	8c6080e7          	jalr	-1850(ra) # 800044e8 <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    80005c2a:	08000613          	li	a2,128
    80005c2e:	f7040593          	addi	a1,s0,-144
    80005c32:	4501                	li	a0,0
    80005c34:	ffffd097          	auipc	ra,0xffffd
    80005c38:	1ea080e7          	jalr	490(ra) # 80002e1e <argstr>
    80005c3c:	02054963          	bltz	a0,80005c6e <sys_mkdir+0x54>
    80005c40:	4681                	li	a3,0
    80005c42:	4601                	li	a2,0
    80005c44:	4585                	li	a1,1
    80005c46:	f7040513          	addi	a0,s0,-144
    80005c4a:	fffff097          	auipc	ra,0xfffff
    80005c4e:	7fe080e7          	jalr	2046(ra) # 80005448 <create>
    80005c52:	cd11                	beqz	a0,80005c6e <sys_mkdir+0x54>
    end_op();
    return -1;
  }
  iunlockput(ip);
    80005c54:	ffffe097          	auipc	ra,0xffffe
    80005c58:	124080e7          	jalr	292(ra) # 80003d78 <iunlockput>
  end_op();
    80005c5c:	fffff097          	auipc	ra,0xfffff
    80005c60:	90c080e7          	jalr	-1780(ra) # 80004568 <end_op>
  return 0;
    80005c64:	4501                	li	a0,0
}
    80005c66:	60aa                	ld	ra,136(sp)
    80005c68:	640a                	ld	s0,128(sp)
    80005c6a:	6149                	addi	sp,sp,144
    80005c6c:	8082                	ret
    end_op();
    80005c6e:	fffff097          	auipc	ra,0xfffff
    80005c72:	8fa080e7          	jalr	-1798(ra) # 80004568 <end_op>
    return -1;
    80005c76:	557d                	li	a0,-1
    80005c78:	b7fd                	j	80005c66 <sys_mkdir+0x4c>

0000000080005c7a <sys_mknod>:

uint64
sys_mknod(void)
{
    80005c7a:	7135                	addi	sp,sp,-160
    80005c7c:	ed06                	sd	ra,152(sp)
    80005c7e:	e922                	sd	s0,144(sp)
  ...
  begin_op();
    ...
    80005c86:	866080e7          	jalr	-1946(ra) # 800044e8 <begin_op>
  if((argstr(0, path, MAXPATH)) < 0 ||
    80005c8a:	08000613          	li	a2,128
    80005c8e:	f7040593          	addi	a1,s0,-144
    80005c92:	4501                	li	a0,0
    80005c94:	ffffd097          	auipc	ra,0xffffd
    80005c98:	18a080e7          	jalr	394(ra) # 80002e1e <argstr>
    80005c9c:	04054a63          	bltz	a0,80005cf0 <sys_mknod+0x76>
     argint(1, &major) < 0 ||
    80005ca0:	f6c40593          	addi	a1,s0,-148
    80005ca4:	4505                	li	a0,1
    80005ca6:	ffffd097          	auipc	ra,0xffffd
    80005caa:	134080e7          	jalr	308(ra) # 80002dda <argint>
  if((argstr(0, path, MAXPATH)) < 0 ||
    80005cae:	04054163          	bltz	a0,80005cf0 <sys_mknod+0x76>
     argint(2, &minor) < 0 ||
    80005cb2:	f6840593          	addi	a1,s0,-152
    80005cb6:	4509                	li	a0,2
    80005cb8:	ffffd097          	auipc	ra,0xffffd
    80005cbc:	122080e7          	jalr	290(ra) # 80002dda <argint>
     argint(1, &major) < 0 ||
    80005cc0:	02054863          	bltz	a0,80005cf0 <sys_mknod+0x76>
     (ip = create(path, T_DEVICE, major, minor)) == 0){
    80005cc4:	f6841683          	lh	a3,-152(s0)
    80005cc8:	f6c41603          	lh	a2,-148(s0)
    80005ccc:	458d                	li	a1,3
    80005cce:	f7040513          	addi	a0,s0,-144
    80005cd2:	fffff097          	auipc	ra,0xfffff
    80005cd6:	776080e7          	jalr	1910(ra) # 80005448 <create>
     argint(2, &minor) < 0 ||
    80005cda:	c919                	beqz	a0,80005cf0 <sys_mknod+0x76>
    end_op();
    return -1;
  }
  iunlockput(ip);
    80005cdc:	ffffe097          	auipc	ra,0xffffe
    80005ce0:	09c080e7          	jalr	156(ra) # 80003d78 <iunlockput>
  end_op();
    80005ce4:	fffff097          	auipc	ra,0xfffff
    80005ce8:	884080e7          	jalr	-1916(ra) # 80004568 <end_op>
  return 0;
    80005cec:	4501                	li	a0,0
    80005cee:	a031                	j	80005cfa <sys_mknod+0x80>
    end_op();
    80005cf0:	fffff097          	auipc	ra,0xfffff
    80005cf4:	878080e7          	jalr	-1928(ra) # 80004568 <end_op>
    return -1;
    80005cf8:	557d                	li	a0,-1
}
    80005cfa:	60ea                	ld	ra,152(sp)
    80005cfc:	644a                	ld	s0,144(sp)
    80005cfe:	610d                	addi	sp,sp,160
    80005d00:	8082                	ret

0000000080005d02 <sys_chdir>:
...
sys_chdir(void)
{
    ...
    80005d08:	e526                	sd	s1,136(sp)
    80005d0a:	e14a                	sd	s2,128(sp)
    80005d0c:	1100                	addi	s0,sp,160
  char path[MAXPATH];
  struct inode *ip;
  struct proc *p = myproc();
    80005d0e:	ffffc097          	auipc	ra,0xffffc
    80005d12:	ca2080e7          	jalr	-862(ra) # 800019b0 <myproc>
    80005d16:	892a                	mv	s2,a0
  
  begin_op();
    80005d18:	ffffe097          	auipc	ra,0xffffe
    80005d1c:	7d0080e7          	jalr	2000(ra) # 800044e8 <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    80005d20:	08000613          	li	a2,128
    80005d24:	f6040593          	addi	a1,s0,-160
    80005d28:	4501                	li	a0,0
    80005d2a:	ffffd097          	auipc	ra,0xffffd
    80005d2e:	0f4080e7          	jalr	244(ra) # 80002e1e <argstr>
    80005d32:	04054b63          	bltz	a0,80005d88 <sys_chdir+0x86>
    80005d36:	f6040513          	addi	a0,s0,-160
    80005d3a:	ffffe097          	auipc	ra,0xffffe
    80005d3e:	592080e7          	jalr	1426(ra) # 800042cc <namei>
    80005d42:	84aa                	mv	s1,a0
    80005d44:	c131                	beqz	a0,80005d88 <sys_chdir+0x86>
    end_op();
    return -1;
  }
  ilock(ip);
    80005d46:	ffffe097          	auipc	ra,0xffffe
    80005d4a:	dd0080e7          	jalr	-560(ra) # 80003b16 <ilock>
  if(ip->type != T_DIR){
    80005d4e:	04449703          	lh	a4,68(s1)
    80005d52:	4785                	li	a5,1
    80005d54:	04f71063          	bne	a4,a5,80005d94 <sys_chdir+0x92>
    iunlockput(ip);
    end_op();
    return -1;
  }
  iunlock(ip);
    ...
    80005d5e:	e7e080e7          	jalr	-386(ra) # 80003bd8 <iunlock>
  iput(p->cwd);
    80005d62:	15093503          	ld	a0,336(s2)
    80005d66:	ffffe097          	auipc	ra,0xffffe
    80005d6a:	f6a080e7          	jalr	-150(ra) # 80003cd0 <iput>
  end_op();
    80005d6e:	ffffe097          	auipc	ra,0xffffe
    80005d72:	7fa080e7          	jalr	2042(ra) # 80004568 <end_op>
  p->cwd = ip;
    80005d76:	14993823          	sd	s1,336(s2)
  return 0;
    80005d7a:	4501                	li	a0,0
}
    80005d7c:	60ea                	ld	ra,152(sp)
    80005d7e:	644a                	ld	s0,144(sp)
    80005d80:	64aa                	ld	s1,136(sp)
    80005d82:	690a                	ld	s2,128(sp)
    80005d84:	610d                	addi	sp,sp,160
    80005d86:	8082                	ret
    end_op();
    80005d88:	ffffe097          	auipc	ra,0xffffe
    80005d8c:	7e0080e7          	jalr	2016(ra) # 80004568 <end_op>
    return -1;
    80005d90:	557d                	li	a0,-1
    80005d92:	b7ed                	j	80005d7c <sys_chdir+0x7a>
    iunlockput(ip);
    80005d94:	8526                	mv	a0,s1
    80005d96:	ffffe097          	auipc	ra,0xffffe
    80005d9a:	fe2080e7          	jalr	-30(ra) # 80003d78 <iunlockput>
    end_op();
    80005d9e:	ffffe097          	auipc	ra,0xffffe
    80005da2:	7ca080e7          	jalr	1994(ra) # 80004568 <end_op>
    return -1;
    80005da6:	557d                	li	a0,-1
    80005da8:	bfd1                	j	80005d7c <sys_chdir+0x7a>

0000000080005daa <sys_exec>:

uint64
sys_exec(void)
{
    80005daa:	7145                	addi	sp,sp,-464
    80005dac:	e786                	sd	ra,456(sp)
    80005dae:	e3a2                	sd	s0,448(sp)
    80005db0:	ff26                	sd	s1,440(sp)
    80005db2:	fb4a                	sd	s2,432(sp)
    80005db4:	f74e                	sd	s3,424(sp)
    80005db6:	f352                	sd	s4,416(sp)
    80005db8:	ef56                	sd	s5,408(sp)
    80005dba:	0b80                	addi	s0,sp,464
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80005dc0:	f4040593          	addi	a1,s0,-192
    80005dc4:	4501                	li	a0,0
    80005dc6:	ffffd097          	auipc	ra,0xffffd
    80005dca:	058080e7          	jalr	88(ra) # 80002e1e <argstr>
    return -1;
    80005dce:	597d                	li	s2,-1
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    80005dd0:	0c054a63          	bltz	a0,80005ea4 <sys_exec+0xfa>
    80005dd4:	e3840593          	addi	a1,s0,-456
    80005dd8:	4505                	li	a0,1
    80005dda:	ffffd097          	auipc	ra,0xffffd
    80005dde:	022080e7          	jalr	34(ra) # 80002dfc <argaddr>
    80005de2:	0c054163          	bltz	a0,80005ea4 <sys_exec+0xfa>
  }
  memset(argv, 0, sizeof(argv));
    80005de6:	10000613          	li	a2,256
    80005dea:	4581                	li	a1,0
    80005dec:	e4040513          	addi	a0,s0,-448
    80005df0:	ffffb097          	auipc	ra,0xffffb
    80005df4:	ef0080e7          	jalr	-272(ra) # 80000ce0 <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv)){
    80005df8:	e4040493          	addi	s1,s0,-448
  memset(argv, 0, sizeof(argv));
    80005dfc:	89a6                	mv	s3,s1
    80005dfe:	4901                	li	s2,0
    if(i >= NELEM(argv)){
    80005e00:	02000a13          	li	s4,32
    80005e04:	00090a9b          	sext.w	s5,s2
      goto bad;
    }
    if(fetchaddr(uargv+sizeof(uint64)*i, (uint64*)&uarg) < 0){
    80005e08:	00391513          	slli	a0,s2,0x3
    80005e0c:	e3040593          	addi	a1,s0,-464
    80005e10:	e3843783          	ld	a5,-456(s0)
    80005e14:	953e                	add	a0,a0,a5
    80005e16:	ffffd097          	auipc	ra,0xffffd
    80005e1a:	f2a080e7          	jalr	-214(ra) # 80002d40 <fetchaddr>
    80005e1e:	02054a63          	bltz	a0,80005e52 <sys_exec+0xa8>
      goto bad;
    }
    if(uarg == 0){
    80005e22:	e3043783          	ld	a5,-464(s0)
    80005e26:	c3b9                	beqz	a5,80005e6c <sys_exec+0xc2>
      argv[i] = 0;
      break;
    }
    argv[i] = kalloc();
    80005e28:	ffffb097          	auipc	ra,0xffffb
    80005e2c:	ccc080e7          	jalr	-820(ra) # 80000af4 <kalloc>
    80005e30:	85aa                	mv	a1,a0
    80005e32:	00a9b023          	sd	a0,0(s3)
    if(argv[i] == 0)
    80005e36:	cd11                	beqz	a0,80005e52 <sys_exec+0xa8>
      goto bad;
    if(fetchstr(uarg, argv[i], PGSIZE) < 0)
    80005e38:	6605                	lui	a2,0x1
    80005e3a:	e3043503          	ld	a0,-464(s0)
    80005e3e:	ffffd097          	auipc	ra,0xffffd
    80005e42:	f54080e7          	jalr	-172(ra) # 80002d92 <fetchstr>
    80005e46:	00054663          	bltz	a0,80005e52 <sys_exec+0xa8>
    if(i >= NELEM(argv)){
    80005e4a:	0905                	addi	s2,s2,1
    80005e4c:	09a1                	addi	s3,s3,8
    80005e4e:	fb491be3          	bne	s2,s4,80005e04 <sys_exec+0x5a>
    kfree(argv[i]);
 ...
 bad:
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005e52:	10048913          	addi	s2,s1,256
    80005e56:	6088                	ld	a0,0(s1)
    80005e58:	c529                	beqz	a0,80005ea2 <sys_exec+0xf8>
    kfree(argv[i]);
    80005e5a:	ffffb097          	auipc	ra,0xffffb
    80005e5e:	b9e080e7          	jalr	-1122(ra) # 800009f8 <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005e62:	04a1                	addi	s1,s1,8
    80005e64:	ff2499e3          	bne	s1,s2,80005e56 <sys_exec+0xac>
  return -1;
    80005e68:	597d                	li	s2,-1
    80005e6a:	a82d                	j	80005ea4 <sys_exec+0xfa>
      argv[i] = 0;
    80005e6c:	0a8e                	slli	s5,s5,0x3
    80005e6e:	fc040793          	addi	a5,s0,-64
    80005e72:	9abe                	add	s5,s5,a5
    80005e74:	e80ab023          	sd	zero,-384(s5)
  int ret = exec(path, argv);
    80005e78:	e4040593          	addi	a1,s0,-448
    80005e7c:	f4040513          	addi	a0,s0,-192
    80005e80:	fffff097          	auipc	ra,0xfffff
    80005e84:	194080e7          	jalr	404(ra) # 80005014 <exec>
    80005e88:	892a                	mv	s2,a0
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005e8a:	10048993          	addi	s3,s1,256
    80005e8e:	6088                	ld	a0,0(s1)
    80005e90:	c911                	beqz	a0,80005ea4 <sys_exec+0xfa>
    kfree(argv[i]);
    80005e92:	ffffb097          	auipc	ra,0xffffb
    80005e96:	b66080e7          	jalr	-1178(ra) # 800009f8 <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005e9a:	04a1                	addi	s1,s1,8
    80005e9c:	ff3499e3          	bne	s1,s3,80005e8e <sys_exec+0xe4>
    80005ea0:	a011                	j	80005ea4 <sys_exec+0xfa>
  return -1;
    80005ea2:	597d                	li	s2,-1
}
    80005ea4:	854a                	mv	a0,s2
    80005ea6:	60be                	ld	ra,456(sp)
    80005ea8:	641e                	ld	s0,448(sp)
    80005eaa:	74fa                	ld	s1,440(sp)
    80005eac:	795a                	ld	s2,432(sp)
    80005eae:	79ba                	ld	s3,424(sp)
    80005eb0:	7a1a                	ld	s4,416(sp)
    80005eb2:	6afa                	ld	s5,408(sp)
    80005eb4:	6179                	addi	sp,sp,464
    80005eb6:	8082                	ret

0000000080005eb8 <sys_pipe>:

uint64
sys_pipe(void)
{
    80005eb8:	7139                	addi	sp,sp,-64
    80005eba:	fc06                	sd	ra,56(sp)
    80005ebc:	f822                	sd	s0,48(sp)
    80005ebe:	f426                	sd	s1,40(sp)
    80005ec0:	0080                	addi	s0,sp,64
  uint64 fdarray; // user pointer to array of two integers
  struct file *rf, *wf;
  int fd0, fd1;
  struct proc *p = myproc();
    80005ec2:	ffffc097          	auipc	ra,0xffffc
    80005ec6:	aee080e7          	jalr	-1298(ra) # 800019b0 <myproc>
    80005eca:	84aa                	mv	s1,a0

  if(argaddr(0, &fdarray) < 0)
    80005ecc:	fd840593          	addi	a1,s0,-40
    80005ed0:	4501                	li	a0,0
    80005ed2:	ffffd097          	auipc	ra,0xffffd
    80005ed6:	f2a080e7          	jalr	-214(ra) # 80002dfc <argaddr>
    return -1;
    80005eda:	57fd                	li	a5,-1
  if(argaddr(0, &fdarray) < 0)
    80005edc:	0e054063          	bltz	a0,80005fbc <sys_pipe+0x104>
  if(pipealloc(&rf, &wf) < 0)
    80005ee0:	fc840593          	addi	a1,s0,-56
    80005ee4:	fd040513          	addi	a0,s0,-48
    80005ee8:	fffff097          	auipc	ra,0xfffff
    80005eec:	dfc080e7          	jalr	-516(ra) # 80004ce4 <pipealloc>
    return -1;
    80005ef0:	57fd                	li	a5,-1
  if(pipealloc(&rf, &wf) < 0)
    80005ef2:	0c054563          	bltz	a0,80005fbc <sys_pipe+0x104>
  fd0 = -1;
    80005ef6:	fcf42223          	sw	a5,-60(s0)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    80005efa:	fd043503          	ld	a0,-48(s0)
    80005efe:	fffff097          	auipc	ra,0xfffff
    80005f02:	508080e7          	jalr	1288(ra) # 80005406 <fdalloc>
    80005f06:	fca42223          	sw	a0,-60(s0)
    80005f0a:	08054c63          	bltz	a0,80005fa2 <sys_pipe+0xea>
    80005f0e:	fc843503          	ld	a0,-56(s0)
    80005f12:	fffff097          	auipc	ra,0xfffff
    80005f16:	4f4080e7          	jalr	1268(ra) # 80005406 <fdalloc>
    80005f1a:	fca42023          	sw	a0,-64(s0)
    80005f1e:	06054863          	bltz	a0,80005f8e <sys_pipe+0xd6>
      p->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    80005f22:	4691                	li	a3,4
    80005f24:	fc440613          	addi	a2,s0,-60
    80005f28:	fd843583          	ld	a1,-40(s0)
    80005f2c:	68a8                	ld	a0,80(s1)
    80005f2e:	ffffb097          	auipc	ra,0xffffb
    80005f32:	744080e7          	jalr	1860(ra) # 80001672 <copyout>
    80005f36:	02054063          	bltz	a0,80005f56 <sys_pipe+0x9e>
     copyout(p->pagetable, fdarray+sizeof(fd0), (char *)&fd1, sizeof(fd1)) < 0){
    80005f3a:	4691                	li	a3,4
    80005f3c:	fc040613          	addi	a2,s0,-64
    80005f40:	fd843583          	ld	a1,-40(s0)
    80005f44:	0591                	addi	a1,a1,4
    80005f46:	68a8                	ld	a0,80(s1)
    80005f48:	ffffb097          	auipc	ra,0xffffb
    80005f4c:	72a080e7          	jalr	1834(ra) # 80001672 <copyout>
    p->ofile[fd1] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    80005f52:	06055563          	bgez	a0,80005fbc <sys_pipe+0x104>
    p->ofile[fd0] = 0;
    80005f56:	fc442783          	lw	a5,-60(s0)
    80005f5a:	07e9                	addi	a5,a5,26
    80005f5c:	078e                	slli	a5,a5,0x3
    80005f5e:	97a6                	add	a5,a5,s1
    80005f60:	0007b023          	sd	zero,0(a5)
    p->ofile[fd1] = 0;
    80005f64:	fc042503          	lw	a0,-64(s0)
    80005f68:	0569                	addi	a0,a0,26
    80005f6a:	050e                	slli	a0,a0,0x3
    80005f6c:	9526                	add	a0,a0,s1
    80005f6e:	00053023          	sd	zero,0(a0)
    fileclose(rf);
    80005f72:	fd043503          	ld	a0,-48(s0)
    80005f76:	fffff097          	auipc	ra,0xfffff
    80005f7a:	a3e080e7          	jalr	-1474(ra) # 800049b4 <fileclose>
    fileclose(wf);
    80005f7e:	fc843503          	ld	a0,-56(s0)
    80005f82:	fffff097          	auipc	ra,0xfffff
    80005f86:	a32080e7          	jalr	-1486(ra) # 800049b4 <fileclose>
    return -1;
    80005f8a:	57fd                	li	a5,-1
    80005f8c:	a805                	j	80005fbc <sys_pipe+0x104>
    if(fd0 >= 0)
    80005f8e:	fc442783          	lw	a5,-60(s0)
    80005f92:	0007c863          	bltz	a5,80005fa2 <sys_pipe+0xea>
      p->ofile[fd0] = 0;
    80005f96:	01a78513          	addi	a0,a5,26
    80005f9a:	050e                	slli	a0,a0,0x3
    80005f9c:	9526                	add	a0,a0,s1
    80005f9e:	00053023          	sd	zero,0(a0)
    fileclose(rf);
    80005fa2:	fd043503          	ld	a0,-48(s0)
    80005fa6:	fffff097          	auipc	ra,0xfffff
    80005faa:	a0e080e7          	jalr	-1522(ra) # 800049b4 <fileclose>
    fileclose(wf);
    80005fae:	fc843503          	ld	a0,-56(s0)
    80005fb2:	fffff097          	auipc	ra,0xfffff
    80005fb6:	a02080e7          	jalr	-1534(ra) # 800049b4 <fileclose>
    return -1;
...
0000000080005fd0 <kernelvec>:
    ...
    80006010:	c27fc0ef          	jal	ra,80002c36 <kerneltrap>
...
free_desc(int i)
{
  ...
  wakeup(&disk.free[0]);
    ...
    80006196:	162080e7          	jalr	354(ra) # 800022f4 <wakeup>
}
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  while(1){
    ...
    800063d6:	d96080e7          	jalr	-618(ra) # 80002168 <sleep>
  for(int i = 0; i < 3; i++){
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80006520:	c4c080e7          	jalr	-948(ra) # 80002168 <sleep>
  while(b->disk == 1) {
...
virtio_disk_intr()
{
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  while(disk.used_idx != disk.used->idx){
    ...
    8000665e:	c9a080e7          	jalr	-870(ra) # 800022f4 <wakeup>
