...
main(void)
{
  ...
  18:	8cc50513          	addi	a0,a0,-1844 # 8e0 <malloc+0xe8>
  ...
  40:	8aca8a93          	addi	s5,s5,-1876 # 8e8 <malloc+0xf0>
    printf("\e[1;1H\e[2J");
  44:	00001a17          	auipc	s4,0x1
  48:	8bca0a13          	addi	s4,s4,-1860 # 900 <malloc+0x108>
    printf("\033[32;1m\n\
  4c:	00001997          	auipc	s3,0x1
  50:	8c498993          	addi	s3,s3,-1852 # 910 <malloc+0x118>
    #endif
    #ifdef FCFS
  ...
  58:	f6c90913          	addi	s2,s2,-148 # fc0 <malloc+0x7c8>
    printf("init: starting sh\n");
  5c:	8556                	mv	a0,s5
  5e:	00000097          	auipc	ra,0x0
  62:	6dc080e7          	jalr	1756(ra) # 73a <printf>
    printf("\e[1;1H\e[2J");
  66:	8552                	mv	a0,s4
  68:	00000097          	auipc	ra,0x0
  6c:	6d2080e7          	jalr	1746(ra) # 73a <printf>
    printf("\033[32;1m\n\
  70:	854e                	mv	a0,s3
  72:	00000097          	auipc	ra,0x0
  76:	6c8080e7          	jalr	1736(ra) # 73a <printf>
    printf("\033[31;1mScheduling Policy: Priority Based Scheduling (PBS)\033[0;0m\n\n");
  7a:	854a                	mv	a0,s2
  7c:	00000097          	auipc	ra,0x0
  80:	6be080e7          	jalr	1726(ra) # 73a <printf>
    #endif
    #ifdef MLFQ
  ...
  aa:	f9a50513          	addi	a0,a0,-102 # 1040 <malloc+0x848>
  ae:	00000097          	auipc	ra,0x0
  b2:	68c080e7          	jalr	1676(ra) # 73a <printf>
        exit(1);
  b6:	4505                	li	a0,1
  ...
  c8:	81c50513          	addi	a0,a0,-2020 # 8e0 <malloc+0xe8>
  cc:	00000097          	auipc	ra,0x0
  d0:	326080e7          	jalr	806(ra) # 3f2 <mknod>
    open("console", O_RDWR);
  d4:	4589                	li	a1,2
  d6:	00001517          	auipc	a0,0x1
  da:	80a50513          	addi	a0,a0,-2038 # 8e0 <malloc+0xe8>
  de:	00000097          	auipc	ra,0x0
  e2:	30c080e7          	jalr	780(ra) # 3ea <open>
  e6:	b789                	j	28 <main+0x28>
      printf("init: fork failed\n");
  e8:	00001517          	auipc	a0,0x1
  ec:	f2050513          	addi	a0,a0,-224 # 1008 <malloc+0x810>
  f0:	00000097          	auipc	ra,0x0
  f4:	64a080e7          	jalr	1610(ra) # 73a <printf>
      exit(1);
  f8:	4505                	li	a0,1
 ...
 106:	f7e58593          	addi	a1,a1,-130 # 1080 <argv>
 10a:	00001517          	auipc	a0,0x1
 10e:	f1650513          	addi	a0,a0,-234 # 1020 <malloc+0x828>
 112:	00000097          	auipc	ra,0x0
 116:	2d0080e7          	jalr	720(ra) # 3e2 <exec>
      printf("init: exec sh failed\n");
 11a:	00001517          	auipc	a0,0x1
 11e:	f0e50513          	addi	a0,a0,-242 # 1028 <malloc+0x830>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4aa:	bc250513          	addi	a0,a0,-1086 # 1068 <digits>
 4ae:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 572:	00001b97          	auipc	s7,0x1
 576:	af6b8b93          	addi	s7,s7,-1290 # 1068 <digits>
 ...
 6b0:	bdf9                	j	58e <vprintf+0x60>
          s = "(null)";
 6b2:	00001917          	auipc	s2,0x1
 6b6:	9ae90913          	addi	s2,s2,-1618 # 1060 <malloc+0x868>
        while(*s != 0){
...
free(void *ap)
{
 ...
 77e:	9167b783          	ld	a5,-1770(a5) # 1090 <freep>
 ...
 7ac:	00e6ea63          	bltu	a3,a4,7c0 <free+0x50>
{
 ...
 7ee:	8af73323          	sd	a5,-1882(a4) # 1090 <freep>
}
 7f2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 820:	87453503          	ld	a0,-1932(a0) # 1090 <freep>
 ...
 848:	84c90913          	addi	s2,s2,-1972 # 1090 <freep>
  if(p == (char*)-1)
 84c:	5afd                	li	s5,-1
 84e:	a88d                	j	8c0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 850:	00001797          	auipc	a5,0x1
 854:	84878793          	addi	a5,a5,-1976 # 1098 <base>
 858:	00001717          	auipc	a4,0x1
 85c:	82f73c23          	sd	a5,-1992(a4) # 1090 <freep>
 860:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 882:	80a73923          	sd	a0,-2030(a4) # 1090 <freep>
      return (void*)(p + 1);
 ...
 8d0:	b66080e7          	jalr	-1178(ra) # 432 <sbrk>
  if(p == (char*)-1)
