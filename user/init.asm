...
main(void)
{
  ...
  aa:	f9250513          	addi	a0,a0,-110 # 1038 <malloc+0x840>
  ...
  ec:	f1850513          	addi	a0,a0,-232 # 1000 <malloc+0x808>
 ...
 10e:	f0e50513          	addi	a0,a0,-242 # 1018 <malloc+0x820>
 112:	00000097          	auipc	ra,0x0
 116:	2d0080e7          	jalr	720(ra) # 3e2 <exec>
      printf("init: exec sh failed\n");
 11a:	00001517          	auipc	a0,0x1
 11e:	f0650513          	addi	a0,a0,-250 # 1020 <malloc+0x828>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4aa:	bba50513          	addi	a0,a0,-1094 # 1060 <digits>
 4ae:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 576:	aeeb8b93          	addi	s7,s7,-1298 # 1060 <digits>
 ...
 6b6:	9a690913          	addi	s2,s2,-1626 # 1058 <malloc+0x860>
        while(*s != 0){
...
free(void *ap)
{
 ...
 77e:	90e7b783          	ld	a5,-1778(a5) # 1088 <freep>
 ...
 7ac:	00e6ea63          	bltu	a3,a4,7c0 <free+0x50>
{
 ...
 7ee:	88f73f23          	sd	a5,-1890(a4) # 1088 <freep>
}
 7f2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 820:	86c53503          	ld	a0,-1940(a0) # 1088 <freep>
 ...
 848:	84490913          	addi	s2,s2,-1980 # 1088 <freep>
  if(p == (char*)-1)
 84c:	5afd                	li	s5,-1
 84e:	a88d                	j	8c0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 850:	00001797          	auipc	a5,0x1
 854:	84078793          	addi	a5,a5,-1984 # 1090 <base>
 858:	00001717          	auipc	a4,0x1
 85c:	82f73823          	sd	a5,-2000(a4) # 1088 <freep>
 860:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 882:	80a73523          	sd	a0,-2038(a4) # 1088 <freep>
      return (void*)(p + 1);
