...
main(void)
{
  ...
  aa:	f8a50513          	addi	a0,a0,-118 # 1030 <malloc+0x838>
  ...
  ec:	f1050513          	addi	a0,a0,-240 # ff8 <malloc+0x800>
 ...
 10e:	f0650513          	addi	a0,a0,-250 # 1010 <malloc+0x818>
 112:	00000097          	auipc	ra,0x0
 116:	2d0080e7          	jalr	720(ra) # 3e2 <exec>
      printf("init: exec sh failed\n");
 11a:	00001517          	auipc	a0,0x1
 11e:	efe50513          	addi	a0,a0,-258 # 1018 <malloc+0x820>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4aa:	bb250513          	addi	a0,a0,-1102 # 1058 <digits>
 4ae:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 576:	ae6b8b93          	addi	s7,s7,-1306 # 1058 <digits>
 ...
 6b6:	99e90913          	addi	s2,s2,-1634 # 1050 <malloc+0x858>
        while(*s != 0){
...
free(void *ap)
{
 ...
 77e:	9067b783          	ld	a5,-1786(a5) # 1080 <freep>
 ...
 7ac:	00e6ea63          	bltu	a3,a4,7c0 <free+0x50>
{
 ...
 7ee:	88f73b23          	sd	a5,-1898(a4) # 1080 <freep>
}
 7f2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 820:	86453503          	ld	a0,-1948(a0) # 1080 <freep>
 ...
 848:	83c90913          	addi	s2,s2,-1988 # 1080 <freep>
  if(p == (char*)-1)
 84c:	5afd                	li	s5,-1
 84e:	a88d                	j	8c0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 850:	00001797          	auipc	a5,0x1
 854:	83878793          	addi	a5,a5,-1992 # 1088 <base>
 858:	00001717          	auipc	a4,0x1
 85c:	82f73423          	sd	a5,-2008(a4) # 1080 <freep>
 860:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 882:	80a73123          	sd	a0,-2046(a4) # 1080 <freep>
      return (void*)(p + 1);
